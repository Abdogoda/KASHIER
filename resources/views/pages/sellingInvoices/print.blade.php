...
@section('details')
    ...
    <div class="mt-2">
        <p class='text-bold'>تفاصيل العميل:</p>
        @if ($invoice->customer_type == 'عميل')
    ...
    <div class="invoice-body-bottom mt-2">
        ...
        @if ($invoice->customer)
            <div class="invoice-body-item grid-2 border-bottom">
                ...
                @endif
                <div class="item-td text-center"> <span class="text-bold">حساب حالي:</span> {{$invoice->customer->account}}</div>
            </div>
        @endif
    </div>
@endsection