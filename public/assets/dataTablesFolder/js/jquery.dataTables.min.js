...
!(function (n) {
 ...
 function ee(t) {
  ...
  if (g || (!h && !l && !i && s == T(t) && s == c.length))
   ...
   for (
    ...
    (e = r[u[D]]),
     (c[D].style.width =
      null !== e.sWidthOrig && "" !== e.sWidthOrig ? M(e.sWidthOrig) : ""),
     e.sWidthOrig &&
      l &&
      P(c[D]).append(
       P("<div/>").css({
   ...
   o === c.length
    ? i.sort(function (t, e) {
       for (
        ...
        if (
         0 !=
         (r = (n = l[(o = c[u]).col]) < (a = s[o.col]) ? -1 : a < n ? 1 : 0)
        )
 ...
 function W(t, e, n, a) {
  if (
   ((n =
    "DataTables warning: " + (t ? "table id=" + t.sTableId + " - " : "") + n),
   a &&
    (n +=
 ...
 function _e(t, e, n, a, r) {
  for (
   var o,
    ...
    c = typeof e,
    f = 0,
    d = (e = e && "string" != c && "function" != c && e.length !== N ? e : [e])
     .length;
   f < d;
   f++
  )
   for (
    l = 0,
     s = (i =
      e[f] && e[f].split && !e[f].match(/[\[\(:]/) ? e[f].split(",") : [e[f]])
      .length;
    l < s;
    l++
   )
  ...
  Fe =
   ...
   P.extend(B.prototype, {
    ...
    iterator: function (t, e, n, a) {
     ...
     return d.length || a
      ? (((t = (a = new B(h, t ? d.concat.apply([], d) : d)).selector).rows =
         p.rows),
        (t.cols = p.cols),
        (t.opts = p.opts),
        a)
      ...
      for (var r = t.split("."), o = Ie, i = 0, l = r.length; i < l; i++) {
       var s,
        ...
        c = (function (t, e) {
         ...
         o,
         (u = (s = -1 !== r[i].indexOf("()")) ? r[i].replace("()", "") : r[i])
        );
       c ||
        o.push(
         (c = { name: u, val: {}, methodExt: [], propExt: [], type: "object" })
        ),
        i === l - 1
         ? ((c.val = e),
           (c.type =
  ...
  He =
   ...
   e("i18n()", function (t, e, n) {
    ...
    return (
     t === N && (t = e),
     (t =
      n !== N && P.isPlainObject(t) ? (t[n] !== N ? t[n] : t._) : t).replace(
      "%d",
      n
     )
    );
