...
!(function (p, h, v, b) {
     ...
     S.each(function () {
      ...
      (v = {
       initialize: function () {
        v.get.settings(),
         O
          ? (c === L && v.instantiate(), v.invoke(F))
          : (c !== L && (c.invoke("destroy"), v.refresh()),
            v.verbose("Initializing form validation", d, g),
            v.bindEvents(),
            v.set.defaults(),
            g.autoCheckRequired && v.set.autoCheck(),
            v.instantiate());
       },
       instantiate: function () {
       ...
       destroy: function () {
        v.verbose("Destroying previous module", c),
         v.removeEvents(),
         d.removeData(a);
       },
       refresh: function () {
        v.verbose("Refreshing selector cache"),
         (n = d.find(p.field)),
         (f = d.find(p.group)),
         (t = d.find(p.message)),
         d.find(p.prompt),
       ...
       attachEvents: function (e, t) {
        (t = t || "submit"),
         M(e).on("click" + s, function (e) {
          v[t](), e.preventDefault();
         });
       },
       bindEvents: function () {
        v.verbose("Attaching form events"),
         d
          .on("submit" + s, v.validate.form)
          .on("blur" + s, p.field, v.event.field.blur)
          .on("click" + s, p.submit, v.submit)
          .on("click" + s, p.reset, v.reset)
          .on("click" + s, p.clear, v.clear),
         g.keyboardShortcuts &&
          d.on("keydown" + s, p.field, v.event.field.keydown),
         n.each(function (e, t) {
          var n = M(t),
           i = n.prop("type"),
         ...
         g.preventLeaving && M(I).on("beforeunload" + s, v.event.beforeUnload),
         n.on("change click keyup keydown blur", function (e) {
          v.determine.isDirty();
         }),
       ...
       clear: function () {
        n.each(function (e, t) {
         ...
         o.hasClass(h.error) &&
          (v.verbose("Resetting error on field", o),
          o.removeClass(h.error),
          a.remove()),
          c
           ? (v.verbose("Resetting dropdown value", i, s),
             i.dropdown("clear", !0))
           : l
           ? n.prop("checked", !1)
           : u
           ? r.calendar("clear")
           : (v.verbose("Resetting field value", n, s), n.val(""));
        }),
         v.remove.states();
       },
       reset: function () {
        n.each(function (e, t) {
         ...
         s !== L &&
          ...
          c
           ...
           : l
           ? (v.verbose("Resetting checkbox value", i, s), n.prop("checked", s))
           : u
           ? a.calendar("set date", s)
           : (v.verbose("Resetting field value", n, s), n.val(s)));
        }),
         v.remove.states();
       },
       determine: {
        ...
        isDirty: function (e) {
         ...
         n.each(function (e, t) {
          var n,
           i = M(t);
          (n =
           0 < i.filter(p.checkbox).length
            ? v.is.checkboxDirty(i)
            : v.is.fieldDirty(i)),
           i.data(g.metadata.isDirty, n),
           (o |= n);
         }),
       ...
       is: {
        ...
        empty: function (e) {
         return (
          !e ||
          0 === e.length ||
          (e.is(p.checkbox) ? !e.is(":checked") : v.is.blank(e))
         );
        },
        blank: function (e) {
        ...
        valid: function (e, n) {
         var i = !0;
         return e
          ? (v.verbose("Checking if field is valid", e),
            v.validate.field(l[e], e, !!n))
          : (v.verbose("Checking if form is valid"),
            M.each(l, function (e, t) {
             v.is.valid(e, n) || (i = !1);
            }),
            i);
        ...
        fieldDirty: function (e) {
         ...
         var i = /^(true|false)$/i;
         return i.test(t) && i.test(n)
          ? !new RegExp("^" + t + "$", "i").test(n)
          : n !== t;
        },
        ...
        field: {
         keydown: function (e) {
          var t = M(this),
           ...
           r = 13;
          n == 27 &&
           (v.verbose("Escape key pressed blurring field"), t[0].blur()),
           e.ctrlKey ||
            n != r ||
            !i ||
            a ||
            o ||
            (x ||
             (t.one("keyup" + s, v.event.field.keyup),
             v.submit(),
             v.debug("Enter pressed on input submitting form")),
            (x = !0));
         },
         keyup: function () {
          x = !1;
         ...
         blur: function (e) {
          ...
          i &&
           ("blur" == g.on || (n.hasClass(h.error) && g.revalidate)) &&
           (v.debug("Revalidating field", t, i),
           v.validate.field(i),
           g.inline || v.validate.form(!1, !0));
         },
         change: function (e) {
          var t = M(this),
           n = t.closest(f),
           i = v.get.validation(t);
          i &&
           ("change" == g.on || (n.hasClass(h.error) && g.revalidate)) &&
       ...
       get: {
        ancillaryValue: function (e) {
         return (
          !(!e.type || (!e.value && !v.is.bracketedRule(e))) &&
          (e.value !== L ? e.value : e.type.match(g.regExp.bracket)[1] + "")
         );
        },
        ruleName: function (e) {
         return v.is.bracketedRule(e)
        ...
        inputEvent: function () {
         return j.createElement("input").oninput !== L
          ? "input"
          : j.createElement("input").onpropertychange !== L
          ? "propertychange"
          : "keyup";
        },
        ...
        prompt: function (e, t) {
         var n,
          ...
          l = s.val(),
          c = M.isFunction(e.prompt)
           ? e.prompt(l)
           : e.prompt || g.prompt[a] || g.text.unspecifiedRule,
          u = -1 !== c.search("{value}"),
          d = -1 !== c.search("{name}");
         return (
          r &&
           ...
           e.prompt ||
            (c += (
             "" === o[0]
              ? g.prompt.maxValue.replace(/\{ruleValue\}/g, "{max}")
              : "" === o[1]
              ? g.prompt.minValue.replace(/\{ruleValue\}/g, "{min}")
              : g.prompt.range
            ).replace(/\{name\}/g, " " + g.text.and)),
           (c = (c = c.replace(/\{min\}/g, o[0])).replace(/\{max\}/g, o[1]))),
          u && (c = c.replace(/\{value\}/g, s.val())),
          d &&
           ((i =
            1 == (n = s.closest(p.group).find("label").eq(0)).length
             ? n.text()
             : s.prop("placeholder") || g.text.unspecifiedField),
           (c = c.replace(/\{name\}/g, i))),
          (c = (c = c.replace(/\{identifier\}/g, t.identifier)).replace(
           /\{ruleValue\}/g,
           r
          )),
          e.prompt ||
           v.verbose("Using default validation prompt for type", c, a),
          c
         );
        },
        settings: function () {
         if (M.isPlainObject(k)) {
          var e = Object.keys(k);
          0 < e.length && k[e[0]].identifier !== L && k[e[0]].rules !== L
           ? ((g = M.extend(!0, {}, M.fn.form.settings, P)),
             (l = M.extend({}, M.fn.form.settings.defaults, k)),
             v.error(g.error.oldSyntax, b),
             v.verbose("Extending settings from legacy parameters", l, g))
           : (k.fields && (k.fields = v.get.fieldsFromShorthand(k.fields)),
             (g = M.extend(!0, {}, M.fn.form.settings, k)),
             (l = M.extend({}, M.fn.form.settings.defaults, g.fields)),
             v.verbose("Extending settings", l, g));
         } else
          (g = M.fn.form.settings),
           (l = M.fn.form.settings.defaults),
           v.verbose("Using default form validation", l, g);
         (o = g.namespace),
          (m = g.metadata),
          (p = g.selector),
          (h = g.className),
          ...
          (a = "module-" + o),
          (s = "." + o),
          ((c = d.data(a)) || v).refresh();
        },
        field: function (e) {
         var t;
         return (
          v.verbose("Finding field with identifier", e),
          (e = v.escape.string(e)),
          0 < (t = n.filter("#" + e)).length
           ...
           : 0 < (t = n.filter('[name="' + e + '[]"]')).length
           ? t
           : 0 < (t = n.filter("[data-" + m.validate + '="' + e + '"]')).length
           ? t
           : M("<input/>")
         );
        },
        ...
        validation: function (i) {
         ...
         return (
          !!l &&
          (M.each(l, function (e, n) {
           (a = n.identifier || e),
            M.each(v.get.field(a), function (e, t) {
          ...
          t.each(function (e, t) {
           ...
           if (o)
            if (l)
             (o = o.replace("[]", "")),
              m[o] || (m[o] = []),
              r ? (u ? m[o].push(a || !0) : m[o].push(!1)) : m[o].push(a);
            else if (s)
             (m[o] !== L && !1 !== m[o]) || (m[o] = !!u && (a || !0));
            else if (r) m[o] = !!u && (a || !0);
            else if (c) {
             var d = i.calendar("get date");
             if (null !== d) {
              if ("date" == g.dateHandling) m[o] = d;
              else if ("input" == g.dateHandling)
               m[o] = i.calendar("get input date");
       ...
       has: {
        field: function (e) {
         return (
          v.verbose("Checking for existence of a field with identifier", e),
          "string" != typeof (e = v.escape.string(e)) &&
           v.error(u.identifier, e),
          0 < n.filter("#" + e).length ||
       ...
       can: {
        useElement: function (e) {
         return (
          M.fn[e] !== L || (v.error(u.noElement.replace("{element}", e)), !1)
         );
        },
       },
       escape: {
       ...
       add: {
        ...
        field: function (n, e) {
         (l[n] !== L && l[n].rules !== L) || (l[n] = { rules: [] });
         var i = { rules: [] };
         v.is.shorthandRules(e)
          ? ((e = Array.isArray(e) ? e : [e]),
            M.each(e, function (e, t) {
             i.rules.push({ type: t });
            }))
          : (i.rules = e.rules),
          M.each(i.rules, function (e, t) {
           0 ==
            M.grep(l[n].rules, function (e) {
        ...
        prompt: function (e, t, n) {
         ...
         (t = "string" == typeof t ? [t] : t),
          v.verbose("Adding field error state", e),
          n || i.addClass(h.error),
          g.inline &&
           (a || (o = g.templates.prompt(t, h.label)).appendTo(i),
           o.html(t[0]),
           a
            ? v.verbose("Inline errors are disabled, no inline error added", e)
            : g.transition &&
              v.can.useElement("transition") &&
              d.transition("is supported")
            ? (v.verbose("Displaying error with css transition", g.transition),
              o.transition(g.transition + " in", g.duration))
            : (v.verbose("Displaying error with fallback javascript animation"),
              o.fadeIn(g.duration)));
        },
        errors: function (e) {
         v.debug("Adding form error messages", e),
          v.set.error(),
       ...
       remove: {
        ...
        states: function () {
         d.removeClass(h.error).removeClass(h.success),
          g.inline || v.remove.errors(),
          v.determine.isDirty();
        },
        rule: function (n, e) {
         var i = Array.isArray(e) ? e : [e];
         if (l[n] !== L && Array.isArray(l[n].rules))
          return e === L
           ? (v.debug("Removed all rules"), void (l[n].rules = []))
           : void M.each(l[n].rules, function (e, t) {
              t &&
               -1 !== i.indexOf(t.type) &&
               (v.debug("Removed rule", t.type), l[n].rules.splice(e, 1));
             });
        },
        field: function (e) {
        ...
        prompt: function (e) {
         ...
         t.removeClass(h.error),
          g.inline &&
           n.is(":visible") &&
           (v.verbose("Removing prompt for field", e),
           g.transition &&
           v.can.useElement("transition") &&
           d.transition("is supported")
            ? n.transition(g.transition + " out", g.duration, function () {
               n.remove();
              })
       ...
       set: {
        ...
        defaults: function () {
         n.each(function (e, t) {
          ...
          a ? i.dropdown("save defaults") : s && r.calendar("refresh"),
        ...
        values: function (e) {
         M.isEmptyObject(e) ||
          M.each(e, function (e, t) {
           ...
           0 < i.length &&
            (r && s
             ? (v.verbose("Selecting multiple", t, i),
               o.checkbox("uncheck"),
               M.each(t, function (e, t) {
                (n = i.filter('[value="' + t + '"]')),
                 (o = n.parent()),
             ...
             : c
             ? (v.verbose("Selecting radio value", t, i),
               i
                .filter('[value="' + t + '"]')
                .parent(p.uiCheckbox)
                .checkbox("check"))
             : s
             ? (v.verbose("Setting checkbox value", t, o),
               !0 === t || 1 === t
                ? o.checkbox("check")
                : o.checkbox("uncheck"))
             : l
             ? (v.verbose("Setting dropdown value", t, o),
               o.dropdown("set selected", t))
             : u
             ? a.calendar("set date", t)
             : (v.verbose("Setting field value", t, i), i.val(t)));
          });
        },
        dirty: function () {
         v.verbose("Setting state dirty"),
          (C = !0),
          (w[0] = w[1]),
          (w[1] = "dirty"),
          v.is.justClean() && d.trigger("dirty");
        },
        clean: function () {
         v.verbose("Setting state clean"),
          (C = !1),
          (w[0] = w[1]),
          (w[1] = "clean"),
          v.is.justDirty() && d.trigger("clean");
        },
        asClean: function () {
        ...
        autoCheck: function () {
         v.debug("Enabling auto check on required fields"),
          n.each(function (e, t) {
           var n = M(t),
            i = M(t).closest(f),
            o = 0 < n.filter(p.checkbox).length,
            a =
             n.prop("required") ||
             i.hasClass(h.required) ||
             i.parent().hasClass(h.required),
            r =
             n.is(":disabled") ||
             i.hasClass(h.disabled) ||
             i.parent().hasClass(h.disabled),
            s = v.get.validation(n),
            l =
             !!s &&
             0 !==
              M.grep(s.rules, function (e) {
               return "empty" == e.type;
              }),
            c =
             s.identifier ||
           ...
           !a ||
            ...
            c === L ||
            (o
             ? (v.verbose("Adding 'checked' rule on field", c),
               v.add.rule(c, "checked"))
             : (v.verbose("Adding 'empty' rule on field", c),
               v.add.rule(c, "empty")));
          });
        },
       ...
       validate: {
        form: function (e, t) {
         ...
         if (((y = []), v.determine.isValid())) {
          if (
           (v.debug("Form has no validation errors, submitting"),
           v.set.success(),
           g.inline || v.remove.errors(),
           !0 !== t)
          )
           return g.onSuccess.call(b, e, n);
         } else {
          if (
           (v.debug("Form has errors"),
           (r = !1),
           v.set.error(),
           g.inline || v.add.errors(y),
           e && d.data("moduleApi") !== L && e.stopImmediatePropagation(),
           g.errorFocus)
          ) {
           var i,
            o = !0;
           "string" == typeof g.errorFocus
            ? (o = (i = M(g.errorFocus)).is("[tabindex]")) ||
              i.attr("tabindex", -1)
            : (i = f
               .filter("." + h.error)
               .first()
        ...
        field: function (i, e, o) {
         (o = o === L || o),
          "string" == typeof i &&
           (v.verbose("Validating field", i), (i = l[(e = i)]));
         ...
         return (
          i.identifier ||
           (v.debug("Using field name as identifier", a), (i.identifier = a)),
          !t.filter(":not(:disabled)").length
           ? v.debug("Field is disabled. Skipping", a)
           : i.optional && v.is.blank(t)
           ? v.debug("Field is optional and blank. Skipping", a)
           : i.depends && v.is.empty(n)
           ? v.debug(
              "Field depends on another value that is not present or empty. Skipping",
              n
             )
           : i.rules !== L &&
             (o && t.closest(f).removeClass(h.error),
             M.each(i.rules, function (e, t) {
              if (v.has.field(a)) {
               var n = v.validate.rule(i, t, !0) || [];
               0 < n.length &&
                (v.debug("Field is invalid", a, t.type),
                s.push(v.get.prompt(t, i)),
                (r = !1),
                o && M(n).closest(f).addClass(h.error));
              }
             })),
          r
           ? (o && (v.remove.prompt(a, s), g.onValid.call(t)), !0)
           : (o &&
              ((y = y.concat(s)),
              v.add.prompt(a, s, !0),
              g.onInvalid.call(t, s)),
             !1)
         );
        },
        rule: function (e, n, t) {
         function i(e) {
          ...
          return (
           (t =
            t === L || "" === t || null === t
             ? ""
             : (g.shouldTrim && !1 !== n.shouldTrim) || n.shouldTrim
             ? String(t + "").trim()
             : String(t + "")),
           s.call(e, t, a, d)
          );
       ...
       invoke: function (i, e, t) {
        ...
        return (
         ...
         M.isFunction(a) ? (n = a.apply(t, e)) : a !== L && (n = a),
         Array.isArray(T)
          ? T.push(n)
          : T !== L
          ? (T = [T, n])
   ...
   (M.fn.form.settings = {
    ...
    rules: {
     ...
     range: function (e, t, n) {
      var i, o, a;
      return (
       "string" == typeof n && (n = M.fn.form.settings.regExp[n]),
       n instanceof RegExp || (n = M.fn.form.settings.regExp.integer),
       t &&
        -1 === ["", ".."].indexOf(t) &&
        (-1 == t.indexOf("..")
         ? n.test(t) && (i = o = t - 0)
     ...
     contains: function (e, t) {
      return (
       (t = t.replace(M.fn.form.settings.regExp.escape, "\\$&")),
     ...
     match: function (e, t, n) {
      var i, o;
      return (
       0 < (o = n.find('[data-validate="' + t + '"]')).length
        ? (i = o.val())
        : 0 < (o = n.find("#" + t)).length
        ? (i = o.val())
        : 0 < (o = n.find('[name="' + t + '"]')).length
        ? (i = o.val())
        : 0 < (o = n.find('[name="' + t + '[]"]')).length && (i = o),
       i !== L && e.toString() == i.toString()
      );
     },
    ...
    return (
     r.each(function () {
      ...
      (c = {
       ...
       open: function (e) {
        ...
        n.hasClass(d.active) || i
         ...
         : (c.debug("Opening accordion content", t),
           ...
           u.animateChildren &&
            (k.fn.transition !== S && m.transition("is supported")
       ...
       reset: {
        display: function () {
         c.verbose("Removing inline display from element", this),
          k(this).css("display", ""),
          "" === k(this).attr("style") &&
           k(this).attr("style", "").removeAttr("style");
        },
        opacity: function () {
          ...
          k.each(i, function (e, t) {
           ...
           if (k.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (!k.isPlainObject(r[t]) || e == o)
             return r[t] !== S ? (a = r[t]) : c.error(s.method, i), !1;
            r = r[t];
           }
          })),
         k.isFunction(a) ? (n = a.apply(t, e)) : a !== S && (n = a),
         Array.isArray(v)
          ? v.push(n)
          : v !== S
          ? (v = [v, n])
       ...
       C
        ? (h === S && c.initialize(), c.invoke(x))
        : (h !== S && h.invoke("destroy"), c.initialize());
     }),
     v !== S ? v : this
    );
   }),
    ...
    return (
     e.each(function () {
      var f,
       e,
       le,
       ce = ve.isPlainObject(h)
        ? ve.extend(!0, {}, ve.fn.calendar.settings, h)
        : ve.extend({}, ve.fn.calendar.settings),
       ue = ce.className,
       t = ce.namespace,
       r = ce.selector,
       de = ce.formatter,
      ...
      (le = {
       initialize: function () {
        le.debug("Initializing calendar for", d, l),
         (f = le.get.isTouch()),
         le.setup.config(),
         le.setup.popup(),
         le.setup.inline(),
       ...
       destroy: function () {
        le.verbose("Destroying previous calendar for", d),
         l.removeData(o),
         le.unbind.events(),
         le.disconnect.classObserver();
       },
       setup: {
        config: function () {
         null !== le.get.minDate() && le.set.minDate(l.data(fe.minDate)),
          null !== le.get.maxDate() && le.set.maxDate(l.data(fe.maxDate)),
          le.setting("type", le.get.type()),
          le.setting("on", ce.on || (c.length ? "focus" : "click"));
        },
        popup: function () {
          ...
          if (ve.fn.popup !== be) {
           ...
           c.length ||
            ...
            (n = function () {
             return (
              le.refreshTooltips(),
              le.focus(),
              ce.onVisible.apply(ge, arguments)
             );
            }),
            (i = function () {
           ...
           var o = le.setting("on"),
            a = ve.extend({}, ce.popupOptions, {
             ...
             onShow: function () {
              return (
               le.set.focusDate(le.get.date()),
               le.set.mode(le.get.validatedMode(ce.startMode)),
               ce.onShow.apply(ge, arguments)
              );
             },
             onVisible: n,
             onHide: ce.onHide,
        ...
        inline: function () {
         (u.length && !ce.inline) ||
          ((ce.inline = !0),
          (ge = ve("<div/>").addClass(ue.calendar).appendTo(l)),
          c.length || ge.attr("tabindex", "0"));
        },
        input: function () {
        ...
        date: function () {
         var e;
         ce.initialDate
          ? (e = n.date(ce.initialDate, ce))
          : l.data(fe.date) !== be
          ? (e = n.date(l.data(fe.date), ce))
          : c.length && (e = n.date(c.val(), ce)),
          le.set.date(e, ce.formatInput, !1),
          le.set.mode(le.get.mode(), !1);
        },
       },
       trigger: {
        change: function () {
         ...
         if (e) {
          ...
          le.verbose("Triggering native change event"),
       ...
       create: {
        calendar: function () {
         ...
         for (
          E.empty(),
           1 < A && (r = ve("<div/>").addClass(ue.grid).appendTo(E)),
           i = 0;
          i < A;
          i++
         ) {
          ...
          var M = f ? 10 : m ? 1 : 0,
           ...
           z = f
            ? new Date(10 * Math.ceil(T / 10) - 9, 0, 0)
            : m
            ? new Date(T, 0, 0)
            : g
            ? new Date(T, P, 0)
            : new Date(T, P, w, -1),
           N = f
            ? new Date(10 * Math.ceil(T / 10) + 1, 0, 1)
            : m
            ? new Date(T + 1, 0, 1)
            : g
            ? new Date(T, P + 1, 1)
          ...
          if (!v) {
           ...
           if ((Q.data(fe.mode, X), 0 === i)) {
            ...
            K.data(fe.focusDate, V),
             K.toggleClass(ue.disabledCell, !le.helper.isDateInRange(z, s)),
             ve("<i/>").addClass(ue.prevIcon).appendTo(K);
           }
           if (i === A - 1) {
            var $ = ve("<span/>").addClass(ue.next).appendTo(a);
            $.data(fe.focusDate, q),
             $.toggleClass(ue.disabledCell, !le.helper.isDateInRange(N, s)),
             ve("<i/>").addClass(ue.nextIcon).appendTo($);
           }
           if (g)
            for (
             o = ve("<tr/>").appendTo(W),
              ce.showWeekNumbers &&
               ((a = ve("<th/>").appendTo(o)).text(ce.text.weekNo),
               a.addClass(ue.weekCell),
               B--),
              e = 0;
             e < B;
             e++
            )
             (a = ve("<th/>").appendTo(o)).text(
              de.dayColumnHeader((e + ce.firstDayOfWeek) % 7, ce)
             );
          }
          var G = ve("<tbody/>").appendTo(U);
          for (
           e = f ? 10 * Math.ceil(T / 10) - 9 : g ? 1 - O : 0, t = 0;
           t < D;
           t++
          )
           for (
            o = ve("<tr/>").appendTo(G),
             g &&
              ce.showWeekNumbers &&
              ((a = ve("<th/>").appendTo(o)).text(
               le.get.weekOfYear(T, P, e + 1 - ce.firstDayOfWeek)
              ),
              a.addClass(ue.weekCell)),
             n = 0;
            n < B;
            ...
            var J = f
              ...
              : p
              ? new Date(T, P, w, e)
              : new Date(T, P, w, C, e * ce.minTimeGap),
             Z = f
              ? e
              : m
              ? ce.text.monthsShort[e]
              : g
              ? J.getDate()
              : de.time(J, ce, !0);
            (a = ve("<td/>").addClass(ue.cell).appendTo(o)).text(Z),
             a.data(fe.date, J);
            var _,
             ee = g && J.getMonth() !== (P + 12) % 12,
             te =
              (!ce.selectAdjacentDays && ee) ||
              !le.helper.isDateInRange(J, s) ||
              ce.isDisabled(J, s) ||
              le.helper.isDisabled(J, s) ||
              !le.helper.isEnabled(J, s);
            if (te) {
             var ne = le.helper.findDayAsObject(J, s, ce.disabledDates);
             null !== ne &&
              ne[fe.message] &&
              (a.attr("data-tooltip", ne[fe.message]),
              a.attr("data-position", ne[fe.position] || F),
              (ne[fe.inverted] || (pe && ne[fe.inverted] === be)) &&
               a.attr("data-inverted", ""),
              ne[fe.variation] && a.attr("data-variation", ne[fe.variation]));
            } else
             null !== (_ = le.helper.findDayAsObject(J, s, ce.eventDates)) &&
              (a.addClass(_[fe.class] || ce.eventClass),
              _[fe.message] &&
               (a.attr("data-tooltip", _[fe.message]),
               a.attr("data-position", _[fe.position] || F),
               (_[fe.inverted] || (pe && _[fe.inverted] === be)) &&
                a.attr("data-inverted", ""),
               _[fe.variation] && a.attr("data-variation", _[fe.variation])));
            var ie = le.helper.dateEqual(J, c, s),
             oe = le.helper.dateEqual(J, l, s);
            a.toggleClass(ue.adjacentCell, ee && !_),
             a.toggleClass(ue.disabledCell, te),
             a.toggleClass(ue.activeCell, ie && !(ee && te)),
             p || h || a.toggleClass(ue.todayCell, !ee && oe);
            var ae = {
             mode: s,
             adjacent: ee,
             disabled: te,
            ...
            de.cell(a, J, ae),
             le.helper.dateEqual(J, u, s) && le.set.focusDate(J, !1, !1);
           }
          if (ce.today) {
         ...
         t.find("td").each(function () {
          ...
          if (t) {
           var n = e.hasClass(ue.disabledCell),
            ...
            r =
             !!d &&
             ((!!c && le.helper.isDateInRange(t, s, c, d)) ||
              (!!u && le.helper.isDateInRange(t, s, d, u)));
           e.toggleClass(
            ue.focusCell,
            a && (!f || g) && (!o || (ce.selectAdjacentDays && o)) && !n
           ),
            le.helper.isTodayButton(e) ||
             e.toggleClass(ue.rangeCell, r && !i && !n);
          }
         });
        },
       },
       ...
       refreshTooltips: function () {
        ...
        ge.find("td[data-position]").each(function () {
         var e = ve(this),
          ...
          i =
           o - e.width() - (parseInt(t, 10) || 250) > e.offset().left
            ? "right"
            : "left";
         -1 === n.indexOf(i) &&
          e.attr("data-position", n.replace(/(left|right)/, i));
        });
       },
       bind: {
        events: function () {
         le.debug("Binding events"),
          ge.on("mousedown" + i, le.event.mousedown),
          ge.on("touchstart" + i, le.event.mousedown),
          ge.on("mouseup" + i, le.event.mouseup),
          ge.on("touchend" + i, le.event.mouseup),
          ge.on("mouseover" + i, le.event.mouseover),
          c.length
           ? (c.on("input" + i, le.event.inputChange),
             c.on("focus" + i, le.event.inputFocus),
             c.on("blur" + i, le.event.inputBlur),
             c.on("keydown" + i, le.event.keydown))
           : ge.on("keydown" + i, le.event.keydown);
        },
       },
       unbind: {
        events: function () {
       ...
       event: {
        ...
        mouseup: function (e) {
         ...
         if (!t.hasClass("disabled")) {
          var n = t.parent();
          (n.data(fe.date) || n.data(fe.focusDate) || n.data(fe.mode)) &&
           (t = n);
        ...
        keydown: function (e) {
         var t = e.which;
         if (
          ((27 !== t && 9 !== t) || le.popup("hide"), le.popup("is visible"))
         )
          if (37 === t || 38 === t || 39 === t || 40 === t) {
           ...
           "time" === ce.type && (u = le.helper.mergeDateTime(o, u)),
            le.helper.isDateInRange(u, d) && le.set.focusDate(u);
          } else if (13 === t) {
           var d = le.get.mode(),
            f = le.get.focusDate();
           f &&
            !ce.isDisabled(f, d) &&
            !le.helper.isDisabled(f, d) &&
            le.helper.isEnabled(f, d) &&
            le.selectDate(f),
            e.preventDefault(),
            e.stopPropagation();
          }
       ...
       observeChanges: function () {
        "MutationObserver" in S &&
         ((e = new MutationObserver(le.event.class.mutation)),
         le.debug("Setting up mutation observer", e),
         le.observe.class());
       },
       disconnect: {
       ...
       observe: {
        class: function () {
         c.length && e && e.observe(l[0], { attributes: !0 });
        },
       },
       is: {
        disabled: function () {
       ...
       get: {
        weekOfYear: function (e, t, n) {
         var i, o, a;
         return (
          (i = Date.UTC(e, t, n + 3) / 864e5),
          (o = Math.floor(i / 7)),
          (a = new Date(6048e5 * o).getUTCFullYear()),
          o - Math.floor(Date.UTC(a, 0, 7) / 6048e5) + 1
         );
        },
        date: function () {
        ...
        validModes: function () {
         ...
         return (
          "time" !== ce.type &&
           ((ce.disableYear && "year" !== ce.type) || e.push("year"),
           ((ce.disableMonth || "year" === ce.type) && "month" !== ce.type) ||
            e.push("month"),
           0 <= ce.type.indexOf("date") && e.push("day")),
          0 <= ce.type.indexOf("time") &&
           (e.push("hour"), ce.disableMinute || e.push("minute")),
          e
         );
        },
        isTouch: function () {
       ...
       set: {
        ...
        focusDate: function (e, t, n, i) {
         ...
         if (o && e && a) {
          var r =
           12 * (e.getFullYear() - a.getFullYear()) +
           e.getMonth() -
           a.getMonth();
          if (r) {
        ...
        minDate: function (e) {
         (e = le.helper.sanitiseDate(e)),
          null !== ce.maxDate && ce.maxDate <= e
           ? le.verbose(
              "Unable to set minDate variable bigger that maxDate variable",
              e,
              ce.maxDate
             )
           : (le.setting("minDate", e), le.set.dataKeyValue(fe.minDate, e));
        },
        maxDate: function (e) {
         (e = le.helper.sanitiseDate(e)),
          null !== ce.minDate && ce.minDate >= e
           ? le.verbose(
              "Unable to set maxDate variable lower that minDate variable",
              e,
              ce.minDate
             )
           : (le.setting("maxDate", e), le.set.dataKeyValue(fe.maxDate, e));
        },
        monthOffset: function (e, t) {
         var n = Math.max(ce.multiMonth, 1);
         (e = Math.max(1 - n, Math.min(0, e))),
          le.set.dataKeyValue(fe.monthOffset, e, t);
        },
        mode: function (e, t) {
       ...
       selectDate: function (e, t) {
        ...
        if (
         t ||
         "minute" === n ||
         (ce.disableMinute && "hour" === n) ||
         ("date" === ce.type && "day" === n) ||
         ("month" === ce.type && "month" === n) ||
         ("year" === ce.type && "year" === n)
        ) {
       ...
       helper: {
        isDisabled: function (n, i) {
         return (
          ...
          (("day" === i && -1 !== ce.disabledDaysOfWeek.indexOf(n.getDay())) ||
           ce.disabledDates.some(function (e) {
            if (
             ("string" == typeof e && (e = le.helper.sanitiseDate(e)),
             e instanceof Date)
            )
             return le.helper.dateEqual(n, e, i);
            if (null !== e && "object" == typeof e)
             if (e[fe.year]) {
              if ("number" == typeof e[fe.year])
               return n.getFullYear() == e[fe.year];
              if (Array.isArray(e[fe.year]))
               return -1 < e[fe.year].indexOf(n.getFullYear());
             } else if (e[fe.month]) {
              if ("number" == typeof e[fe.month])
               return n.getMonth() == e[fe.month];
              if (Array.isArray(e[fe.month]))
               return -1 < e[fe.month].indexOf(n.getMonth());
              ...
              if (e[fe.date] instanceof Date)
               return le.helper.dateEqual(
                n,
                le.helper.sanitiseDate(e[fe.date]),
                i
               );
              if (Array.isArray(e[fe.date]))
               return e[fe.date].some(function (e) {
                return le.helper.dateEqual(n, e, i);
               });
             }
           }))
        ...
        isEnabled: function (t, n) {
         return (
          "day" !== n ||
          0 === ce.enabledDates.length ||
          ce.enabledDates.some(function (e) {
           return (
            "string" == typeof e && (e = le.helper.sanitiseDate(e)),
            e instanceof Date
             ? le.helper.dateEqual(t, e, n)
             : null !== e && "object" == typeof e && e[fe.date]
             ? le.helper.dateEqual(t, le.helper.sanitiseDate(e[fe.date]), n)
             : void 0
           );
          })
         );
        ...
        findDayAsObject: function (t, n, e) {
         if ("day" === n || "month" === n || "year" === n)
          for (var i, o = 0; o < e.length; o++) {
           if (
            ("string" == typeof (i = e[o]) && (i = le.helper.sanitiseDate(i)),
            i instanceof Date && le.helper.dateEqual(t, i, n))
           ) {
            var a = {};
           ...
           if (null !== i && "object" == typeof i)
            if (i[fe.year]) {
             if ("number" == typeof i[fe.year] && t.getFullYear() == i[fe.year])
              return i;
             if (
              Array.isArray(i[fe.year]) &&
              -1 < i[fe.year].indexOf(t.getFullYear())
             )
              return i;
            } else if (i[fe.month]) {
             if ("number" == typeof i[fe.month] && t.getMonth() == i[fe.month])
              return i;
             ...
             if (
              i[fe.date] instanceof Date &&
              le.helper.dateEqual(t, le.helper.sanitiseDate(i[fe.date]), n)
             )
              return i;
             if (
              Array.isArray(i[fe.date]) &&
              i[fe.date].some(function (e) {
        ...
        sanitiseDate: function (e) {
         return (
          e instanceof Date || (e = n.date("" + e, ce)),
          !e || isNaN(e.getTime()) ? null : e
         );
        },
        dateDiff: function (e, t, n) {
         ...
         return (
          (e = new Date(
           ...
           i ? 1 : a ? 1 : e.getDate(),
           s ? e.getHours() : 0,
           r ? ce.minTimeGap * Math.floor(e.getMinutes() / ce.minTimeGap) : 0
          )),
          (t = new Date(
           i ? 2e3 : t.getFullYear(),
           i ? 0 : o ? 0 : t.getMonth(),
           i ? 1 : a ? 1 : t.getDate(),
           s ? t.getHours() : 0,
           r ? ce.minTimeGap * Math.floor(t.getMinutes() / ce.minTimeGap) : 0
          )).getTime() - e.getTime()
         );
        },
        ...
        isDateInRange: function (e, t, n, i) {
         if (!n && !i) {
          ...
          (n =
           o && ce.minDate
            ? new Date(Math.max(o, ce.minDate))
            : o || ce.minDate),
           (i = ce.maxDate);
         }
         return (
          (n =
           ...
           new Date(
            ...
            n.getDate(),
            n.getHours(),
            ce.minTimeGap * Math.ceil(n.getMinutes() / ce.minTimeGap)
           )),
          !(
           !e ||
           (n && 0 < le.helper.dateDiff(e, n, t)) ||
           (i && 0 < le.helper.dateDiff(i, e, t))
          )
         );
        },
        dateInRange: function (e, t, n) {
         if (!t && !n) {
          ...
          (t =
           i && ce.minDate
            ? new Date(Math.max(i, ce.minDate))
            : i || ce.minDate),
           (n = ce.maxDate);
         }
         t =
          ...
          new Date(
           ...
           t.getDate(),
           t.getHours(),
           ce.minTimeGap * Math.ceil(t.getMinutes() / ce.minTimeGap)
          );
         var o = "time" === ce.type;
         return e
          ? t && 0 < le.helper.dateDiff(e, t, "minute")
            ? o
              ? le.helper.mergeDateTime(e, t)
              : t
            : n && 0 < le.helper.dateDiff(n, e, "minute")
            ? o
              ? le.helper.mergeDateTime(e, n)
              : n
            : e
          : e;
        },
       ...
       setting: function (e, t) {
        if ((le.debug("Changing setting", e, t), ve.isPlainObject(e)))
         ve.extend(!0, ce, e);
        else {
         if (t === be) return ce[e];
       ...
       debug: function () {
        !ce.silent &&
         ce.debug &&
         (ce.performance
          ? le.performance.log(arguments)
          : ((le.debug = Function.prototype.bind.call(
             console.info,
             console,
             ce.name + ":"
            )),
            le.debug.apply(console, arguments)));
       },
       verbose: function () {
        !ce.silent &&
         ce.verbose &&
         ...
         (ce.performance
          ? le.performance.log(arguments)
          : ((le.verbose = Function.prototype.bind.call(
             console.info,
             console,
             ce.name + ":"
            )),
            le.verbose.apply(console, arguments)));
       },
       error: function () {
        ce.silent ||
         ((le.error = Function.prototype.bind.call(
          console.error,
          console,
          ce.name + ":"
         )),
         le.error.apply(console, arguments));
       },
       performance: {
        log: function (e) {
         var t, n;
         ce.performance &&
          ...
          clearTimeout(le.performance.timer),
          (le.performance.timer = setTimeout(le.performance.display, 500));
        },
        display: function () {
         var e = ce.name + ":",
          n = 0;
         (y = !1),
          clearTimeout(le.performance.timer),
          ve.each(x, function (e, t) {
           n += t["Execution Time"];
          }),
          (e += " " + n + "ms"),
          b && (e += " '" + b + "'"),
          (console.group !== be || console.table !== be) &&
           0 < x.length &&
           (console.groupCollapsed(e),
           console.table
            ? console.table(x)
         ...
         "string" == typeof i &&
          ...
          ve.each(i, function (e, t) {
           ...
           if (ve.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (!ve.isPlainObject(r[t]) || e == o)
             return r[t] !== be ? (a = r[t]) : le.error(s.method, i), !1;
            r = r[t];
           }
          })),
         ve.isFunction(a) ? (n = a.apply(t, e)) : a !== be && (n = a),
         Array.isArray(v)
          ? v.push(n)
          : v !== be
          ? (v = [v, n])
       ...
       w
        ? (m === be && le.initialize(), le.invoke(C))
        : (m !== be && m.invoke("destroy"), le.initialize());
     }),
     v !== be ? v : this
    );
   }),
   (ve.fn.calendar.settings = {
    ...
    formatter: {
     ...
     time: function (e, t, n) {
      ...
      return (
       t.ampm &&
        ((a = " " + (i < 12 ? t.text.am : t.text.pm)),
        (i = 0 === i ? 12 : 12 < i ? i - 12 : i)),
       i + ":" + (o < 10 ? "0" : "") + o + a
      );
     },
     today: function (e) {
    ...
    parser: {
     date: function (e, t) {
      ...
      e.match(/^[0-9]{4}[\/\-\.][0-9]{1,2}[\/\-\.][0-9]{1,2}$/) &&
       (e = e.replace(/[\/\-\.]/g, "/") + " 00:00:00"),
       (e =
        t.monthFirst || !e.match(/^[0-9]{1,2}[\/\-\.]/)
         ? e
         : e.replace(/[\/\-\.]/g, "/").replace(/([0-9]+)\/([0-9]+)/, "$2/$1"));
      var n,
       i,
       o,
       a = new Date(e);
      ...
      if (!h)
       for (
        g =
         0 <= ve.inArray(t.text.am.toLowerCase(), v) ||
         (!(0 <= ve.inArray(t.text.pm.toLowerCase(), v)) && be),
         n = 0;
        n < b.length;
        n++
       )
        if (0 <= (s = b[n]).indexOf(":")) {
         if (u < 0 || c < 0)
          for (l = s.split(":"), o = 0; o < Math.min(2, l.length); o++)
           (i = parseInt(l[o])),
            isNaN(i) && (i = 0),
            0 === o ? (u = i % 24) : (c = i % 60);
         b.splice(n, 1);
      ...
      if (!p) {
       ...
       for (n = 0; n < b.length; n++)
        if (
         ((i = parseInt(b[n])),
         !isNaN(i) && i >= t.centuryBreak && n === b.length - 1)
        ) {
      ...
      c < 0 && (c = 0),
       ...
       d < 0 && (d = 1),
       f < 0 && (f = 1),
       m < 0 && (m = new Date().getFullYear()),
       g !== be && (g ? 12 === u && (u = 0) : u < 12 && (u += 12));
      var y = new Date(m, f - 1, d, u, c);
      return (
       (y.getMonth() === f - 1 && y.getFullYear() === m) ||
        (y = new Date(m, f, 0, u, c)),
       isNaN(y.getTime()) ? null : y
      );
     },
    },
 ...
 (function (S, D, A, E) {
  ...
  (S.isFunction =
   ...
   (D =
    void 0 !== D && D.Math == Math
     ? D
     : "undefined" != typeof self && self.Math == Math
     ? self
     : Function("return this")()),
   (S.fn.checkbox = function (u) {
    var d,
     e = S(this),
     f = e.selector || "",
     x = new Date().getTime(),
     ...
     e.each(function () {
      ...
      (m = {
       ...
       fix: {
        reference: function () {
         h.is(p.input) &&
          (m.debug("Behavior called on <input> adjusting invoked element"),
          (h = h.closest(p.checkbox)),
          m.refresh());
        },
       },
       setup: function () {
        m.set.initialLoad(),
         m.is.indeterminate()
          ? (m.debug("Initial value is indeterminate"), m.indeterminate())
          : m.is.checked()
       ...
       attachEvents: function (e, t) {
        var n = S(e);
        (t = S.isFunction(m[t]) ? m[t] : m.toggle),
         0 < n.length
          ? (m.debug("Attaching checkbox events to element", e, t),
            n.on("click" + i, t))
          : m.error(s.notFound);
       },
       ...
       event: {
        ...
        click: function (e) {
         var t = S(e.target);
         t.is(p.input)
          ? m.verbose("Using default check action on initialized checkbox")
          : t.is(p.link)
          ? m.debug("Clicking link inside checkbox, skipping toggle")
          : (m.toggle(), v.focus(), e.preventDefault());
        },
        keydown: function (e) {
         var t = e.which,
          n = 13,
         ...
         if (
          (t == a || t == r
           ? (f = (0 === u ? d : u) - 1)
           : (t != s && t != l) || (f = u === d - 1 ? 0 : u + 1),
          !m.should.ignoreCallbacks() && !1 !== f)
         ) {
          if (!1 === g.beforeUnchecked.apply(b))
           return (
            m.verbose(
          ...
          if (!1 === g.beforeChecked.apply(S(c[f]).children(p.input)[0]))
           return (
            m.verbose(
         ...
         y =
          t == o
           ? (m.verbose("Escape key pressed blurring field"), v.blur(), !0)
           : !(e.ctrlKey || !(t == i || (t == n && g.enableEnterKey))) &&
       ...
       check: function () {
        m.should.allowCheck() &&
         (m.debug("Checking checkbox", v),
         m.set.checked(),
         m.should.ignoreCallbacks() ||
          (g.onChecked.call(b), m.trigger.change()),
         m.preventDefaultOnInputTarget());
       },
       uncheck: function () {
        m.should.allowUncheck() &&
         ...
         m.set.unchecked(),
         m.should.ignoreCallbacks() ||
          (g.onUnchecked.call(b), m.trigger.change()),
         m.preventDefaultOnInputTarget());
       },
       indeterminate: function () {
        m.should.allowIndeterminate()
         ...
         : (m.debug("Making checkbox indeterminate"),
           m.set.indeterminate(),
           m.should.ignoreCallbacks() ||
            (g.onIndeterminate.call(b), m.trigger.change()));
       },
       determinate: function () {
        m.should.allowDeterminate()
         ...
         : (m.debug("Making checkbox determinate"),
           m.set.determinate(),
           m.should.ignoreCallbacks() ||
            (g.onDeterminate.call(b), m.trigger.change()));
       },
       enable: function () {
        m.is.enabled()
         ...
         : (m.debug("Enabling checkbox"),
           m.set.enabled(),
           m.should.ignoreCallbacks() ||
            (g.onEnable.call(b), g.onEnabled.call(b), m.trigger.change()));
       },
       disable: function () {
        m.is.disabled()
         ...
         : (m.debug("Disabling checkbox"),
           m.set.disabled(),
           m.should.ignoreCallbacks() ||
            (g.onDisable.call(b), g.onDisabled.call(b), m.trigger.change()));
       },
       get: {
        radios: function () {
         var e = m.get.name();
       ...
       should: {
        allowCheck: function () {
         return m.is.determinate() && m.is.checked() && !m.is.initialLoad()
          ? (m.debug("Should not allow check, checkbox is already checked"), !1)
          : !(!m.should.ignoreCallbacks() && !1 === g.beforeChecked.apply(b)) ||
             (m.debug("Should not allow check, beforeChecked cancelled"), !1);
        },
        allowUncheck: function () {
         return m.is.determinate() && m.is.unchecked() && !m.is.initialLoad()
          ? (m.debug("Should not allow uncheck, checkbox is already unchecked"),
            !1)
          : !(
             !m.should.ignoreCallbacks() && !1 === g.beforeUnchecked.apply(b)
            ) ||
             (m.debug("Should not allow uncheck, beforeUnchecked cancelled"),
             !1);
        },
        allowIndeterminate: function () {
         return m.is.indeterminate() && !m.is.initialLoad()
          ? (m.debug(
          ...
          : !(
             !m.should.ignoreCallbacks() &&
             !1 === g.beforeIndeterminate.apply(b)
            ) ||
             (m.debug(
        ...
        allowDeterminate: function () {
         return m.is.determinate() && !m.is.initialLoad()
          ? (m.debug(
             "Should not allow determinate, checkbox is already determinate"
            ),
            !1)
          : !(
             !m.should.ignoreCallbacks() && !1 === g.beforeDeterminate.apply(b)
            ) ||
             (m.debug(
       ...
       set: {
        ...
        checked: function () {
         m.verbose("Setting class to checked"),
          ...
          m.is.indeterminate() || !m.is.checked()
           ? (m.verbose("Setting state to checked", b),
             v.prop("indeterminate", !1).prop("checked", !0))
           : m.debug(
         ...
         m.verbose("Removing checked class"),
          ...
          m.is.indeterminate() || !m.is.unchecked()
           ? (m.debug("Setting state to unchecked"),
             v.prop("indeterminate", !1).prop("checked", !1))
        ...
        enabled: function () {
         m.verbose("Removing disabled class"),
          ...
          m.is.enabled()
           ? m.debug("Input is already enabled, skipping input property change")
           : (m.debug("Setting state to enabled"), v.prop("disabled", !1));
        },
        tabbable: function () {
         m.verbose("Adding tabindex to checkbox"),
          v.attr("tabindex") === E && v.attr("tabindex", 0);
        },
       },
       remove: {
        initialLoad: function () {
       ...
       create: {
        label: function () {
         0 < v.prevAll(p.label).length
          ? (v.prev(p.label).detach().insertAfter(v),
            m.debug("Moving existing label", a))
          : m.has.label() ||
            ((a = S("<label>").insertAfter(v)), m.debug("Creating label", a));
        },
       },
       has: {
        label: function () {
       ...
       bind: {
        events: function () {
         m.verbose("Attaching checkbox events"),
          h
           .on("click" + i, m.event.click)
           .on("change" + i, m.event.change)
           .on("keydown" + i, p.input, m.event.keydown)
           .on("keyup" + i, p.input, m.event.keyup);
        },
       },
       unbind: {
        events: function () {
       ...
       toggle: function () {
        m.can.change()
         ...
         : m.is.radio() ||
           m.debug("Checkbox is read-only or disabled, ignoring toggle");
       },
       setting: function (e, t) {
        if ((m.debug("Changing setting", e, t), S.isPlainObject(e)))
         S.extend(!0, g, e);
        else {
         if (t === E) return g[e];
          ...
          S.each(i, function (e, t) {
           ...
           if (S.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (!S.isPlainObject(r[t]) || e == o)
             return r[t] !== E ? (a = r[t]) : m.error(s.method, i), !1;
            r = r[t];
           }
          })),
         S.isFunction(a) ? (n = a.apply(t, e)) : a !== E && (n = a),
         Array.isArray(d)
          ? d.push(n)
          : d !== E
          ? (d = [d, n])
       ...
       k
        ? (l === E && m.initialize(), m.invoke(w))
        : (l !== E && l.invoke("destroy"), m.initialize());
     }),
     d !== E ? d : this
    );
   }),
    ...
    return (
     v.each(function () {
      ...
      (s = {
       preinitialize: function () {
        o = s.is.dimmer()
         ...
         : ((t = f),
           s.has.dimmer()
            ? a.dimmerName
              ? t.find(n.dimmer).filter("." + a.dimmerName)
              : t.find(n.dimmer)
            : s.create());
       },
       initialize: function () {
        s.debug("Initializing dimmer", a),
         s.bind.events(),
         s.set.dimmable(),
         s.instantiate();
       },
       ...
       destroy: function () {
        s.verbose("Destroying previous module", o),
         s.unbind.events(),
         s.remove.variation(),
         t.off(r);
       },
       bind: {
        events: function () {
         "hover" == a.on
          ? t.on("mouseenter" + r, s.show).on("mouseleave" + r, s.hide)
          : "click" == a.on && t.on(d + r, s.toggle),
          s.is.page() &&
           (s.debug("Setting as a page dimmer", t), s.set.pageDimmer()),
          s.is.closable() &&
           (s.verbose("Adding dimmer close event", o),
           t.on(d + r, n.dimmer, s.event.click));
        },
       },
       unbind: {
        events: function () {
       ...
       event: {
        click: function (e) {
         s.verbose("Determining if event occurred on dimmer", e),
          (0 !== o.find(e.target).length && !k(e.target).is(n.content)) ||
       ...
       addContent: function (e) {
        ...
        s.debug("Add content to dimmer", t),
         t.parent()[0] !== o[0] && t.detach().appendTo(o);
       },
       create: function () {
        var e = k(a.template.dimmer(a));
        return (
         a.dimmerName &&
          (s.debug("Creating named dimmer", a.dimmerName),
       ...
       toggle: function () {
        s.verbose("Toggling dimmer visibility", o),
         s.is.dimmed() ? s.is.closable() && s.hide() : s.show();
       },
       animate: {
        show: function (e) {
         (e = k.isFunction(e) ? e : function () {}),
          a.useCSS && k.fn.transition !== S && o.transition("is supported")
           ? (a.useFlex
              ? (s.debug("Using flex dimmer"), s.remove.legacy())
              : (s.debug("Using legacy non-flex dimmer"), s.set.legacy()),
             "auto" !== a.opacity && s.set.opacity(),
             o.transition({
         ...
         (e = k.isFunction(e) ? e : function () {}),
          a.useCSS && k.fn.transition !== S && o.transition("is supported")
           ...
           : (s.verbose("Hiding dimmer with javascript"),
             o.stop().fadeOut(s.get.duration(), function () {
       ...
       get: {
        ...
        duration: function () {
         return s.is.active()
          ? a.transition.hideDuration || a.duration.hide || a.duration
          : a.transition.showDuration || a.duration.show || a.duration;
        },
       },
       has: {
        dimmer: function () {
         return a.dimmerName
          ? 0 < f.find(n.dimmer).filter("." + a.dimmerName).length
       ...
       set: {
        opacity: function (e) {
         var t = o.css("background-color"),
          n = t.split(","),
          i = n && 3 <= n.length;
         (e = 0 === a.opacity ? 0 : a.opacity || e),
          (t = i
           ? ((n[2] = n[2].replace(")", "")), (n[3] = e + ")"), n.join(","))
           : "rgba(0, 0, 0, " + e + ")"),
         ...
         "string" == typeof i &&
          ...
          k.each(i, function (e, t) {
           ...
           if (k.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (r[n] !== S) return (a = r[n]), !1;
            if (!k.isPlainObject(r[t]) || e == o)
             return r[t] !== S ? (a = r[t]) : s.error(l.method, i), !1;
            r = r[t];
           }
          })),
         k.isFunction(a) ? (n = a.apply(t, e)) : a !== S && (n = a),
       ...
       C
        ? (g === S && s.initialize(), s.invoke(x))
        : (g !== S && g.invoke("destroy"), s.initialize());
     }),
     h !== S ? h : this
    );
   }),
    ...
    template: {
     dimmer: function (e) {
      ...
      return (
       e.displayLoader &&
        ((t = k("<div/>")
         .addClass(e.className.loader)
         .addClass(e.loaderVariation)),
        e.loaderText && (t.text(e.loaderText), t.addClass("text")),
        n.append(t)),
       n
      );
     },
 ...
 (function (te, ne, ie, oe) {
  ...
  (te.isFunction =
   ...
   (ne =
    void 0 !== ne && ne.Math == Math
     ? ne
     : "undefined" != typeof self && self.Math == Math
     ? self
     : Function("return this")()),
   (te.fn.dropdown = function (B) {
    var W,
     Y = te(this),
     Q = te(ie),
     X = Y.selector || "",
    ...
    return (
     Y.each(function (n) {
      var d,
       ...
       l,
       p,
       g = te.isPlainObject(B)
        ? te.extend(!0, {}, te.fn.dropdown.settings, B)
        : te.extend({}, te.fn.dropdown.settings),
       h = g.className,
       f = g.message,
       c = g.fields,
       v = g.keys,
      ...
      (p = {
       initialize: function () {
        p.debug("Initializing dropdown", g),
         p.is.alreadySetup()
          ? p.setup.reference()
          : (g.ignoreDiacritics &&
             !String.prototype.normalize &&
             ((g.ignoreDiacritics = !1), p.error(x.noNormalize, N)),
            p.setup.layout(),
            g.values &&
             (p.set.initialLoad(),
             p.change.values(g.values),
       ...
       destroy: function () {
        p.verbose("Destroying previous dropdown", T),
         p.remove.tabbable(),
         p.remove.active(),
         M.transition("stop all"),
         M.removeClass(h.visible).addClass(h.hidden),
         T.off(w).removeData(k),
         M.off(w),
         Q.off(o),
         p.disconnect.menuObserver(),
         p.disconnect.selectObserver(),
         p.disconnect.classObserver();
       },
       observeChanges: function () {
        "MutationObserver" in ne &&
         ((r = new MutationObserver(p.event.select.mutation)),
         (s = new MutationObserver(p.event.menu.mutation)),
         (l = new MutationObserver(p.event.class.mutation)),
         p.debug("Setting up mutation observer", r, s, l),
         p.observe.select(),
         p.observe.menu(),
         p.observe.class());
       },
       ...
       observe: {
        select: function () {
         p.has.input() && r && r.observe(T[0], { childList: !0, subtree: !0 });
        },
        menu: function () {
         p.has.menu() && s && s.observe(M[0], { childList: !0, subtree: !0 });
        },
        class: function () {
         p.has.search() && l && l.observe(T[0], { attributes: !0 });
        },
       },
       create: {
        id: function () {
         (a = (Math.random().toString(16) + "000000000").substr(2, 8)),
          (o = "." + a),
          p.verbose("Creating unique id for element", a);
        },
        userChoice: function (e) {
         var n, i, o;
         return (
          !!(e = e || p.get.userValues()) &&
          ((e = Array.isArray(e) ? e : [e]),
          te.each(e, function (e, t) {
           !1 === p.get.item(t) &&
            ((o = g.templates.addition(p.add.variables(f.addResult, t))),
            (i = te("<div />")
             .html(o)
             .attr("data-" + b.value, t)
             .attr("data-" + b.text, t)
             .addClass(h.addition)
             .addClass(h.item)),
            g.hideAdditions && i.addClass(h.hidden),
            (n = n === oe ? i : n.add(i)),
            p.verbose("Creating user choices for value", t, i));
          }),
          n)
         );
        },
       ...
       search: function (e) {
        (e = e !== oe ? e : p.get.query()),
         p.verbose("Searching for query", e),
         !1 === g.fireOnInit && p.is.initialLoad()
          ? p.verbose("Skipping callback on initial load", g.onSearch)
          : p.has.minCharacters(e) && !1 !== g.onSearch.call(N, e)
          ? p.filter(e)
          : p.hide(null, !0);
       },
       select: {
        firstUnfiltered: function () {
         p.verbose("Selecting first non-filtered element"),
          p.remove.selectedItem(),
          I.not(y.unselectable)
        ...
        nextAvailable: function (e) {
         ...
         0 < t.length
          ? (p.verbose("Moving selection to", t), t.addClass(h.selected))
          : (p.verbose("Moving selection to", n), n.addClass(h.selected));
        },
       },
       setup: {
        api: function () {
         var e = {
          debug: g.debug,
          urlData: { value: p.get.value(), query: p.get.query() },
          on: !1,
         };
         p.verbose("First request, initializing API"), T.api(e);
        },
        layout: function () {
         T.is("select") && (p.setup.select(), p.setup.returnedObject()),
          p.has.menu() || p.create.menu(),
          p.is.clearable() &&
           !p.has.clearItem() &&
           (p.verbose("Adding clear icon"),
           (O = te("<i />").addClass("remove icon").insertBefore(D))),
          p.is.search() &&
           !p.has.search() &&
           (p.verbose("Adding search input"),
           (A = te("<input />")
            .addClass(h.search)
            .prop("autocomplete", p.is.chrome() ? "fomantic-search" : "off")
            .insertBefore(D))),
          p.is.multiple() &&
           p.is.searchSelection() &&
           !p.has.sizer() &&
           p.create.sizer(),
        ...
        select: function () {
         ...
         p.debug("Dropdown initialized on a select", e),
          T.is("select") && (F = T),
          0 < F.parent(y.dropdown).length
           ? (p.debug(
              "UI dropdown already exists. Creating dropdown menu only"
             ),
             (T = F.closest(y.dropdown)),
             p.has.menu() || p.create.menu(),
             (M = T.children(y.menu)),
             p.setup.menu(e))
           : (p.debug("Creating entire dropdown from select"),
             (T = te("<div />")
              .attr("class", F.attr("class"))
              .addClass(h.selection)
              .addClass(h.dropdown)
              .html(C.dropdown(e, c, g.preserveHTML, g.className))
              .insertBefore(F)),
             F.hasClass(h.multiple) &&
              !1 === F.prop("multiple") &&
              (p.error(x.missingMultiple), F.prop("multiple", !0)),
             F.is("[multiple]") && p.set.multiple(),
             F.prop("disabled") &&
              (p.debug("Disabling dropdown"), T.addClass(h.disabled)),
        ...
        menu: function (e) {
         M.html(C.menu(e, c, g.preserveHTML, g.className)),
          (I = M.find(y.item)),
          (j = g.hideDividers ? I.parent().children(y.divider) : te());
        },
        reference: function () {
         p.debug(
          ...
          (T = T.parent(y.dropdown)),
          (U = T.data(k)),
          (N = T.get(0)),
          p.refresh(),
          p.setup.returnedObject();
        },
       ...
       refreshSelectors: function () {
        p.verbose("Refreshing selector cache"),
         ...
         (P = T.find(y.icon)),
         (R =
          0 < T.prev().find(y.text).length ? T.prev().find(y.text) : T.prev()),
         (M = T.children(y.menu)),
         (I = M.find(y.item)),
         (j = g.hideDividers ? I.parent().children(y.divider) : te());
       },
       refreshData: function () {
        p.verbose("Refreshing cached metadata"),
         I.removeData(b.text).removeData(b.value);
       },
       clearData: function () {
        p.verbose("Clearing metadata"),
         I.removeData(b.text).removeData(b.value),
         T.removeData(b.defaultText)
       ...
       toggle: function () {
        p.verbose("Toggling menu visibility"),
         p.is.active() ? p.hide() : p.show();
       },
       show: function (e, t) {
        if (
         ((e = te.isFunction(e) ? e : function () {}),
         (H || z) && p.is.remote() && p.is.noApiCache() && p.clearItems(),
         !p.can.show() &&
          p.is.remote() &&
          (p.debug("No API results retrieved, searching before show"),
          p.queryRemote(p.get.query(), p.show, [e, t])),
         p.can.show() && !p.is.active())
        ) {
         if (
          (p.debug("Showing dropdown"),
          !p.has.message() ||
           p.has.maxSelections() ||
           p.has.allResultsFiltered() ||
           p.remove.message(),
          p.is.allFiltered())
         )
          return !0;
         !1 !== g.onShow.call(N) &&
          p.animate.show(function () {
           p.can.click() && p.bind.intent(),
            p.has.search() && !t && p.focusSearch(),
            p.set.visible(),
            e.call(N);
          });
        }
       ...
       hide: function (e, t) {
        (e = te.isFunction(e) ? e : function () {}),
         p.is.active() && !p.is.animatingOutward()
          ? (p.debug("Hiding dropdown"),
            !1 !== g.onHide.call(N) &&
             p.animate.hide(function () {
              p.remove.visible(),
               p.is.focusedOnSearch() && !0 !== t && A.blur(),
               e.call(N);
             }))
       ...
       hideOthers: function () {
        p.verbose("Finding other dropdowns to hide"),
         Y.not(T)
          .has(y.menu + "." + h.visible)
          .dropdown("hide");
       },
       hideMenu: function () {
        p.verbose("Hiding menu  instantaneously"),
         p.remove.active(),
         p.remove.visible(),
         M.transition("hide");
       },
       ...
       bind: {
        ...
        keyboardEvents: function () {
         p.verbose("Binding keyboard events"),
          T.on("keydown" + w, p.event.keydown),
          p.has.search() &&
           T.on(p.get.inputEvent() + w, y.search, p.event.input),
          p.is.multiple() && Q.on("keydown" + o, p.event.document.keydown);
        },
        inputEvents: function () {
         p.verbose("Binding input change events"),
          T.on("change" + w, y.input, p.event.change);
        },
        mouseEvents: function () {
         p.verbose("Binding mouse events"),
          p.is.multiple() &&
           T.on($ + w, y.label, p.event.label.click).on(
            $ + w,
            y.remove,
            p.event.remove.click
           ),
          p.is.searchSelection()
           ? (T.on("mousedown" + w, p.event.mousedown)
              .on("mouseup" + w, p.event.mouseup)
              .on("mousedown" + w, y.menu, p.event.menu.mousedown)
              .on("mouseup" + w, y.menu, p.event.menu.mouseup)
              .on($ + w, y.icon, p.event.icon.click)
              .on($ + w, y.clearIcon, p.event.clearIcon.click)
              .on("focus" + w, y.search, p.event.search.focus)
              .on($ + w, y.search, p.event.search.focus)
              .on("blur" + w, y.search, p.event.search.blur)
              .on($ + w, y.text, p.event.text.focus),
             p.is.multiple() &&
              T.on($ + w, p.event.click).on($ + w, p.event.search.focus))
           : ("click" == g.on
              ? T.on($ + w, y.icon, p.event.icon.click).on(
                 $ + w,
                 p.event.test.toggle
                )
              : "hover" == g.on
              ? T.on("mouseenter" + w, p.delay.show).on(
                 "mouseleave" + w,
                 p.delay.hide
                )
              : T.on(g.on + w, p.toggle),
             T.on("mousedown" + w, p.event.mousedown)
              .on("mouseup" + w, p.event.mouseup)
              .on("focus" + w, p.event.focus)
              .on($ + w, y.clearIcon, p.event.clearIcon.click),
             p.has.menuSearch()
              ? T.on("blur" + w, y.search, p.event.search.blur)
              : T.on("blur" + w, p.event.blur)),
          M.on(
           (K ? "touchstart" : "mouseenter") + w,
           y.item,
           p.event.item.mouseenter
          )
           .on("mouseleave" + w, y.item, p.event.item.mouseleave)
           .on("click" + w, y.item, p.event.item.click);
        },
        intent: function () {
         p.verbose("Binding hide intent event to document"),
          K &&
           Q.on("touchstart" + o, p.event.test.touch).on(
            "touchmove" + o,
            p.event.test.touch
           ),
          Q.on($ + o, p.event.test.hide);
        },
       },
       unbind: {
        intent: function () {
         p.verbose("Removing hide intent event from document"),
          K && Q.off("touchstart" + o).off("touchmove" + o),
          Q.off($ + o);
        },
       },
       filter: function (e) {
        function t() {
         p.is.multiple() && p.filterActive(),
          (e || (!e && 0 == p.get.activeItem().length)) &&
           p.select.firstUnfiltered(),
          p.has.allResultsFiltered()
           ? g.onNoResults.call(N, n)
             ? g.allowAdditions
               ? g.hideAdditions &&
                 (p.verbose("User addition with no menu, setting empty style"),
                 p.set.empty(),
                 p.hideMenu())
               : (p.verbose("All items filtered, showing message", n),
                 p.add.message(f.noResults))
             : (p.verbose("All items filtered, hiding dropdown", n),
               p.hideMenu())
           : (p.remove.empty(), p.remove.message()),
          g.allowAdditions && p.add.userSuggestion(p.escape.htmlEntities(e)),
          p.is.searchSelection() &&
           p.can.show() &&
           p.is.focusedOnSearch() &&
           p.show();
        }
        var n = e !== oe ? e : p.get.query();
        (g.useLabels && p.has.maxSelections()) ||
         (g.apiSettings
          ? p.can.useAPI()
            ? p.queryRemote(n, function () {
         ...
         onSuccess: function (e) {
          ...
          if (
           ...
           "" !== i &&
            ...
            p.set.selected(i, null, null, !0));
          } else p.add.message(f.noResults);
          (H = z = !1), o.apply(null, a);
         },
        };
        T.api("get request") || p.setup.api(),
         (t = te.extend(!0, {}, t, g.apiSettings)),
         T.api("setting", t).api("query");
       },
       filterItems: function (e) {
        ...
        p.has.query() &&
         ((o = []),
         p.verbose("Searching for matching values", i),
         I.each(function () {
          var e,
           t,
           n = te(this);
          ...
          if ("both" === g.match || "text" === g.match) {
           if (
            -1 !==
            (e = p.remove.diacritics(String(p.get.choiceText(n, !1)))).search(a)
           )
            return o.push(this), !0;
           if ("exact" === g.fullTextSearch && p.exactSearch(i, e))
            return o.push(this), !0;
           if (!0 === g.fullTextSearch && p.fuzzySearch(i, e))
            return o.push(this), !0;
          }
          if ("both" === g.match || "value" === g.match) {
           if (
            -1 !==
            (t = p.remove.diacritics(String(p.get.choiceValue(n, e)))).search(a)
           )
            return o.push(this), !0;
           if ("exact" === g.fullTextSearch && p.exactSearch(i, t))
            return o.push(this), !0;
           if (!0 === g.fullTextSearch && p.fuzzySearch(i, t))
            return o.push(this), !0;
          }
         })),
         p.debug("Showing only matched items", i),
         p.remove.filteredItem(),
         o && I.not(o).addClass(h.filtered),
         p.has.query()
          ? !0 === g.hideDividers
            ? j.addClass(h.hidden)
            : "empty" === g.hideDividers &&
              j
               ...
               .filter(function () {
                ...
                return (
                 ...
                 (e.length ? e : te(this))
                  .nextUntil(y.divider)
                  .filter(y.item + ":not(." + h.filtered + ")").length
                );
               })
               .addClass(h.hidden)
          : j.removeClass(h.hidden);
       },
       ...
       focusSearch: function (e) {
        p.has.search() &&
         !p.is.focusedOnSearch() &&
         (e
          ? (T.off("focus" + w, y.search),
            A.focus(),
            T.on("focus" + w, y.search, p.event.search.focus))
          : A.focus());
       },
       blurSearch: function () {
        p.has.search() && A.blur();
       ...
       forceSelection: function () {
        var e = I.not(h.filtered)
         ...
         n = 0 < e.length ? e : t,
         i = 0 < n.length;
        g.allowAdditions || (i && !p.is.multiple())
         ? (p.debug("Forcing partial selection to selected item", n),
           p.event.item.click.call(n, {}, !0))
         : p.remove.searchTerm();
       },
       change: {
        values: function (e) {
         g.allowAdditions || p.clear(),
          p.debug("Creating dropdown with specified values", e);
         var t = {};
         (t[c.values] = e),
          p.setup.menu(t),
          te.each(e, function (e, t) {
           if (
            1 == t.selected &&
            (p.debug("Setting initial selection to", t[c.value]),
            p.set.selected(t[c.value]),
            !p.is.multiple())
           )
            return !1;
          }),
          p.has.selectInput() &&
           (p.disconnect.selectObserver(),
           F.html(""),
           F.append("<option disabled selected value></option>"),
           te.each(e, function (e, t) {
       ...
       event: {
        ...
        blur: function (e) {
         (t = ie.activeElement === this),
          L || t || (p.remove.activeLabel(), p.hide());
        },
        mousedown: function () {
        ...
        click: function (e) {
         te(e.target).is(T) &&
          (p.is.focusedOnSearch() ? p.show() : p.focusSearch());
        },
        search: {
         focus: function (e) {
          (L = !0),
           p.is.multiple() && p.remove.activeLabel(),
           H ||
            p.is.active() ||
          ...
          (t = ie.activeElement === this),
           p.is.searchSelection() &&
            ...
            (V ||
             ...
             (g.forceSelection
              ? p.forceSelection()
              : g.allowAdditions || p.remove.searchTerm(),
             p.hide())),
           (i = !1);
         },
        },
        clearIcon: {
         click: function (e) {
          p.clear(),
           p.is.searchSelection() && p.remove.searchTerm(),
           p.hide(),
           e.stopPropagation();
         },
        },
        ...
        input: function (e) {
         (p.is.multiple() || p.is.searchSelection()) && p.set.filtered(),
        ...
        remove: {
         click: function (e) {
          ...
          t.hasClass(h.active)
           ? p.remove.activeLabels()
           : p.remove.activeLabels(t),
           e.stopPropagation();
         },
        },
        test: {
         toggle: function (e) {
          ...
          p.is.bubbledLabelClick(e) ||
           p.is.bubbledIconClick(e) ||
           ((p.is.multiple() && (!p.is.multiple() || p.is.active())) ||
            (H = !0),
           p.determine.eventOnElement(e, t) && e.preventDefault());
         },
         touch: function (e) {
          p.determine.eventOnElement(e, function () {
           "touchstart" == e.type
            ...
            : "touchmove" == e.type && clearTimeout(p.timer);
          }),
           e.stopPropagation();
         },
         hide: function (e) {
        ...
        menu: {
         mutation: function (e) {
          ...
          a || r
           ? (p.debug("Updating item selector cache"), p.refreshItems())
           : (p.debug("Menu modified, updating selector cache"), p.refresh());
         },
         mousedown: function () {
          V = !0;
         },
        ...
        item: {
         mouseenter: function (e) {
          ...
          0 < i.find(t).length ||
           !a ||
           (clearTimeout(p.itemTimer),
           (p.itemTimer = setTimeout(function () {
            p.verbose("Showing sub-menu", i),
             te.each(o, function () {
         ...
         click: function (e, t) {
          var n = te(this),
           ...
           s = 0 < o.length,
           l = 0 < o.find(i).length;
          "input" !== ie.activeElement.tagName.toLowerCase() &&
           te(ie.activeElement).blur(),
           l ||
            (s && !g.allowCategorySelection) ||
            (p.is.searchSelection() &&
             (g.allowAdditions && p.remove.userAddition(),
             p.remove.searchTerm(),
             p.is.focusedOnSearch() || 1 == t || p.focusSearch(!0)),
            g.useLabels || (p.remove.filteredItem(), p.set.scrollPosition(n)),
            p.determine.selectAction.call(this, a, r));
         },
        },
        document: {
         keydown: function (e) {
          ...
          if (p.is.inObject(t, v)) {
           ...
           t == v.leftArrow
            ? (!f && !m) || r
              ? r &&
                (e.shiftKey
                 ? p.verbose("Adding previous label to selection")
                 : (p.verbose("Selecting previous label"),
            ...
            ? (f && !r && n.first().addClass(h.active),
              r &&
               (e.shiftKey
                ? p.verbose("Adding next label to selection")
                : (p.verbose("Selecting next label"), n.removeClass(h.active)),
               c
                ? u
                  ? d
                    ? n.removeClass(h.active)
            ...
            ? r
              ? (p.verbose("Removing active labels"),
                c && u && !d && p.focusSearch(),
                i.last().next(y.siblingLabel).addClass(h.active),
                p.remove.activeLabels(i),
                e.preventDefault())
              : !m ||
                g ||
                r ||
                t != v.backspace ||
                (p.verbose("Removing last label on input backspace"),
         ...
         if (p.is.inObject(t, v)) {
          ...
          if (
           (g.allowAdditions &&
            ...
            (t == v.enter || m) &&
            f &&
            (p.verbose("Selecting item from keyboard shortcut", a),
            p.event.item.click.call(a, e),
            p.is.searchSelection() && p.remove.searchTerm(),
            p.is.multiple() && e.preventDefault()),
           p.is.visible())
          ) {
           if (
            ((t != v.enter && !m) ||
             (t == v.enter && d && u && !g.allowCategorySelection
              ? (p.verbose(
              ...
              : f &&
                ...
                p.event.item.click.call(a, e),
                p.is.searchSelection() &&
                 (p.remove.searchTerm(), p.is.multiple() && A.focus())),
             e.preventDefault()),
            d &&
             (t == v.leftArrow &&
              l[0] !== M[0] &&
              (p.verbose("Left key pressed, closing sub-menu"),
              p.animate.hide(!1, l),
             ...
             t == v.rightArrow &&
              u &&
              (p.verbose("Right key pressed, opening sub-menu"),
              p.animate.show(!1, s),
              a.removeClass(h.selected),
            ...
            if (
             ...
             return (
              p.verbose("Up key pressed but reached top of current menu"),
              void e.preventDefault()
             );
            p.verbose("Up key pressed, changing active item"),
             a.removeClass(h.selected),
             n.addClass(h.selected),
             p.set.scrollPosition(n),
             g.selectOnKeydown && p.is.single() && p.set.selectedItem(n),
             e.preventDefault();
           }
           if (t == v.downArrow) {
            if (
             ...
             return (
              p.verbose("Down key pressed but reached bottom of current menu"),
              void e.preventDefault()
             );
            p.verbose("Down key pressed, changing active item"),
           ...
           t == v.pageUp && (p.scrollPage("up"), e.preventDefault()),
            t == v.pageDown && (p.scrollPage("down"), e.preventDefault()),
            t == v.escape &&
             (p.verbose("Escape key pressed, closing dropdown"), p.hide());
          } else
           m && e.preventDefault(),
            t != v.downArrow ||
             p.is.visible() ||
             (p.verbose("Down key pressed, showing dropdown"),
             p.show(),
             e.preventDefault());
       ...
       determine: {
        selectAction: function (e, t) {
         (d = !0),
          p.verbose("Determining action", g.action),
          te.isFunction(p.action[g.action])
           ? (p.verbose("Triggering preset action", g.action, e, t),
             p.action[g.action].call(N, e, t, this))
           : te.isFunction(g.action)
           ? (p.verbose("Triggering user action", g.action, e, t),
             g.action.call(N, e, t, this))
           : p.error(x.action, g.action),
          (d = !1);
        },
        eventInModule: function (e, t) {
         ...
         return (
          (t = te.isFunction(t) ? t : function () {}),
          i && !o
           ? (p.verbose("Triggering event", t), t(), !0)
           : (p.verbose("Event occurred in dropdown, canceling callback"), !1)
         );
        },
        eventOnElement: function (e, t) {
         ...
         return (
          ...
          o && a && r
           ? (p.verbose("Triggering event", t), t(), !0)
           : (p.verbose("Event occurred in dropdown menu, canceling callback"),
             !1)
         );
        },
       },
       action: {
        ...
        activate: function (e, t, n) {
         (t = t !== oe ? t : e),
          p.can.activate(te(n)) &&
           (p.set.selected(t, te(n)), p.is.multiple() || p.hideAndClear());
        },
        select: function (e, t, n) {
         (t = t !== oe ? t : e),
          p.can.activate(te(n)) &&
           (p.set.value(t, e, te(n)), p.is.multiple() || p.hideAndClear());
        },
       ...
       get: {
        ...
        searchWidth: function (e) {
         return (
          (e = e !== oe ? e : A.val()), E.text(e), Math.ceil(E.width() + 1)
         );
        },
        ...
        caretPosition: function (e) {
         var t,
          n,
          i = A.get(0);
         return e && "selectionEnd" in i
          ? i.selectionEnd
          : !e && "selectionStart" in i
          ? i.selectionStart
          : ie.selection
          ? (i.focus(),
            (n = (t = ie.selection.createRange()).text.length),
            e
             ? n
             : (t.moveStart("character", -i.value.length), t.text.length - n))
          : void 0;
        },
        value: function () {
        ...
        values: function (e) {
         ...
         return "" === t
          ? ""
          : !p.has.selectInput() && p.is.multiple()
          ? "string" == typeof t
            ? (e ? t : p.escape.htmlEntities(t)).split(g.delimiter)
            : ""
          : t;
        },
         ...
         return (
          e &&
           ...
           te.each(e, function (e, t) {
            ...
            p.verbose("Restoring value from session data", n, t),
             n && ((i = i || {})[t] = n);
           })),
          i
         );
        ...
        choiceText: function (e, t) {
         if (((t = t !== oe ? t : g.preserveHTML), e))
          return (
           0 < e.find(y.menu).length &&
            (p.verbose("Retrieving text of element with sub-menu"),
        ...
        choiceValue: function (e, t) {
         return (
          (t = t || p.get.choiceText(e)),
          !!e &&
           (e.data(b.value) !== oe
            ? String(e.data(b.value))
            : "string" == typeof t
            ? String(g.ignoreSearchCase ? t.toLowerCase() : t).trim()
            : String(t))
         );
        },
        inputEvent: function () {
          ...
          T.find("option").each(function () {
           ...
           "auto" === g.placeholder && "" === i
            ...
            : ((a.length === s.length && a[0] === s[0]) ||
               ...
               (s = a)),
              l.push({ name: t, value: i, text: o, disabled: n }));
          }),
          g.placeholder &&
           "auto" !== g.placeholder &&
           (p.debug("Setting placeholder value to", g.placeholder),
           (r.placeholder = g.placeholder)),
          g.sortSelect
           ? (!0 === g.sortSelect
              ? l.sort(function (e, t) {
                 return e.name.localeCompare(t.name);
                })
              : "natural" === g.sortSelect
              ? l.sort(function (e, t) {
                 return e.name
                  .toLowerCase()
                  .localeCompare(t.name.toLowerCase());
                })
              : te.isFunction(g.sortSelect) && l.sort(g.sortSelect),
             (r[c.values] = l),
             p.debug("Retrieved and sorted values from select", r))
           : ((r[c.values] = l), p.debug("Retrieved values from select", r)),
          r
         );
        },
        activeItem: function () {
         ...
         return (
          (i =
           i !== oe
            ...
            ? p.get.values()
            : p.get.text()),
          (e = (a = p.is.multiple() && Array.isArray(i))
           ? 0 < i.length
           : i !== oe && null !== i),
          (o = "" === i || !1 === i || !0 === i || o || !1),
          e &&
           I.each(function () {
            ...
            if (null !== n && n !== oe)
             if (a)
              -1 !==
               te.inArray(
                p.escape.htmlEntities(String(n)),
                i.map(function (e) {
                 return String(e);
                })
               ) && (r = r ? r.add(e) : e);
              ...
              (g.ignoreCase && ((n = n.toLowerCase()), (i = i.toLowerCase())),
              p.escape.htmlEntities(String(n)) ===
               p.escape.htmlEntities(String(i)))
             )
              return p.verbose("Found select item by value", n, i), (r = e), !0;
           }),
          r
         );
        },
        ...
        maxSelections: function (e) {
         return (
          ...
          ((e = e !== oe ? e : p.get.selectionCount()) >= g.maxSelections
           ? (p.debug("Maximum selection count reached"),
             g.useLabels &&
              (I.addClass(h.filtered), p.add.message(f.maxSelections)),
             !0)
           : (p.verbose("No longer at maximum selection count"),
             p.remove.message(),
             p.remove.filteredItem(),
             p.is.searchSelection() && p.filterItems(),
             !1))
         );
        },
        disabled: function () {
       ...
       restore: {
        ...
        defaultText: function () {
         ...
         e === p.get.placeholderText
          ? (p.debug("Restoring default placeholder text", e),
            p.set.placeholderText(e))
        ...
        defaultValue: function () {
         ...
         e !== oe &&
          (p.debug("Restoring default value", e),
          "" !== e
           ? (p.set.value(e), p.set.selected())
           : (p.remove.activeItem(), p.remove.selectedItem()));
        },
        labels: function () {
         g.allowAdditions &&
          (g.useLabels || (p.error(x.labels), (g.useLabels = !0)),
          p.debug("Restoring selected values"),
          p.create.userLabels()),
          p.check.maxSelections();
        },
        selected: function () {
         p.restore.values(),
          p.is.multiple()
           ? (p.debug("Restoring previously selected values and labels"),
             p.restore.labels())
           : p.debug("Restoring previously selected values");
        },
        values: function () {
         p.set.initialLoad(),
          g.apiSettings && g.saveRemoteData && p.get.remoteValues()
           ? p.restore.remoteValues()
           : p.set.selected();
         var e = p.get.value();
         !e || "" === e || (Array.isArray(e) && 0 === e.length)
          ? F.addClass(h.noselection)
          : F.removeClass(h.noselection),
          p.remove.initialLoad();
        },
        remoteValues: function () {
         var e = p.get.remoteValues();
         p.debug("Recreating selected from session data", e),
          e &&
           (p.is.single()
            ? te.each(e, function (e, t) {
               p.set.text(t);
       ...
       read: {
        remoteData: function (e) {
         var t;
         if (ne.Storage !== oe)
          return (t = sessionStorage.getItem(e)) !== oe && t;
         p.error(x.noStorage);
        },
       },
       save: {
        ...
        placeholderText: function () {
         var e;
         !1 !== g.placeholder &&
          D.hasClass(h.placeholder) &&
          ((e = p.get.text()),
          p.verbose("Saving placeholder text as", e),
          T.data(b.placeholderText, e));
        },
        remoteData: function (e, t) {
         ne.Storage !== oe
          ? (p.verbose("Saving remote data to session storage", t, e),
            sessionStorage.setItem(t, e))
          : p.error(x.noStorage);
        },
       },
       clear: function (e) {
        p.is.multiple() && g.useLabels
         ? p.remove.labels(T.find(y.label), e)
         : (p.remove.activeItem(),
           p.remove.selectedItem(),
           p.remove.filteredItem()),
         p.set.placeholderText(),
       ...
       set: {
        filtered: function () {
         ...
         e &&
          o &&
          (p.verbose("Adjusting input width", a, g.glyphWidth),
          A.css("width", a)),
          o || (n && r)
           ? (p.verbose("Hiding placeholder text"), D.addClass(h.filtered))
           : (e && (!n || r)) ||
             (p.verbose("Showing placeholder text"), D.removeClass(h.filtered));
        },
        empty: function () {
         T.addClass(h.empty);
        },
        ...
        placeholderText: function (e) {
         (e = e || p.get.placeholderText()),
          p.debug("Setting placeholder text", e),
          p.set.text(e),
          D.addClass(h.placeholder);
        },
        tabbable: function () {
         p.is.searchSelection()
          ? (p.debug("Added tabindex to searchable dropdown"),
            A.val(""),
            p.check.disabled(),
            M.attr("tabindex", -1))
          : (p.debug("Added tabindex to dropdown"),
            T.attr("tabindex") === oe &&
             (T.attr("tabindex", 0), M.attr("tabindex", -1)));
        },
        initialLoad: function () {
         p.verbose("Setting initial load"), (e = !0);
        },
        activeItem: function (e) {
         g.allowAdditions && 0 < e.filter(y.addition).length
        ...
        scrollPosition: function (e, t) {
         var n, i, o, a, r, s;
         (n = (e = e || p.get.selectedItem()).closest(y.menu)),
          (i = e && 0 < e.length),
          (t = t !== oe && t),
          0 === p.get.activeItem().length && (t = !1),
          e &&
           0 < n.length &&
           i &&
           (e.position().top,
           ...
           p.debug("Scrolling to active item", o),
           (t || r || s) && n.scrollTop(o),
           n.removeClass(h.loading));
        },
        text: function (e) {
         "combo" === g.action
          ? (p.debug("Changing combo button text", e, R),
            g.preserveHTML ? R.html(e) : R.text(e))
          : "activate" === g.action &&
            (e !== p.get.placeholderText() && D.removeClass(h.placeholder),
            p.debug("Changing text", e, D),
            D.removeClass(h.filtered),
            g.preserveHTML ? D.html(e) : D.text(e));
        },
        selectedItem: function (e) {
         var t = p.get.choiceValue(e),
          n = p.get.choiceText(e, !1),
          i = p.get.choiceText(e, !0);
         p.debug("Setting user selection to item", e),
          p.remove.activeItem(),
          p.set.partialSearch(n),
          p.set.activeItem(e),
          p.set.selected(t, e),
          p.set.text(i);
        },
        selectedLetter: function (e) {
         var t,
          n = I.filter("." + h.selected),
          i = 0 < n.length && p.has.firstLetter(n, e),
          o = !1;
         i && ((t = n.nextAll(I).eq(0)), p.has.firstLetter(t, e) && (o = t)),
          o ||
           I.each(function () {
            if (p.has.firstLetter(te(this), e)) return (o = te(this)), !1;
           }),
          o &&
           (p.verbose("Scrolling to next value with letter", e),
           p.set.scrollPosition(o),
           n.removeClass(h.selected),
           o.addClass(h.selected),
           g.selectOnKeydown && p.is.single() && p.set.selectedItem(o));
        },
        direction: function (e) {
         "auto" == g.direction
          ? (e ? p.is.upward(e) && p.remove.upward(e) : p.remove.upward(),
            p.can.openDownward(e) ? p.remove.upward(e) : p.set.upward(e),
            p.is.leftward(e) || p.can.openRightward(e) || p.set.leftward(e))
          : "upward" == g.direction && p.set.upward(e);
        },
        upward: function (e) {
        ...
        value: function (e, t, n, i) {
         e === oe || "" === e || (Array.isArray(e) && 0 === e.length)
          ? F.addClass(h.noselection)
          : F.removeClass(h.noselection);
         ...
         if (a) {
          if (
           !g.allowReselection &&
           s == r &&
           (p.verbose("Skipping value update already same value", e, r),
           !p.is.initialLoad())
          )
           return;
          p.is.single() &&
           p.has.selectInput() &&
           p.can.extendSelect() &&
           (p.debug("Adding user option", e), p.add.optionValue(e)),
           p.debug("Updating input value", o, r),
           (q = !0),
           F.val(o),
           !1 === g.fireOnInit && p.is.initialLoad()
            ? p.debug("Input native change event ignored on initial load")
            : !0 !== i && p.trigger.change(),
           (q = !1);
         } else
          p.verbose("Storing value in metadata", o, F),
           o !== r && T.data(b.value, s);
         !1 === g.fireOnInit && p.is.initialLoad()
          ? p.verbose("No callback on initial load", g.onChange)
          : !0 !== i && g.onChange.call(N, e, t, n);
        },
        active: function () {
         T.addClass(h.active);
        },
        ...
        exactly: function (e, t) {
         p.debug("Setting selected to exact values"),
          p.clear(),
          p.set.selected(e, t);
        },
        selected: function (e, s, l, c) {
         var u = p.is.multiple();
         (s = g.allowAdditions
          ? s || p.get.itemWithAdditions(e)
          : s || p.get.item(e)) &&
          (p.debug("Setting selected menu item to", s),
          p.is.multiple() && p.remove.searchWidth(),
          p.is.single()
           ? (p.remove.activeItem(), p.remove.selectedItem())
           : g.useLabels && p.remove.selectedItem(),
          s.each(function () {
           var e = te(this),
            t = p.get.choiceText(e),
            n = p.get.choiceValue(e, t),
           ...
           u
            ? !o || a
              ? (g.apiSettings && g.saveRemoteData && p.save.remoteData(t, n),
                g.useLabels
                 ? (p.add.label(n, t, r),
                   p.add.value(n, t, e),
                   p.set.activeItem(e),
                   p.filterActive(),
                   p.select.nextAvailable(s))
                 : (p.add.value(n, t, e),
                   p.set.text(p.add.variables(f.count)),
                   p.set.activeItem(e)))
              : i ||
                (!g.useLabels && !d) ||
                (p.debug("Selected active value, removing label"),
                p.remove.selected(n))
            : (g.apiSettings && g.saveRemoteData && p.save.remoteData(t, n),
              c || p.set.text(t),
              p.set.value(n, t, e, l),
       ...
       add: {
        label: function (e, t, n) {
         var i,
          o = p.is.searchSelection() ? A : D,
          a = p.escape.value(e);
         g.ignoreCase && (a = a.toLowerCase()),
          (i = te("<a />")
           .addClass(h.label)
           .attr("data-" + b.value, a)
           .html(C.label(a, t, g.preserveHTML, g.className))),
          (i = g.onLabelCreate.call(i, a, t)),
          p.has.label(e)
           ? p.debug("User selection already exists, skipping", a)
           : (g.label.variation && i.addClass(g.label.variation),
             !0 === n
              ? (p.debug("Animating in label", i),
        ...
        message: function (e) {
         ...
         0 < t.length
          ? t.html(n)
          : (t = te("<div/>").html(n).addClass(h.message).appendTo(M));
        },
        optionValue: function (e) {
         var t = p.escape.value(e);
         0 < F.find('option[value="' + p.escape.string(t) + '"]').length ||
          (p.disconnect.selectObserver(),
          p.is.single() &&
           (p.verbose("Removing previous user addition"),
           F.find("option." + h.addition).remove()),
          te("<option/>")
           .prop("value", t)
           .addClass(h.addition)
           .html(e)
           .appendTo(F),
          p.verbose("Adding user addition as an <option>", e),
          p.observe.select());
        },
        userSuggestion: function (e) {
         var t,
          n = M.children(y.addition),
          i = p.get.item(e),
          ...
          ("" === e || o
           ...
           : (a
              ? (n
                ...
                g.hideAdditions ||
                 ((t = g.templates.addition(p.add.variables(f.addResult, e))),
                 n.html(t)),
                p.verbose("Replacing user suggestion with new value", n))
              : ((n = p.create.userChoice(e)).prependTo(M),
                p.verbose(
                 "Adding item choice to menu corresponding with user choice addition",
                 n
                )),
             (g.hideAdditions && !p.is.allFiltered()) ||
        ...
        variables: function (e, t) {
         var n,
          ...
          r = -1 !== e.search("{term}");
         return (
          p.verbose("Adding templated variables to message", e),
          o && ((n = p.get.selectionCount()), (e = e.replace("{count}", n))),
          a &&
           ((n = p.get.selectionCount()),
           (e = e.replace("{maxCount}", g.maxSelections))),
          r && ((i = t || p.get.query()), (e = e.replace("{term}", i))),
          e
         );
        },
        value: function (e, t, n) {
         var i,
          o = p.get.values(!0);
         p.has.value(e)
          ? p.debug("Value already selected")
          : "" !== e
          ? ((i = Array.isArray(o)
             ? ((i = o.concat([e])), p.get.uniqueArray(i))
             : [e]),
            p.has.selectInput()
             ? p.can.extendSelect() &&
               (p.debug("Adding value to select", e, i, F),
               p.add.optionValue(e))
             : ((i = i.join(g.delimiter)),
               p.debug("Setting hidden input to delimited value", i, F)),
            !1 === g.fireOnInit && p.is.initialLoad()
             ? p.verbose("Skipping onadd callback on initial load", g.onAdd)
             : g.onAdd.call(N, e, t, n),
            p.set.value(i, t, n),
            p.check.maxSelections())
          : p.debug("Cannot select blank values from multiselect");
        },
       },
       remove: {
        active: function () {
        ...
        filteredItem: function () {
         (g.useLabels && p.has.maxSelections()) ||
          (g.useLabels && p.is.multiple()
           ? I.not("." + h.active).removeClass(h.filtered)
           : I.removeClass(h.filtered),
          g.hideDividers && j.removeClass(h.hidden),
          p.remove.empty());
        },
        optionValue: function (e) {
         var t = p.escape.value(e),
         ...
         0 < n.length &&
          ...
          (r &&
           (r.disconnect(),
           p.verbose("Temporarily disconnecting mutation observer")),
          n.remove(),
          p.verbose("Removing user addition as an <option>", t),
          r && r.observe(F[0], { childList: !0, subtree: !0 }));
        },
        message: function () {
        ...
        selected: function (e, t, i) {
         ...
         t.each(function () {
          ...
          p.is.multiple()
           ? g.useLabels
             ? (p.remove.value(n, t, e, i), p.remove.label(n))
             : (p.remove.value(n, t, e, i),
               0 === p.get.selectionCount()
                ? p.set.placeholderText()
                : p.set.text(p.add.variables(f.count)))
           : p.remove.value(n, t, e, i),
           e.removeClass(h.filtered).removeClass(h.active),
           g.useLabels && e.removeClass(h.selected);
         });
        },
        selectedItem: function () {
         I.removeClass(h.selected);
        ...
        value: function (e, t, n, i) {
         var o,
          a = p.get.values();
         (e = p.escape.htmlEntities(e)),
          p.has.selectInput()
           ? (p.verbose("Input is <select> removing selected option", e),
             (o = p.remove.arrayValue(e, a)),
             p.remove.optionValue(e))
           : (p.verbose("Removing from delimited values", e),
             (o = (o = p.remove.arrayValue(e, a)).join(g.delimiter))),
          !1 === g.fireOnInit && p.is.initialLoad()
           ? p.verbose("No callback on initial load", g.onRemove)
           : g.onRemove.call(N, e, t, n),
          p.set.value(o, t, n, i),
          p.check.maxSelections();
        },
        arrayValue: function (t, e) {
         return (
          Array.isArray(e) || (e = [e]),
          (e = te.grep(e, function (e) {
           return t != e;
          })),
          p.verbose("Removed value from delimited string", t, e),
          e
         );
        },
        label: function (e, t) {
         var n = p.escape.value(e),
          i = T.find(y.label).filter(
           "[data-" +
            b.value +
            '="' +
            p.escape.string(g.ignoreCase ? n.toLowerCase() : n) +
            '"]'
          );
         p.verbose("Removing label", i), i.remove();
        },
        activeLabels: function (e) {
         (e = e || T.find(y.label).filter("." + h.active)),
          p.verbose("Removing active label selections", e),
          p.remove.labels(e);
        },
        labels: function (e, o) {
         (e = e || T.find(y.label)),
          p.verbose("Removing labels", e),
          e.each(function () {
           var e = te(this),
            t = e.data(b.value),
            n = t !== oe ? String(t) : t,
           ...
           !1 !== g.onLabelRemove.call(e, t)
            ? (p.remove.message(),
              i
               ? (p.remove.value(n, n, p.get.item(n), o), p.remove.label(n))
               : p.remove.selected(n, !1, o))
            : p.debug("Label remove callback cancelled removal");
          });
        },
        tabbable: function () {
         p.is.searchSelection()
          ? (p.debug("Searchable dropdown initialized"),
            A.removeAttr("tabindex"))
          : (p.debug("Simple selection dropdown initialized"),
            T.removeAttr("tabindex")),
          M.removeAttr("tabindex");
        },
        diacritics: function (e) {
         return g.ignoreDiacritics
       ...
       has: {
        ...
        minCharacters: function (e) {
         return g.minCharacters && !z
          ? (e = e !== oe ? String(e) : String(p.get.query())).length >=
             g.minCharacters
          : !(z = !1);
        },
        ...
        label: function (e) {
         ...
         return (
          ...
          0 <
           n.filter("[data-" + b.value + '="' + p.escape.string(t) + '"]')
            .length
         );
        },
        ...
        value: function (e) {
         return g.ignoreCase
          ? p.has.valueIgnoringCase(e)
          : p.has.valueMatchingCase(e);
        },
       ...
       is: {
        ...
        bubbledLabelClick: function (e) {
         return (
          te(e.target).is("select, input") && 0 < T.closest("label").length
         );
        },
        ...
        animating: function (e) {
         return e
          ...
          : M.transition && M.transition("is animating");
        },
        leftward: function (e) {
        ...
        allFiltered: function () {
         return (
          (p.is.multiple() || p.has.search()) &&
          !(0 == g.hideAdditions && p.has.userSuggestion()) &&
          !p.has.message() &&
          p.has.allResultsFiltered()
         );
        },
        ...
        selectMutation: function (e) {
         ...
         return (
          te.each(e, function (e, t) {
           if (te(t.target).is("select") || te(t.addedNodes).is("select"))
            return !(n = !0);
          }),
          n
         );
       ...
       can: {
        activate: function (e) {
         return (
          !!g.useLabels ||
          !p.has.maxSelections() ||
          !(!p.has.maxSelections() || !e.hasClass(h.active))
         );
        },
        openDownward: function (e) {
         ...
         return (
          ...
          (n = {
           context: {
            offset: S.get(0) === ne ? { top: 0, left: 0 } : S.offset(),
            scrollTop: S.scrollTop(),
            height: S.outerHeight(),
           },
           menu: { offset: i.offset(), height: i.outerHeight() },
          }),
          p.is.verticallyScrollableContext() &&
           (n.menu.offset.top += n.context.scrollTop),
          p.has.subMenu(i) &&
           (n.menu.height += i.find(y.menu).first().outerHeight()),
          (o = (t = {
           above:
            n.context.scrollTop <=
           ...
           ? (p.verbose("Dropdown can fit in context downward", t), !0)
           : t.below || t.above
           ? (p.verbose("Dropdown cannot fit below, opening upward", t), !1)
           : (p.verbose(
        ...
        openRightward: function (e) {
         ...
         return (
          ...
          p.is.horizontallyScrollableContext() &&
          ...
          (t =
           ...
           (p.verbose("Dropdown cannot fit in context rightward", t), (o = !1)),
          i.removeClass(h.loading),
          o
         );
        },
       ...
       animate: {
        show: function (e, t) {
         ...
         (e = te.isFunction(e) ? e : function () {}),
          p.verbose("Doing menu show animation", i),
          p.set.direction(t),
          (n = g.transition.showMethod || p.get.transition(t)),
          p.is.selection() && p.set.scrollPosition(p.get.selectedItem(), !0),
          (p.is.hidden(i) || p.is.animating(i)) &&
           ("none" === n
            ? (o(),
              i
               .transition({ displayType: p.get.displayType() })
               .transition("show"),
              e.call(N))
            : te.fn.transition !== oe && T.transition("is supported")
            ? i.transition({
               animation: n + " in",
               debug: g.debug,
               verbose: g.verbose,
        ...
        hide: function (e, t) {
         ...
         (e = te.isFunction(e) ? e : function () {}),
          (p.is.visible(n) || p.is.animating(n)) &&
           (p.verbose("Doing menu hide animation", n),
           "none" === o
            ? (i(),
              n
               .transition({ displayType: p.get.displayType() })
       ...
       delay: {
        show: function () {
         p.verbose("Delaying show event to ensure user intent"),
          clearTimeout(p.timer),
          (p.timer = setTimeout(p.show, g.delay.show));
        },
        hide: function () {
         p.verbose("Delaying hide event to ensure user intent"),
          clearTimeout(p.timer),
          (p.timer = setTimeout(p.hide, g.delay.hide));
        },
       },
       escape: {
        value: function (e) {
         ...
         return i || !o
          ? e
          : (p.debug("Encoding quote values for use in select", e),
            t
             ? (te.each(e, function (e, t) {
        ...
        htmlEntities: function (e) {
         ...
         return /[&<>"'`]/.test(e)
          ? (e = e.replace(/&(?![a-z0-9#]{1,6};)/, "&amp;")).replace(
             /[<>"'`]/g,
             function (e) {
              return t[e];
             }
       ...
       setting: function (e, t) {
        if ((p.debug("Changing setting", e, t), te.isPlainObject(e)))
         te.extend(!0, g, e);
        else {
         if (t === oe) return g[e];
       ...
       performance: {
        ...
        display: function () {
         ...
         (G = !1),
          clearTimeout(p.performance.timer),
          te.each(J, function (e, t) {
           n += t["Execution Time"];
          }),
          (e += " " + n + "ms"),
          X && (e += " '" + X + "'"),
          (console.group !== oe || console.table !== oe) &&
           0 < J.length &&
           (console.groupCollapsed(e),
           console.table
            ? console.table(J)
         ...
         "string" == typeof i &&
          ...
          te.each(i, function (e, t) {
           ...
           if (te.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (!te.isPlainObject(r[t]) || e == o)
             return r[t] !== oe ? (a = r[t]) : p.error(x.method, i), !1;
            r = r[t];
           }
          })),
         te.isFunction(a) ? (n = a.apply(t, e)) : a !== oe && (n = a),
         Array.isArray(W)
          ? W.push(n)
          : W !== oe
          ? (W = [W, n])
       ...
       _
        ? (U === oe && p.initialize(), p.invoke(Z))
        : (U !== oe && U.invoke("destroy"), p.initialize());
     }),
     W !== oe ? W : Y
    );
   }),
   ...
   (te.fn.dropdown.settings.templates = {
    ...
    dropdown: function (e, t, n, i) {
     ...
     return (
      ...
      (a += o
       ? '<div class="default text">' + r(o, n) + "</div>"
       : '<div class="text"></div>'),
      (a += '<div class="' + i.menu + '">'),
      (a += te.fn.dropdown.settings.templates.menu(e, t, n, i)),
      (a += "</div>")
     );
    },
       ...
       if ("item" === n || i) {
        ...
        (m +=
         ...
         i &&
          (m +=
           '<i class="' +
           (-1 !== n.indexOf("left") ? "left" : "") +
           ' dropdown icon"></i>'),
         t[u.image] &&
          (m +=
           '<img class="' +
           (t[u.imageClass] ? p(t[u.imageClass]) : f.image) +
           '" src="' +
           p(t[u.image]) +
           '">'),
         t[u.icon] &&
          (m +=
           ...
           p(t[u.icon]) +
           " " +
           (t[u.iconClass] ? p(t[u.iconClass]) : f.icon) +
           '"></i>'),
         s &&
          ((m +=
           '<span class="' +
           ...
           g(t[u.description] || "", d) +
           "</span>"),
          (m += i ? "" : '<span class="' + f.text + '">')),
         i && (m += '<span class="' + f.text + '">'),
         (m += g(t[u.name] || "", d)),
         i
          ? ((m += "</span>"),
            (m += '<div class="' + n + '">'),
            (m += te.fn.dropdown.settings.templates.menu(t, u, d, f)),
            (m += "</div>"))
          : s && (m += "</span>"),
         (m += "</div>");
       } else if ("header" === n) {
        ...
        ("" === l && "" === c) ||
         ((m +=
          '<div class="' + (t[u.class] ? p(t[u.class]) : f.header) + '">'),
         "" !== c &&
          (m +=
           '<i class="' +
           c +
         ...
         (m += l),
         (m += "</div>")),
         t[u.divider] && (m += '<div class="' + f.divider + '"></div>');
       }
      }),
      m
     );
    ...
    label: function (e, t, n, i) {
     return (
      (0, te.fn.dropdown.settings.templates.escape)(t, n) +
      '<i class="' +
      i.delete +
      ' icon"></i>'
     );
   ...
   (T.fn.embed = function (p) {
    ...
    return (
     v.each(function () {
      var s,
       i = T.isPlainObject(p)
        ? T.extend(!0, {}, T.fn.embed.settings, p)
        : T.extend({}, T.fn.embed.settings),
       e = i.selector,
       t = i.className,
       o = i.sources,
       l = i.error,
      ...
      (s = {
       ...
       determine: {
        ...
        url: function () {
         ...
         return (
          (e = o[n] !== S && o[n].url.replace("{id}", t)) && d.data(a.url, e), e
         );
        },
       },
       set: {
       ...
       generate: {
        ...
        parameters: function (e, t) {
         ...
         return (
          (t = t || i.parameters) && (n = T.extend({}, n, t)),
          (n = i.onEmbed(n)),
       ...
       should: {
        autoplay: function () {
         return "auto" === i.autoplay
          ? i.placeholder || d.data(a.placeholder) !== S
          : i.autoplay;
        },
       },
       is: {
       ...
       invoke: function (i, e, t) {
        ...
        return (
         ...
         T.isFunction(a) ? (n = a.apply(t, e)) : a !== S && (n = a),
         Array.isArray(h)
          ? h.push(n)
          : h !== S
          ? (h = [h, n])
  ...
  (z.isFunction =
    ...
    return (
     e.each(function () {
      var o,
       ...
       u,
       d = z.isPlainObject(A)
        ? z.extend(!0, {}, z.fn.modal.settings, A)
        : z.extend({}, z.fn.modal.settings),
       f = d.selector,
       m = d.className,
       g = d.namespace,
       p = d.fields,
      ...
      (u = {
       initialize: function () {
        if (
         ...
         "" !== d.title &&
          y
           .find(f.title)
           .html(u.helpers.escape(d.title, d.preserveHTML))
           .addClass(d.classTitle),
         "" !== d.content &&
          y
           .find(f.content)
           .html(u.helpers.escape(d.content, d.preserveHTML))
           .addClass(d.classContent),
         u.has.configActions())
        ) {
         ...
         0 === a.length
          ...
          d.actions.forEach(function (e) {
           var t = e[p.icon]
             ? '<i class="' + u.helpers.deQuote(e[p.icon]) + ' icon"></i>'
             : "",
            n = u.helpers.escape(e[p.text] || "", d.preserveHTML),
            i = u.helpers.deQuote(e[p.class] || ""),
            o =
             e[p.click] && z.isFunction(e[p.click])
              ? e[p.click]
              : function () {};
           a.append(
            z("<button/>", {
        ...
        (u.cache = {}),
         u.verbose("Initializing dimmer", x),
         u.create.id(),
         u.create.dimmer(),
         d.allowMultiple && u.create.innerDimmer(),
         d.centered || y.addClass("top aligned"),
         u.refreshModals(),
         u.bind.events(),
         d.observeChanges && u.observeChanges(),
         u.instantiate(),
         d.autoShow && u.show();
       },
       instantiate: function () {
       ...
       create: {
        modal: function () {
         (y = z("<div/>", { class: m.modal })),
          d.closeIcon && ((C = z("<i/>", { class: m.close })), y.append(C)),
          "" !== d.title && z("<div/>", { class: m.title }).appendTo(y),
          "" !== d.content && z("<div/>", { class: m.content }).appendTo(y),
          u.has.configActions() &&
           z("<div/>", { class: m.actions }).appendTo(y),
          x.append(y);
        },
        dimmer: function () {
         var e = { debug: d.debug, dimmerName: "modals" },
          t = z.extend(!0, e, d.dimmerSettings);
         z.fn.dimmer !== U
          ? (u.debug("Creating dimmer"),
            (i = x.dimmer(t)),
            d.detachable
             ? (u.verbose("Modal is detachable, moving content into dimmer"),
               i.dimmer("add content", y))
             : u.set.undetached(),
        ...
        id: function () {
         (l = (Math.random().toString(16) + "000000000").substr(2, 8)),
          (t = "." + l),
          u.verbose("Creating unique id for element", l);
        },
        innerDimmer: function () {
         0 == y.find(f.dimmer).length &&
          y.prepend('<div class="ui inverted dimmer"></div>');
        },
       },
       destroy: function () {
        c && c.disconnect(),
         u.verbose("Destroying previous modal"),
         y.removeData(b).off(v),
         F.off(t),
         n.off(t),
         C.off(v),
         x.dimmer("destroy");
       ...
       refresh: function () {
        u.remove.scrolling(),
         u.cacheSizes(),
         u.can.useFlex() || u.set.modalOffset(),
         u.set.screenHeight(),
         u.set.type();
       },
       ...
       attachEvents: function (e, t) {
        var n = z(e);
        (t = z.isFunction(u[t]) ? u[t] : u.toggle),
         0 < n.length
          ? (u.debug("Attaching modal events to element", e, t),
            n.off(v).on("click" + v, t))
          : u.error(h.notFound, e);
       },
       bind: {
        events: function () {
         u.verbose("Attaching events"),
          y
           .on("click" + v, f.close, u.event.close)
           .on("click" + v, f.approve, u.event.approve)
           .on("click" + v, f.deny, u.event.deny),
          F.on("resize" + t, u.event.resize);
        },
        scrollLock: function () {
       ...
       event: {
        approve: function () {
         T || !1 === d.onApprove.call(w, z(this))
          ? u.verbose("Approve callback returned false cancelling hide")
          : ((T = !0),
            u.hide(function () {
             T = !1;
            }));
        ...
        deny: function () {
         T || !1 === d.onDeny.call(w, z(this))
          ? u.verbose("Deny callback returned false cancelling hide")
          : ((T = !0),
            u.hide(function () {
             T = !1;
            }));
        ...
        mousedown: function (e) {
         var t = z(e.target),
          n = u.is.rtl();
         (r = 0 < t.closest(f.modal).length) &&
          u.verbose("Mouse down event registered inside the modal"),
          (s =
           u.is.scrolling() &&
           ((!n && z(N).outerWidth() - d.scrollbarWidth <= e.clientX) ||
            (n && d.scrollbarWidth >= e.clientX))) &&
           u.verbose("Mouse down event registered inside the scrollbar");
        },
        mouseup: function (e) {
         if (d.closable)
          if (r)
           ...
           if (!t && n && u.is.active() && y.hasClass(m.front)) {
            if (
             (u.debug("Dimmer clicked, hiding all modals"), d.allowMultiple)
            ) {
             if (!u.hideAll()) return;
        ...
        keyboard: function (e) {
         27 == e.which &&
          (d.closable
           ? (u.debug("Escape key pressed hiding modal"),
             y.hasClass(m.front) && u.hide())
           : u.debug("Escape key pressed, but closable is set to false"),
          e.preventDefault());
        },
        resize: function () {
         i.dimmer("is active") &&
          (u.is.animating() || u.is.active()) &&
          q(u.refresh);
        },
       },
       toggle: function () {
         ...
         u.is.animating() || !u.is.active()
          ? (u.showDimmer(),
            ...
            u.can.useFlex()
             ...
             : (u.set.legacy(),
               u.set.modalOffset(),
               u.debug("Using non-flex legacy modal positioning.")),
            u.set.screenHeight(),
            u.set.type(),
            u.set.clickaway(),
            !d.allowMultiple && u.others.active()
             ? u.hideOthers(u.showModal)
             : ((T = !1),
               d.allowMultiple &&
                (u.others.active() &&
                 a
                  ...
                  .find(f.dimmer)
                  .addClass("active"),
                d.detachable && y.detach().appendTo(n)),
               d.onShow.call(w),
               d.transition &&
               z.fn.transition !== U &&
               y.transition("is supported")
                ? (u.debug("Showing modal with css animations"),
                  y.transition({
                   debug: d.debug,
                   ...
                   onComplete: function () {
                    d.onVisible.apply(w),
                     d.keyboardShortcuts && u.add.keyboardShortcuts(),
                     u.save.focus(),
                     u.set.active(),
                     d.autofocus && u.set.autofocus(),
                     e();
                   },
                  }))
                : u.error(h.noTransition)))
          : u.debug("Modal is already visible");
       },
       hideModal: function (e, t, n) {
        var i = a.filter("." + m.active).last();
        if (
         ((e = z.isFunction(e) ? e : function () {}),
         u.debug("Hiding modal"),
         !1 === d.onHide.call(w, z(this)))
        )
         return (
          u.verbose("Hide callback returned false cancelling hide"), (T = !1)
         );
        (u.is.animating() || u.is.active()) &&
         (d.transition && z.fn.transition !== U && y.transition("is supported")
          ? (u.remove.active(),
            y.transition({
             debug: d.debug,
             ...
             useFailSafe: !0,
             onStart: function () {
              u.others.active() || u.others.animating() || t || u.hideDimmer(),
               d.keyboardShortcuts &&
                !u.others.active() &&
                u.remove.keyboardShortcuts();
             },
             onComplete: function () {
              u.unbind.scrollLock(),
               d.allowMultiple &&
                (i.addClass(m.front),
                y.removeClass(m.front),
                n
                 ? o.find(f.dimmer).removeClass("active")
                 : i.find(f.dimmer).removeClass("active")),
               z.isFunction(d.onHidden) && d.onHidden.call(w),
               u.remove.dimmerStyles(),
               u.restore.focus(),
               e();
             },
            }))
       ...
       showDimmer: function () {
        i.dimmer("is animating") || !i.dimmer("is active")
         ? (u.save.bodyMargin(), u.debug("Showing dimmer"), i.dimmer("show"))
         : u.debug("Dimmer already visible");
       },
       hideDimmer: function () {
        i.dimmer("is animating") || i.dimmer("is active")
         ? (u.unbind.scrollLock(),
           i.dimmer("hide", function () {
            u.restore.bodyMargin(),
             u.remove.clickaway(),
             u.remove.screenHeight();
           }))
       ...
       hideAll: function (n) {
        ...
        if (((n = z.isFunction(n) ? n : function () {}), 0 < e.length)) {
         ...
         var i = !0;
         return (
          z(e.get().reverse()).each(function (e, t) {
       ...
       hideOthers: function (e) {
        ...
        (e = z.isFunction(e) ? e : function () {}),
         0 < t.length &&
          (u.debug("Hiding other modals", a), t.modal("hide modal", e, !0));
       },
       others: {
        active: function () {
       ...
       add: {
        keyboardShortcuts: function () {
         u.verbose("Adding keyboard shortcuts"),
          P.on("keyup" + v, u.event.keyboard);
        },
       },
       save: {
        focus: function () {
         0 < z(H.activeElement).closest(y).length ||
          (e = z(H.activeElement).blur());
        },
        bodyMargin: function () {
       ...
       restore: {
        ...
        bodyMargin: function () {
         ...
         O.css("margin-" + n, S),
          O.find(f.bodyFixed.replace("right", n)).each(function () {
           var e = z(this),
       ...
       remove: {
        ...
        clickaway: function () {
         d.detachable || y.off("mousedown" + t),
          n.off("mousedown" + t),
          n.off("mouseup" + t);
        },
        ...
        bodyStyle: function () {
         "" === O.attr("style") &&
          (u.verbose("Removing style attribute"), O.removeAttr("style"));
        },
       ...
       cacheSizes: function () {
        ...
        (u.cache.pageHeight !== U && 0 === n) ||
         ...
         (u.cache.topOffset = -u.cache.height / 2)),
         y.removeClass(m.loading),
         u.debug("Caching modal and container sizes", u.cache);
       },
       helpers: {
        deQuote: function (e) {
       ...
       can: {
        leftBodyScrollbar: function () {
         return (
          u.cache.leftBodyScrollbar === U &&
           (u.cache.leftBodyScrollbar =
            u.is.rtl() &&
            ((u.is.iframe && !u.is.firefox()) ||
             u.is.safari() ||
             u.is.edge() ||
             u.is.ie())),
          u.cache.leftBodyScrollbar
        ...
        useFlex: function () {
         return "auto" === d.useFlex
          ? d.detachable && !u.is.ie()
          : (d.useFlex && u.is.ie()
             ? u.debug("useFlex true is not supported in IE")
             : d.useFlex &&
               !d.detachable &&
               u.debug(
       ...
       is: {
        ...
        animating: function () {
         return y.transition("is supported")
          ? y.transition("is animating")
          : y.is(":visible");
        },
        scrolling: function () {
        ...
        rtl: function () {
         return (
          u.cache.isRTL === U &&
           (u.cache.isRTL =
            "rtl" === O.attr("dir") || "rtl" === O.css("direction")),
          u.cache.isRTL
         );
        },
        safari: function () {
         return (
          u.cache.isSafari === U &&
           (u.cache.isSafari =
            /constructor/i.test(N.htmlElement) || !!N.ApplePaySession),
          u.cache.isSafari
         );
        },
        edge: function () {
         return (
          u.cache.isEdge === U &&
           (u.cache.isEdge = !!N.setImmediate && !u.is.ie()),
          u.cache.isEdge
         );
        },
        firefox: function () {
         return (
          u.cache.isFirefox === U && (u.cache.isFirefox = !!N.InstallTrigger),
          u.cache.isFirefox
         );
        },
        iframe: function () {
       ...
       set: {
        ...
        bodyMargin: function () {
         var n = u.can.leftBodyScrollbar() ? "left" : "right";
         (d.detachable || u.can.fit()) && O.css("margin-" + n, D + "px"),
          O.find(f.bodyFixed.replace("right", n)).each(function () {
           var e = z(this),
            t = "fixed" === e.css("position") ? "padding-" + n : n;
        ...
        clickaway: function () {
         d.detachable || y.on("mousedown" + t, u.event.mousedown),
          n.on("mousedown" + t, u.event.mousedown),
          n.on("mouseup" + t, u.event.mouseup);
        },
        dimmerSettings: function () {
         if (z.fn.dimmer !== U) {
          ...
          d.inverted &&
           (t.variation =
            t.variation !== U ? t.variation + " inverted" : "inverted"),
           x.dimmer("setting", t);
         } else u.error(h.dimmer);
        },
        dimmerStyles: function () {
         d.inverted ? n.addClass(m.inverted) : n.removeClass(m.inverted),
          d.blurring ? i.addClass(m.blurring) : i.removeClass(m.blurring);
        },
        modalOffset: function () {
         if (d.detachable)
          y.css({
           marginTop:
            !y.hasClass("aligned") && u.can.fit()
             ? -u.cache.height / 2
             : d.padding / 2,
          ...
          y.css({
           top:
            !y.hasClass("aligned") && e
             ? z(H).scrollTop() + (u.cache.contextHeight - u.cache.height) / 2
             : !e || y.hasClass("top")
             ? z(H).scrollTop() + d.padding
             : z(H).scrollTop() +
               (u.cache.contextHeight - u.cache.height - d.padding),
           marginLeft: -u.cache.width / 2,
          });
         }
        ...
        screenHeight: function () {
         u.can.fit()
          ? O.css("height", "")
          : y.hasClass("bottom") ||
            (u.debug("Modal is taller than page content, resizing page height"),
            O.css("height", u.cache.height + 2 * d.padding));
        },
        active: function () {
         y.addClass(m.active + " " + m.front),
          a.filter("." + m.active).removeClass(m.front);
        },
        scrolling: function () {
         i.addClass(m.scrolling),
          y.addClass(m.scrolling),
          u.unbind.scrollLock();
        },
        legacy: function () {
         y.addClass(m.legacy);
        ...
        type: function () {
         u.can.fit()
          ? (u.verbose("Modal fits on screen"),
            u.others.active() ||
             u.others.animating() ||
             (u.remove.scrolling(), u.bind.scrollLock()))
          : y.hasClass("bottom")
          ? u.verbose(
             "Bottom aligned modal not fitting on screen is unsupported for scrolling"
            )
          : (u.verbose("Modal cannot fit on screen setting to scrolling"),
            u.set.scrolling());
        },
        undetached: function () {
       ...
       setting: function (e, t) {
        if ((u.debug("Changing setting", e, t), z.isPlainObject(e)))
         z.extend(!0, d, e);
        else {
         if (t === U) return d[e];
       ...
       performance: {
        ...
        display: function () {
         ...
         (M = !1),
          ...
          (e += " " + n + "ms"),
          R && (e += " '" + R + "'"),
          (console.group !== U || console.table !== U) &&
           0 < I.length &&
           (console.groupCollapsed(e),
           console.table
            ? console.table(I)
          ...
          z.each(i, function (e, t) {
           ...
           if (z.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (!z.isPlainObject(r[t]) || e == o)
             return r[t] !== U && (a = r[t]), !1;
            r = r[t];
           }
          })),
         z.isFunction(a) ? (n = a.apply(t, e)) : a !== U && (n = a),
         Array.isArray(E)
          ? E.push(n)
          : E !== U
          ? (E = [E, n])
       ...
       L
        ? (k === U &&
           (z.isFunction(d.templates[j]) &&
            ((d.autoShow = !0),
            (d.className.modal = d.className.template),
            (d = z.extend(!0, {}, d, d.templates[j].apply(u, V))),
            (m = d.className),
            (g = d.namespace),
            (p = d.fields),
            (h = d.error)),
           u.initialize()),
          z.isFunction(d.templates[j]) || u.invoke(j))
        : (k !== U && k.invoke("destroy"), u.initialize(), (E = y));
     }),
     E !== U ? E : this
    );
   }),
   ...
   (z.fn.modal.settings.templates = {
    getArguments: function (e) {
     var t = [].slice.call(e);
     return z.isPlainObject(t[0])
      ? z.extend({ handler: function () {}, content: "", title: "" }, t[0])
      : (z.isFunction(t[t.length - 1]) || t.push(function () {}),
        { handler: t.pop(), content: t.pop() || "", title: t.pop() || "" });
    },
    alert: function () {
     ...
     return {
      title: t.title,
      content: t.content,
      actions: [{ text: e.text.ok, class: e.className.ok, click: t.handler }],
     };
    },
    confirm: function () {
     var e = this.get.settings(),
    ...
    prompt: function () {
     ...
     return (
      0 === z(z.parseHTML(i.content)).filter(".ui.input").length &&
       (i.content +=
        '<p><div class="' +
        e.className.prompt +
        '"><input placeholder="' +
        this.helpers.deQuote(i.placeholder || "") +
        '" type="text" value="' +
        this.helpers.deQuote(i.defaultValue || "") +
        '"></div></p>'),
      {
       title: i.title,
       content: i.content,
    ...
    return (
     e.each(function () {
      var i,
       s,
       o = x.isPlainObject(f)
        ? x.extend(!0, {}, x.fn.nag.settings, f)
        : x.extend({}, x.fn.nag.settings),
       e = o.selector,
       l = o.error,
       t = o.namespace,
       n = "." + t,
      ...
      (s = {
       initialize: function () {
        s.verbose("Initializing element"),
         (i = s.get.storage()),
         r.on("click" + n, e.close, s.dismiss).data(a, s),
         o.detachable && r.parent()[0] !== c[0] && r.detach().prependTo(c),
         0 < o.displayTime && setTimeout(s.hide, o.displayTime),
         s.show();
       },
       destroy: function () {
       ...
       show: function () {
        if (s.should.show() && !r.is(":visible")) {
         if (!1 === o.onShow.call(u))
          return (
           s.debug("onShow callback returned false, cancelling nag animation"),
           !1
          );
         s.debug("Showing nag", o.animation.show),
          "fade" === o.animation.show
           ? r.fadeIn(o.duration, o.easing, o.onVisible)
           : r.slideDown(o.duration, o.easing, o.onVisible);
        }
       },
       hide: function () {
        if (!1 === o.onHide.call(u))
         return (
          s.debug("onHide callback returned false, cancelling nag animation"),
          !1
         );
        s.debug("Hiding nag", o.animation.hide),
         "fade" === o.animation.hide
          ? r.fadeOut(o.duration, o.easing, o.onHidden)
          : r.slideUp(o.duration, o.easing, o.onHidden);
       },
       dismiss: function (e) {
        !1 !== s.hide() &&
         o.storageMethod &&
         (s.debug("Dismissing nag", o.storageMethod, o.key, o.value, o.expires),
         s.storage.set(o.key, o.value)),
       ...
       should: {
        show: function () {
         return o.persist
          ...
          : s.storage.get(o.key) != o.value.toString()
          ? (s.debug(
       ...
       get: {
        expirationDate: function (e) {
         if (
          ("number" == typeof e && (e = new Date(Date.now() + 864e5 * e)),
        ...
        storage: function () {
         return "localstorage" === o.storageMethod && C.localStorage !== k
          ? (s.debug("Using local storage"), C.localStorage)
          : "sessionstorage" === o.storageMethod && C.sessionStorage !== k
          ? (s.debug("Using session storage"), C.sessionStorage)
          : "cookie" in w
          ? (s.debug("Using cookie"),
            {
             setItem: function (e, t, n) {
              (e = encodeURIComponent(e)
               .replace(/%(2[346B]|5E|60|7C)/g, decodeURIComponent)
               .replace(/[()]/g, escape)),
               (t = encodeURIComponent(t).replace(
              ...
              for (var o in n)
               n.hasOwnProperty(o) &&
                ((i += "; " + o),
                "string" == typeof n[o] && (i += "=" + n[o].split(";")[0]));
              w.cookie = e + "=" + t + i;
             },
             getItem: function (e) {
              for (
               var t = w.cookie.split("; "), n = 0, i = t.length;
               n < i;
               n++
              ) {
               var o = t[n].split("=");
               if (e === o[0].replace(/(%[\dA-F]{2})+/gi, decodeURIComponent))
                return o[1] || "";
              }
             },
        ...
        storageOptions: function () {
         var e = {};
         return (
          o.expires && (e.expires = s.get.expirationDate(o.expires)),
          o.domain && (e.domain = o.domain),
          o.path && (e.path = o.path),
          o.secure && (e.secure = o.secure),
          o.samesite && (e.samesite = o.samesite),
          e
         );
        },
       },
       ...
       storage: {
        set: function (e, t) {
         ...
         i === C.localStorage &&
          n.expires &&
          (s.debug("Storing expiration value in localStorage", e, n.expires),
          i.setItem(e + o.expirationKey, n.expires)),
          s.debug("Value stored", e, t);
         try {
          i.setItem(e, t, n);
         } catch (e) {
          s.error(l.setItem, e);
        ...
        get: function (e) {
         ...
         if (((t = i.getItem(e)), i === C.localStorage)) {
          ...
          null !== n &&
           n !== k &&
           new Date(n) < new Date() &&
           (s.debug("Value in localStorage has expired. Deleting key", e),
           s.storage.remove(e),
           (t = null));
         }
         return (
          ("undefined" != t && "null" != t && t !== k && null !== t) || (t = k),
          t
         );
        },
        remove: function (e) {
         var t = s.get.storageOptions();
         (t.expires = s.get.expirationDate(-1)),
          i === C.localStorage && i.removeItem(e + o.expirationKey),
          i.removeItem(e, t);
        },
       },
       setting: function (e, t) {
        if ((s.debug("Changing setting", e, t), x.isPlainObject(e)))
         x.extend(!0, o, e);
        else {
         if (t === k) return o[e];
          ...
          x.each(i, function (e, t) {
           ...
           if (x.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (!x.isPlainObject(r[t]) || e == o)
             return r[t] !== k ? (a = r[t]) : s.error(l.method, i), !1;
            r = r[t];
           }
          })),
         x.isFunction(a) ? (n = a.apply(t, e)) : a !== k && (n = a),
         Array.isArray(m)
          ? m.push(n)
          : m !== k
          ? (m = [m, n])
       ...
       b
        ? (d === k && s.initialize(), s.invoke(v))
        : (d !== k && d.invoke("destroy"), s.initialize());
     }),
     m !== k ? m : this
    );
   }),
    ...
    return (
     e.each(function () {
      var u,
       ...
       f,
       m = L.isPlainObject(T)
        ? L.extend(!0, {}, L.fn.popup.settings, T)
      ...
      (f = {
       initialize: function () {
        f.debug("Initializing", v),
         f.createID(),
         f.bind.events(),
         !f.exists() && m.preserve && f.create(),
       ...
       observeChanges: function () {
        "MutationObserver" in V &&
         ((e = new MutationObserver(f.event.documentChanged)).observe(q, {
          childList: !0,
          subtree: !0,
         }),
       ...
       refresh: function () {
        m.popup
         ? (u = L(m.popup).eq(0))
         : m.inline && ((u = y.nextAll(o.popup).eq(0)), (m.popup = u)),
         m.popup
          ? (u.addClass(g.loading),
            (d = f.get.offsetParent()),
            u.removeClass(g.loading),
            m.movePopup &&
             f.has.popup() &&
             f.get.offsetParent(u)[0] !== d[0] &&
             (f.debug("Moving popup to the same offset parent as target"),
             u.detach().appendTo(d)))
          : (d = m.inline
             ? f.get.offsetParent(y)
             : f.has.popup()
             ? f.get.offsetParent(u)
             : E),
         d.is("html") &&
          d[0] !== E[0] &&
          (f.debug("Setting page as offset parent"), (d = E)),
         f.get.variation() && f.set.variation();
       },
       reposition: function () {
        f.refresh(), f.set.position();
       },
       destroy: function () {
        f.debug("Destroying previous module"),
         e && e.disconnect(),
         u && !m.preserve && f.removePopup(),
       ...
       event: {
        start: function (e) {
         ...
         clearTimeout(f.hideTimer),
          (!C || (C && m.addTouchEvents)) &&
           (f.showTimer = setTimeout(f.show, t));
        },
        end: function () {
        ...
        hideGracefully: function (e) {
         ...
         e && !i && n
          ? (f.debug("Click occurred outside popup hiding popup"), f.hide())
          : f.debug("Click was inside popup, keeping popup open");
        },
       },
       create: function () {
        var e = f.get.html(),
         ...
         n = f.get.content();
        e || n || t
         ? (f.debug("Creating pop-up html"),
           (e = e || m.templates.popup({ title: t, content: n })),
           (u = L("<div/>").addClass(g.popup).data(h.activator, v).html(e)),
           m.inline
            ? (f.verbose("Inserting popup element inline", u), u.insertAfter(v))
            : (f.verbose("Appending popup element to body", u), u.appendTo(s)),
           f.refresh(),
           f.set.variation(),
           m.hoverable && f.bind.popup(),
           m.onCreate.call(u, w))
         : m.popup
         ? (L(m.popup).data(h.activator, v),
           f.verbose("Used popup specified in settings"),
           f.refresh(),
           m.hoverable && f.bind.popup())
         : 0 !== y.next(o.popup).length
         ? (f.verbose("Pre-existing popup found"),
           (m.inline = !0),
           (m.popup = y.next(o.popup).data(h.activator, v)),
           f.refresh(),
           m.hoverable && f.bind.popup())
         : f.debug("No content specified skipping display", w);
       },
       createID: function () {
        (n = (Math.random().toString(16) + "000000000").substr(2, 8)),
         (t = "." + n),
         f.verbose("Creating unique id for element", n);
       },
       toggle: function () {
        f.debug("Toggling pop-up"),
         f.is.hidden()
          ? (f.debug("Popup is hidden, showing pop-up"),
            f.unbind.close(),
            f.show())
          : (f.debug("Popup is visible, hiding pop-up"), f.hide());
       },
       show: function (e) {
        if (
         ((e = e || function () {}),
         f.debug("Showing pop-up", m.transition),
         f.is.hidden() && (!f.is.active() || !f.is.dropdown()))
        ) {
         if ((f.exists() || f.create(), !1 === m.onShow.call(u, w)))
          return void f.debug(
           "onShow callback returned false, cancelling popup animation"
          );
         m.preserve || m.popup || f.refresh(),
          u &&
           f.set.position() &&
           (f.save.conditions(), m.exclusive && f.hideAll(), f.animate.show(e));
        }
       },
       hide: function (e) {
        if (((e = e || function () {}), f.is.visible() || f.is.animating())) {
         if (!1 === m.onHide.call(u, w))
          return void f.debug(
       ...
       exists: function () {
        return (
         !!u && (m.inline || m.popup ? f.has.popup() : 1 <= u.closest(s).length)
        );
       },
       removePopup: function () {
        f.has.popup() &&
         !m.popup &&
         (f.debug("Removing popup", u),
         u.remove(),
         (u = z),
         m.onRemove.call(u, w));
       },
       save: {
        conditions: function () {
         (f.cache = { title: v.attr("title") }),
          f.cache.title && v.removeAttr("title"),
          f.verbose("Saving original attributes", f.cache.title);
        },
       },
       restore: {
        conditions: function () {
         return (
          f.cache &&
           f.cache.title &&
           (v.attr("title", f.cache.title),
           f.verbose("Restoring original attributes", f.cache.title)),
          !0
         );
        },
       },
       ...
       animate: {
        show: function (e) {
         (e = L.isFunction(e) ? e : function () {}),
          m.transition && L.fn.transition !== z && v.transition("is supported")
           ? (f.set.visible(),
             u.transition({
       ...
       get: {
        ...
        content: function () {
         return (
          v.removeData(h.content),
          v.data(h.content) || m.content || v.attr("title")
         );
        },
        variation: function () {
        ...
        calculations: function () {
         var e,
          ...
          o = y.offset(),
          a =
           m.inline || (m.popup && m.movePopup)
            ? y.offsetParent().offset()
            : { top: 0, left: 0 },
          r = i ? { top: 0, left: 0 } : b.offset(),
          s = {},
          l = i
         ...
         if (
          ((s = {
           ...
           parent: { width: d.outerWidth(), height: d.outerHeight() },
           screen: {
            top: r.top,
            left: r.left,
          ...
          var c = t.offset();
          (s.target.top -= c.top),
           (s.target.left -= c.left),
           (s.parent.width = t.outerWidth()),
           (s.parent.height = t.outerHeight());
         }
         return (
          m.setFluidWidth &&
           f.is.fluid() &&
          ...
          (s.target.margin.top = m.inline
           ? parseInt(V.getComputedStyle(n).getPropertyValue("margin-top"), 10)
           : 0),
          (s.target.margin.left = m.inline
           ? f.is.rtl()
             ? parseInt(
                V.getComputedStyle(n).getPropertyValue("margin-right"),
                10
               )
             : parseInt(
                V.getComputedStyle(n).getPropertyValue("margin-left"),
                10
               )
           : 0),
          (e = s.screen),
        ...
        distanceFromBoundary: function (e, t) {
         var n,
          ...
          o = {};
         return (
          (n = (t = t || f.get.calculations()).popup),
          (i = t.boundary),
          e &&
           ((o = {
            top: e.top - i.top,
           ...
           f.verbose("Distance from boundaries determined", e, o)),
          o
         );
        },
        ...
        nextPosition: function (e) {
         ...
         return (
          c ||
           (f.verbose("All available positions available"),
           (c = f.get.positions())),
          f.debug("Recording last position tried", e),
          (c[e] = !0),
          "opposite" === m.prefer &&
           ((s = (s = [
           ...
           (a = !0 === c[s]),
           f.debug("Trying opposite strategy", s)),
          "adjacent" === m.prefer &&
           o &&
           ((s = (s = [
            n,
           ...
           (r = !0 === c[s]),
           f.debug("Trying adjacent strategy", s)),
          (r || a) &&
           (f.debug("Using backup position", s),
           (s = {
            "top left": "top center",
       ...
       set: {
        position: function (e, t) {
         if (0 !== y.length && 0 !== u.length) {
          var n, i, o, a, r, s, l, c;
          if (
           ((t = t || f.get.calculations()),
           (e = e || v.data(h.position) || m.position),
           (n = v.data(h.offset) || m.offset),
           (i = m.distanceAway),
           (o = t.target),
           (a = t.popup),
           (r = t.parent),
           f.should.centerArrow(t) &&
            (f.verbose(
             "Adjusting offset to center arrow on small target element"
            ),
            ("top left" != e && "bottom left" != e) ||
             ((n += o.width / 2), (n -= m.arrowPixelsFromEdge)),
            ("top right" != e && "bottom right" != e) ||
             ((n -= o.width / 2), (n += m.arrowPixelsFromEdge))),
           0 === o.width && 0 === o.height && !f.is.svg(o.element))
          )
           return f.debug("Popup target is hidden, no action taken"), !1;
          switch (
           (m.inline &&
            (f.debug("Adding margin to calculation", o.margin),
            "left center" == e || "right center" == e
             ...
             : ((n += o.margin.left), (i += o.margin.top))),
           f.debug("Determining popup position from calculations", e, t),
           f.is.rtl() &&
            ((e = e.replace(/left|right/g, function (e) {
             return "left" == e ? "right" : "left";
            })),
            f.debug("RTL: Popup position updated", e)),
           x == m.maxSearchDepth &&
            "string" == typeof m.lastResort &&
            (e = m.lastResort),
           e)
          ) {
           case "top left":
          ...
          if (
           (s === z && f.error(p.invalidPosition, e),
           f.debug("Calculated popup positioning values", s),
           u.css(s).removeClass(g.position).addClass(e).addClass(g.loading),
           (l = f.get.popupOffset()),
           (c = f.get.distanceFromBoundary(l, t)),
           !m.forcePosition && f.is.offstage(c, e))
          ) {
           if (
            (f.debug("Position is outside viewport", e), x < m.maxSearchDepth)
           )
            return (
             x++,
             (e = f.get.nextPosition(e)),
             f.debug("Trying new position", e),
             !!u && f.set.position(e, t)
            );
           if (!m.lastResort)
            return (
             f.debug("Popup could not find a position to display", u),
             f.error(p.cannotPlace, w),
             f.remove.attempts(),
             f.remove.loading(),
             f.reset(),
             m.onUnplaceable.call(u, w),
             !1
            );
           f.debug("No position found, showing with last position");
          }
          return (
           f.debug("Position is on stage", e),
           f.remove.attempts(),
           f.remove.loading(),
           m.setFluidWidth && f.is.fluid() && f.set.fluidWidth(t),
           !0
          );
         }
         f.error(p.notFound);
        ...
        variation: function (e) {
         (e = e || f.get.variation()) &&
          f.has.popup() &&
          (f.verbose("Adding variation to popup", e), u.addClass(e));
        },
        visible: function () {
       ...
       remove: {
        ...
        variation: function (e) {
         (e = e || f.get.variation()) &&
          (f.verbose("Removing variation", e), u.removeClass(e));
        },
        visible: function () {
       ...
       bind: {
        events: function () {
         f.debug("Binding popup events to module"),
          "click" == m.on && v.on(P + a, f.toggle),
          "hover" == m.on && v.on("touchstart" + a, f.event.touchstart),
          f.get.startEvent() &&
           v
            .on(f.get.startEvent() + a, f.event.start)
            .on(f.get.endEvent() + a, f.event.end),
          m.target && f.debug("Target set to element", y),
          A.on("resize" + t, f.event.resize);
        },
        popup: function () {
         f.verbose("Allowing hover events on popup to prevent closing"),
          u &&
           f.has.popup() &&
           u
            .on("mouseenter" + a, f.event.start)
            .on("mouseleave" + a, f.event.end);
        },
        close: function () {
         (!0 === m.hideOnScroll ||
          ("auto" == m.hideOnScroll && "click" != m.on)) &&
          f.bind.closeOnScroll(),
          f.is.closable()
           ? f.bind.clickaway()
           : "hover" == m.on && C && f.bind.touchClose();
        },
        closeOnScroll: function () {
         f.verbose("Binding scroll close event to document"),
          l.one(f.get.scrollEvent() + t, f.event.hideGracefully);
        },
        touchClose: function () {
         f.verbose("Binding popup touchclose event to document"),
          D.on("touchstart" + t, function (e) {
           f.verbose("Touched away from popup"),
            f.event.hideGracefully.call(w, e);
          });
        },
        clickaway: function () {
         f.verbose("Binding popup close event to document"),
          D.on(P + t, function (e) {
           f.verbose("Clicked away from popup"),
            f.event.hideGracefully.call(w, e);
          });
        },
       },
        ...
        offstage: function (e, n) {
         ...
         return (
          L.each(e, function (e, t) {
           t < -m.jitter &&
            (f.debug("Position exceeds allowable distance from edge", e, t, n),
            i.push(e));
          }),
          0 < i.length
         );
       ...
       I
        ? (k === z && f.initialize(), f.invoke(M))
        : (k !== z && k.invoke("destroy"), f.initialize());
     }),
     S !== z ? S : this
    );
   }),
   ...
   (T.fn.progress = function (h) {
    ...
    return (
     e.each(function () {
      var c,
       s = T.isPlainObject(h)
        ? T.extend(!0, {}, T.fn.progress.settings, h)
        : T.extend({}, T.fn.progress.settings),
       n = s.className,
       t = s.metadata,
       e = s.namespace,
       i = s.selector,
      ...
      (c = {
       ...
       destroy: function () {
        c.verbose("Destroying previous progress for", u),
       ...
       complete: function (e) {
        (c.percent === D || c.percent < 100) &&
         (c.remove.progressPoll(), !0 !== e && c.set.percent(100));
       },
       read: {
        metadata: function () {
         var e = {
         ...
         e.total !== D &&
          ...
          c.set.total(e.total)),
          0 < e.value.length &&
           (c.debug("Current value set from metadata", e.value),
           c.set.value(e.value),
           c.set.progress(e.value)),
          0 < e.percent.length &&
           (c.debug("Current percent value set from metadata", e.percent),
           c.set.percent(e.percent));
        },
        settings: function () {
         !1 !== s.total &&
          (c.debug("Current total set in settings", s.total),
          c.set.total(s.total)),
          !1 !== s.value &&
           (c.debug("Current value set in settings", s.value),
           c.set.value(s.value),
           c.set.progress(c.value)),
          !1 !== s.percent &&
           (c.debug("Current percent set in settings", s.percent),
           c.set.percent(s.percent));
        },
       },
       bind: {
       ...
       increment: function (e) {
        ...
        (e = c.has.total()
         ? ((t = c.get.value()), e || 1)
         : ((t = c.get.percent()), e || c.get.randomValue())),
         (n = t + e),
         c.debug("Incrementing percentage by", t, n, e),
         (n = c.get.normalizedValue(n)),
         c.set.progress(n);
       },
       decrement: function (e) {
        var t, n;
        c.get.total()
         ? ((n = (t = c.get.value()) - (e = e || 1)),
           c.debug("Decrementing value by", e, t))
         : ((n = (t = c.get.percent()) - (e = e || c.get.randomValue())),
           c.debug("Decrementing percentage by", e, t)),
         (n = c.get.normalizedValue(n)),
         c.set.progress(n);
       },
       has: {
       ...
       get: {
        text: function (e, t) {
         ...
         return (
          (e = (e = e || "")
           ...
           .replace("{left}", r)
           .replace("{percent}", a)
           .replace("{bar}", s.text.bars[n] || "")),
          c.verbose("Adding variables to progress bar text", e),
          e
         );
        },
        normalizedValue: function (e) {
         ...
         if (c.has.total()) {
          if (e > c.total)
           return (
            c.debug("Value cannot increment above total", c.total), c.total
           );
         } else if (100 < e)
          return c.debug("Value cannot increment above 100 percent"), 100;
         return e;
        },
        ...
        randomValue: function () {
         return (
          c.debug("Generating random increment percentage"),
          Math.floor(Math.random() * s.random.max + s.random.min)
         );
        },
        ...
        displayPercent: function (e) {
         ...
         return 0 < s.precision
          ? Math.round(o * (10 * s.precision)) / (10 * s.precision)
          : Math.round(o);
        },
        percent: function (e) {
       ...
       remove: {
        progressPoll: function () {
         c.verbose("Removing progress poll timer"),
          c.progressPoll &&
           (clearTimeout(c.progressPoll), delete c.progressPoll);
        },
        nextValue: function () {
         c.verbose("Removing progress value stored for next update"),
          delete c.nextValue;
        },
        state: function () {
         c.verbose("Removing stored state"),
          delete c.total,
          delete c.percent,
          delete c.value;
        },
       ...
       set: {
         ...
         var o = -1,
          ...
          t = e.map(function (e, t) {
           ...
           return (
            0 === e && l && !n
             ? i.css("display", "none")
             : (l && n && i.css("background", "transparent"),
               -1 == o && (o = t),
               (a = t),
               i.css({ display: "block", width: e + "%" })),
            parseFloat(e)
           );
          });
        ...
        duration: function (e) {
         (e = "number" == typeof (e = e || s.duration) ? e + "ms" : e),
          c.verbose("Setting progress bar transition duration", e),
          d.css({ "transition-duration": e });
        },
        percent: function (e) {
         e = c.helper.forceArray(e).map(function (e) {
          return (
           (e = "string" == typeof e ? +e.replace("%", "") : e),
           s.limitValues ? Math.max(0, Math.min(100, e)) : e
          );
         });
         var t = c.has.total(),
          n = c.helper.sum(e),
         ...
         if (i && o > c.total) c.error(l.sumExceedsTotal, o, c.total);
          ...
          var a =
            0 < s.precision
             ? s.precision
             : i
             ? c.helper.derivePrecision(Math.min.apply(null, c.value), c.total)
             : 0,
           r = e.map(function (e) {
          ...
          (c.percent = r),
           t &&
            (c.value = e.map(function (e) {
             return 0 < a
              ? Math.round((e / 100) * c.total * (10 * a)) / (10 * a)
              : Math.round((e / 100) * c.total * 10) / 10;
            })),
           c.set.barWidth(e),
           c.set.labelInterval();
         }
        ...
        labelInterval: function () {
         clearInterval(c.interval),
          ...
          (c.interval = setInterval(function () {
           T.contains(S.documentElement, m) ||
            (clearInterval(c.interval), (p = !1)),
            c.set.labels();
          }, s.framerate));
        },
        labels: function () {
         c.verbose("Setting both bar progress and outer label text"),
          c.set.barLabel(),
          c.set.state();
        },
        label: function (e) {
         (e = e || "") &&
          ((e = c.get.text(e)),
          c.verbose("Setting label to text", e),
          f.text(e));
        },
        state: function (e) {
         100 === (e = e !== D ? e : c.helper.sum(c.percent))
          ? s.autoSuccess &&
            1 === d.length &&
            !(c.is.warning() || c.is.error() || c.is.success())
            ? (c.set.success(),
              c.debug("Automatically triggering success at 100%"))
            : (c.verbose("Reached 100% removing active state"),
              c.remove.active(),
              c.remove.progressPoll())
          : 0 < e
          ? (c.verbose("Adjusting active progress bar label", e),
            c.set.active())
          : (c.remove.active(), c.set.label(s.text.active));
        },
        barLabel: function (i) {
         r.map(function (e, t) {
          var n = T(t);
          i !== D
           ? n.text(c.get.text(i, e))
           : "ratio" == s.label && c.has.total()
           ? (c.verbose("Adding ratio to bar label"),
             n.text(c.get.text(s.text.ratio, e)))
           : "percent" == s.label &&
             (c.verbose("Adding percentage to bar label"),
             n.text(c.get.text(s.text.percent, e)));
         });
        },
        active: function (e) {
         (e = e || s.text.active),
          c.debug("Setting active state"),
          s.showActivity && !c.is.active() && u.addClass(n.active),
          c.remove.warning(),
          c.remove.error(),
          c.remove.success(),
          (e = s.onLabelUpdate("active", e, c.value, c.total)) &&
           c.set.label(e),
          c.bind.transitionEnd(function () {
        ...
        success: function (e, t) {
         (e = e || s.text.success || s.text.active),
          c.debug("Setting success state"),
          u.addClass(n.success),
          c.remove.active(),
          c.remove.warning(),
          c.remove.error(),
          c.complete(t),
          (e = s.text.success
           ? s.onLabelUpdate("success", e, c.value, c.total)
           : s.onLabelUpdate("active", e, c.value, c.total)),
          c.set.label(e),
          c.bind.transitionEnd(function () {
        ...
        warning: function (e, t) {
         (e = e || s.text.warning),
          c.debug("Setting warning state"),
          u.addClass(n.warning),
          c.remove.active(),
          c.remove.success(),
          c.remove.error(),
          c.complete(t),
          (e = s.onLabelUpdate("warning", e, c.value, c.total)) &&
           c.set.label(e),
          c.bind.transitionEnd(function () {
        ...
        error: function (e, t) {
         (e = e || s.text.error),
          c.debug("Setting error state"),
          u.addClass(n.error),
          c.remove.active(),
          c.remove.success(),
          c.remove.warning(),
          c.complete(t),
          (e = s.onLabelUpdate("error", e, c.value, c.total)) && c.set.label(e),
          c.bind.transitionEnd(function () {
       ...
       update: {
        toNextValue: function () {
         var e = c.nextValue;
         e &&
          (c.debug("Update interval complete using last updated value", e),
          c.update.progress(e),
          c.remove.nextValue());
        },
        progress: function (e) {
         ...
         var t = c.helper.forceArray(e).map(function (e) {
          var t;
          return (
           !1 === (e = c.get.numericValue(e)) && c.error(l.nonNumeric, e),
           (e = c.get.normalizedValue(e)),
           n
            ? ((t = 0 < c.total ? (e / c.total) * 100 : 100),
              c.debug("Calculating percent complete from total", t))
            : ((t = e), c.debug("Setting value to exact percentage value", t)),
           t
          );
         });
         c.set.percent(t);
       ...
       setting: function (e, t) {
        if ((c.debug("Changing setting", e, t), T.isPlainObject(e)))
         T.extend(!0, s, e);
        else {
         if (t === D) return s[e];
         ...
         "string" == typeof i &&
          ...
          T.each(i, function (e, t) {
           ...
           if (T.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (!T.isPlainObject(r[t]) || e == o)
             return r[t] !== D ? (a = r[t]) : c.error(l.method, i), !1;
            r = r[t];
           }
          })),
       ...
       w
        ? (g === D && c.initialize(), c.invoke(C))
        : (g !== D && g.invoke("destroy"), c.initialize());
     }),
     v !== D ? v : this
    );
   }),
 ...
 (function (U, t, B, W) {
  ...
  (t =
    ...
    return (
     e.each(function () {
      var m,
       ...
       y,
       x = U.isPlainObject(O)
        ? U.extend(!0, {}, U.fn.slider.settings, O)
        : U.extend({}, U.fn.slider.settings),
       i = x.className,
       o = x.metadata,
       a = x.namespace,
       C = x.error,
      ...
      (y = {
       initialize: function () {
        y.debug("Initializing slider", x),
         (b = !0),
         (t = H += 1),
         (n = y.setup.testOutTouch()),
         y.setup.layout(),
         y.setup.labels(),
         y.is.disabled() || y.bind.events(),
         y.read.metadata(),
         y.read.settings(),
         (b = !1),
         y.instantiate();
       ...
       destroy: function () {
        y.verbose("Destroying previous slider for", A),
         clearInterval(F.interval),
         y.unbind.events(),
         y.unbind.slidingEvents(),
         A.removeData(D),
         (F = W);
       },
       setup: {
        layout: function () {
         A.attr("tabindex") === W && A.attr("tabindex", 0),
          0 == A.find(".inner").length &&
           A.append(
            "<div class='inner'><div class='track'></div><div class='track-fill'></div><div class='thumb'></div></div>"
           ),
          (u = y.get.precision()),
          (s = A.find(".thumb:not(.second)")),
          (m = s),
          y.is.range() &&
           (0 == A.find(".thumb.second").length &&
            A.find(".inner").append("<div class='thumb second'></div>"),
           (l = A.find(".thumb.second"))),
          (e = A.find(".track")),
          (g = A.find(".track-fill")),
          (v = s.width() / 2);
        },
        labels: function () {
         y.is.labeled() &&
          (0 != (r = A.find(".labels:not(.auto)")).length
           ? y.setup.customLabel()
           : y.setup.autoLabel(),
          x.showLabelTicks && A.addClass(i.ticked));
        },
        ...
        customLabel: function () {
         ...
         e.each(function (e) {
          ...
          (n = t
           ? ((t = a < t ? a : t < o ? o : t) - o) / (a - o)
           : (e + 1) / (i + 1)),
           y.update.labelPosition(n, U(this));
         });
        },
        autoLabel: function () {
         0 != (r = A.find(".labels")).length
          ? r.empty()
          : (r = A.append('<ul class="auto labels"></ul>').find(".labels"));
         for (var e = 0, t = y.get.numLabels(); e <= t; e++) {
          var n = y.get.label(e),
           i =
            "" !== n
             ? e % y.get.gapRatio()
               ? U('<li class="halftick label"></li>')
               : U('<li class="label">' + n + "</li>")
             : null,
           o = e / t;
       ...
       bind: {
        events: function () {
         y.bind.globalKeyboardEvents(),
          y.bind.keyboardEvents(),
          y.bind.mouseEvents(),
          y.is.touch() && y.bind.touchEvents(),
          x.autoAdjustLabels && y.bind.windowEvents();
        },
        keyboardEvents: function () {
         y.verbose("Binding keyboard events"),
          A.on("keydown" + S, y.event.keydown);
        },
        ...
        mouseEvents: function () {
         y.verbose("Binding mouse events"),
          A.find(".track, .thumb, .inner").on("mousedown" + S, function (e) {
           e.stopImmediatePropagation(), e.preventDefault(), y.event.down(e);
          }),
          A.on("mousedown" + S, y.event.down),
          A.on("mouseenter" + S, function (e) {
           T = !0;
          }),
        ...
        touchEvents: function () {
         y.verbose("Binding touch events"),
          A.find(".track, .thumb, .inner").on("touchstart" + S, function (e) {
           e.stopImmediatePropagation(), e.preventDefault(), y.event.down(e);
          }),
          A.on("touchstart" + S, y.event.down);
        },
        slidingEvents: function () {
         y.verbose("Binding page wide events while handle is being draged"),
          y.is.touch()
           ? (U(B).on("touchmove" + S, y.event.move),
             U(B).on("touchend" + S, y.event.up))
           : (U(B).on("mousemove" + S, y.event.move),
             U(B).on("mouseup" + S, y.event.up));
        },
       ...
       unbind: {
        events: function () {
         A.find(".track, .thumb, .inner").off("mousedown" + S),
          A.find(".track, .thumb, .inner").off("touchstart" + S),
          A.off("mousedown" + S),
          A.off("mouseenter" + S),
          A.off("mouseleave" + S),
          A.off("touchstart" + S),
          A.off("keydown" + S),
          A.off("focusout" + S),
          U(B).off("keydown" + S + t, y.event.activateFocus),
          M.off("resize" + S);
        },
        slidingEvents: function () {
         y.is.touch()
          ? (U(B).off("touchmove" + S), U(B).off("touchend" + S))
          : (U(B).off("mousemove" + S), U(B).off("mouseup" + S));
        },
       },
       event: {
        down: function (e) {
         if ((e.preventDefault(), y.is.range())) {
          var t = y.determine.eventPos(e),
           n = y.determine.pos(t);
          (m =
           x.preventCrossover && y.is.range() && y.thumbVal === y.secondThumbVal
            ? ((f = n), W)
            : y.determine.closestThumb(n)),
           d === W && (d = y.get.currentThumbValue());
        ...
        move: function (e) {
         ...
         if (0 == y.get.step() || y.is.smooth()) {
          ...
          m.hasClass("second")
           ? (x.preventCrossover &&
              y.is.range() &&
              ((t = Math.max(o, t)), (r = Math.max(o, r))),
             (a = t))
           : (x.preventCrossover &&
              y.is.range() &&
              ((t = Math.min(a, t)), (r = Math.min(a, r))),
             (o = t)),
           (t = Math.abs(o - (a || 0))),
           y.update.position(r),
           x.onMove.call(E, t, o, a);
         } else
          y.update.value(t, function (e, t, n) {
        ...
        keydown: function (e, t) {
         if (
          (x.preventCrossover &&
           y.is.range() &&
           y.thumbVal === y.secondThumbVal &&
           (m = W),
          y.is.focused() && U(B).trigger(e),
          t || y.is.focused())
         ) {
        ...
        activateFocus: function (e) {
         !y.is.focused() &&
          y.is.hover() &&
          0 != y.determine.keyMovement(e) &&
          (e.preventDefault(), y.event.keydown(e, !0), A.focus());
        },
        resize: function (e) {
       ...
       resync: function () {
        y.verbose("Resyncing thumb position based on value"),
         y.is.range() && y.update.position(y.secondThumbVal, l),
         y.update.position(y.thumbVal, s),
         y.setup.labels();
       },
       takeStep: function (e) {
        e = e != W ? e : 1;
       ...
       get: {
        ...
        trackStartPos: function () {
         return y.is.reversed()
          ? y.get.trackLeft() + y.get.trackLength()
          : y.get.trackLeft();
        },
        ...
        numLabels: function () {
         var e = Math.round(
          (y.get.max() - y.get.min()) / (0 === y.get.step() ? 1 : y.get.step())
         );
        ...
        label: function (e) {
         ...
         switch (x.labelType) {
          case x.labelTypes.number:
           return (
            Math.round(
             (e * (0 === y.get.step() ? 1 : y.get.step()) + y.get.min()) * u
            ) / u
           );
       ...
       determine: {
        pos: function (e) {
         return y.is.reversed()
          ? y.get.trackStartPos() - e + y.get.trackOffset()
          : e - y.get.trackOffset() - y.get.trackStartPos();
        },
        closestThumb: function (e) {
         var t = parseFloat(y.determine.thumbPos(s)),
          ...
          o = Math.abs(e - i);
         return n === o && y.get.thumbValue() === y.get.min()
          ? l
          : n <= o
          ? s
          : l;
        ...
        valueFromEvent: function (e) {
         var t = y.determine.eventPos(e),
          n = y.determine.pos(t);
         return t < y.get.trackOffset()
          ? y.is.reversed()
            ? y.get.max()
            : y.get.min()
          : t > y.get.trackOffset() + y.get.trackLength()
          ? y.is.reversed()
            ? y.get.min()
            : y.get.max()
          : y.determine.value(n);
        ...
        value: function (e) {
         var t = y.is.reversed() ? y.get.trackEndPos() : y.get.trackStartPos(),
          n =
           (e - t) /
           ((y.is.reversed() ? y.get.trackStartPos() : y.get.trackEndPos()) -
            t),
         ...
         return (
          y.verbose("Determined value based upon position: " + e + " as: " + a),
          a != r && y.verbose("Rounding value to closest step: " + r),
          y.verbose("Cutting off additional decimal places"),
          Math.round((r + y.get.min()) * u) / u
         );
        },
       ...
       handleNewValuePosition: function (e) {
        var t = y.get.min(),
         n = y.get.max();
        return (
         e <= t ? (e = t) : n <= e && (e = n), y.determine.positionFromValue(e)
        );
       },
       set: {
        value: function (i, o) {
         ...
         var a = d === W;
         (d = d === W ? y.get.value() : d),
          y.update.value(i, function (e, t, n) {
           (b && !x.fireOnInit) ||
            !o ||
            (i !== d && x.onChange.call(E, e, t, n), x.onMove.call(E, e, t, n)),
            a && (d = W);
          });
        },
        rangeValue: function (e, t, n) {
         if (((n = !1 !== n), y.is.range())) {
          ...
          (d = d === W ? y.get.value() : d),
           ...
           (y.thumbVal = e),
           (y.secondThumbVal = t),
           (c = Math.abs(y.thumbVal - y.secondThumbVal)),
           y.update.position(y.thumbVal, s),
           y.update.position(y.secondThumbVal, l),
           (b && !x.fireOnInit) ||
            !n ||
            (c !== d && x.onChange.call(E, c, y.thumbVal, y.secondThumbVal),
            x.onMove.call(E, c, y.thumbVal, y.secondThumbVal)),
           a && (d = W);
       ...
       update: {
        value: function (e, t) {
         ...
         e <= n ? (e = n) : i <= e && (e = i),
          y.is.range()
           ? (m === W && (m = e <= y.get.currentThumbValue() ? s : l),
             m.hasClass("second")
              ? (x.preventCrossover &&
                 y.is.range() &&
                 (e = Math.max(y.thumbVal, e)),
                (y.secondThumbVal = e))
              : (x.preventCrossover &&
                 y.is.range() &&
                 (e = Math.min(y.secondThumbVal, e)),
                (y.thumbVal = e)),
             (c = Math.abs(y.thumbVal - y.secondThumbVal)))
           : ((c = e), (y.thumbVal = c)),
          y.update.position(e),
          y.debug("Setting slider value to " + c),
          "function" == typeof t && t(c, y.thumbVal, y.secondThumbVal);
        },
        position: function (e, t) {
         ...
         (r = y.is.vertical()
          ? y.is.reversed()
            ? ((s = { bottom: "calc(" + u + "% - " + v + "px)", top: "auto" }),
              { bottom: d + "%", top: f + "%" })
            : ((s = { top: "calc(" + u + "% - " + v + "px)", bottom: "auto" }),
              { top: d + "%", bottom: f + "%" })
          : y.is.reversed()
          ? ((s = { right: "calc(" + u + "% - " + v + "px)", left: "auto" }),
            { right: d + "%", left: f + "%" })
          : ((s = { left: "calc(" + u + "% - " + v + "px)", right: "auto" }),
            { left: d + "%", right: f + "%" })),
          i.css(s),
          g.css(r),
          y.debug("Setting slider position to " + n);
        },
       ...
       read: {
        metadata: function () {
         ...
         e.thumbVal &&
          (y.is.range() && e.secondThumbVal
           ? (y.debug(
              "Current value set from metadata",
              e.thumbVal,
              e.secondThumbVal
             ),
             y.set.rangeValue(e.thumbVal, e.secondThumbVal))
           : (y.debug("Current value set from metadata", e.thumbVal),
             y.set.value(e.thumbVal)));
        },
        settings: function () {
         !1 !== x.start &&
          (y.is.range()
           ? (y.debug("Start position set from settings", x.start, x.end),
             y.set.rangeValue(x.start, x.end))
           : (y.debug("Start position set from settings", x.start),
             y.set.value(x.start)));
        },
       },
       setting: function (e, t) {
        if ((y.debug("Changing setting", e, t), U.isPlainObject(e)))
         U.extend(!0, x, e);
        else {
         if (t === W) return x[e];
         ...
         "string" == typeof i &&
          ...
          U.each(i, function (e, t) {
           ...
           if (U.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (!U.isPlainObject(r[t]) || e == o)
             return r[t] !== W ? (a = r[t]) : y.error(C.method, i), !1;
            r = r[t];
           }
          })),
         U.isFunction(a) ? (n = a.apply(t, e)) : a !== W && (n = a),
         U.isArray(R) ? R.push(n) : R !== W ? (R = [R, n]) : n !== W && (R = n),
         a
        );
       },
      }),
       q
        ? (F === W && y.initialize(), y.invoke(V))
        : (F !== W && F.invoke("destroy"), y.initialize());
     }),
     R !== W ? R : this
    );
   }),
   (U.fn.slider.settings = {
    ...
    metadata: { thumbVal: "thumbVal", secondThumbVal: "secondThumbVal" },
    min: 0,
    max: 20,
    step: 1,
    start: 0,
 ...
 (function (k, e, t, T) {
  ...
  (k.isFunction =
    ...
    return (
     h.each(function () {
      var e,
       a,
       r = k.isPlainObject(g)
        ? k.extend(!0, {}, k.fn.rating.settings, g)
        : k.extend({}, k.fn.rating.settings),
       t = r.namespace,
       s = r.className,
       n = r.metadata,
       i = r.selector,
      ...
      (a = {
       initialize: function () {
        a.verbose("Initializing rating module", r),
         0 === m.length && a.setup.layout(),
         r.interactive && !a.is.disabled() ? a.enable() : a.disable(),
         a.set.initialLoad(),
         a.set.rating(a.get.initialRating()),
         a.remove.initialLoad(),
         a.instantiate();
       },
       instantiate: function () {
       ...
       destroy: function () {
        a.verbose("Destroying previous instance", d),
         a.remove.events(),
         f.removeData(c);
       },
       refresh: function () {
       ...
       event: {
        mouseenter: function () {
         var e = k(this);
         e.nextAll().removeClass(s.selected),
          f.addClass(s.selected),
          e.addClass(s.selected).prevAll().addClass(s.selected);
        },
        mouseleave: function () {
        ...
        click: function () {
         var e = k(this),
          t = a.get.rating(),
          n = m.index(e) + 1;
         ("auto" == r.clearable ? 1 === m.length : r.clearable) && t == n
          ? a.clearRating()
          : a.set.rating(n);
        },
       },
       ...
       bind: {
        events: function () {
         a.verbose("Binding events"),
          f
           .on("mouseenter" + o, i.icon, a.event.mouseenter)
           .on("mouseleave" + o, i.icon, a.event.mouseleave)
           .on("click" + o, i.icon, a.event.click);
        },
       },
       remove: {
        events: function () {
       ...
       enable: function () {
        a.debug("Setting rating to interactive mode"),
         a.bind.events(),
         f.removeClass(s.disabled);
       },
       disable: function () {
        a.debug("Setting rating to read-only mode"),
         a.remove.events(),
         f.addClass(s.disabled);
       },
       is: {
        initialLoad: function () {
         return e;
       ...
       get: {
        ...
        initialRating: function () {
         return f.data(n.rating) !== T
          ? (f.removeData(n.rating), f.data(n.rating))
          : r.initialRating;
        },
        maxRating: function () {
         return f.data(n.maxRating) !== T
          ? (f.removeData(n.maxRating), f.data(n.maxRating))
          : r.maxRating;
        },
        rating: function () {
       ...
       set: {
        rating: function (e) {
         var t = Math.floor(0 <= e - 1 ? e - 1 : 0),
          ...
          i = e <= 1 ? n : n.next(),
          o = (e % 1) * 100;
         f.removeClass(s.selected),
          m
           .removeClass(s.selected)
           .removeClass(s.active)
           .removeClass(s.partiallyActive),
          0 < e &&
           (a.verbose("Setting current rating to", e),
           n.prevAll().addBack().addClass(s.active),
           n.next() &&
            e % 1 != 0 &&
            (i.addClass(s.partiallyActive).addClass(s.active),
            i.css(l.filledCustomPropName, o + "%"),
            "transparent" === i.css("backgroundColor") &&
             i.removeClass(s.partiallyActive).removeClass(s.active))),
          a.is.initialLoad() || r.onRate.call(u, e);
        },
        initialLoad: function () {
         e = !0;
        },
       ...
       setting: function (e, t) {
        if ((a.debug("Changing setting", e, t), k.isPlainObject(e)))
         k.extend(!0, r, e);
        else {
         if (t === T) return r[e];
       ...
       C
        ? (d === T && a.initialize(), a.invoke(x))
        : (d !== T && d.invoke("destroy"), a.initialize());
     }),
     p !== T ? p : this
    );
   }),
   (k.fn.rating.settings = {
    ...
    metadata: { rating: "rating", maxRating: "maxRating", icon: "icon" },
    className: {
     active: "active",
     disabled: "disabled",
     selected: "selected",
 ...
 (function (F, P, O, R) {
  ...
  (F.isFunction =
   ...
   (P =
    void 0 !== P && P.Math == Math
     ? P
     : "undefined" != typeof self && self.Math == Math
     ? self
     : Function("return this")()),
   (F.fn.search = function (c) {
    var C,
     w = F(this),
     k = w.selector || "",
     T = new Date().getTime(),
    ...
    return (
     F(this).each(function () {
      var f,
       u = F.isPlainObject(c)
        ? F.extend(!0, {}, F.fn.search.settings, c)
        : F.extend({}, F.fn.search.settings),
       m = u.className,
       d = u.metadata,
       i = u.regExp,
       a = u.fields,
      ...
      (f = {
       ...
       bind: {
        events: function () {
         f.verbose("Binding events to search"),
          u.automatic &&
           (h.on(f.get.inputEvent() + o, g.prompt, f.event.input),
           v.attr("autocomplete", f.is.chrome() ? "fomantic-search" : "off")),
          h
           .on("focus" + o, g.prompt, f.event.focus)
           .on("blur" + o, g.prompt, f.event.blur)
           .on("keydown" + o, g.prompt, f.handleKeyboard)
           .on("click" + o, g.searchButton, f.query)
           .on("mousedown" + o, g.results, f.event.result.mousedown)
           .on("mouseup" + o, g.results, f.event.result.mouseup)
           .on("click" + o, g.result, f.event.result.click);
        },
       },
       determine: {
       ...
       event: {
        ...
        blur: function (e) {
         function t() {
          f.cancel.query(),
           f.remove.focus(),
           (f.timer = setTimeout(f.hideResults, u.hideDelay));
         }
         ...
         n ||
          ...
          f.resultsClicked
           ? (f.debug("Determining if user action caused search to close"),
             h.one("click.close" + o, g.results, function (e) {
              f.is.inMessage(e) || y
               ? v.focus()
               : ((y = !1), f.is.animating() || f.is.hidden() || t());
             }))
        ...
        result: {
         ...
         click: function (e) {
          ...
          var t = F(this),
           ...
           c = f.get.value();
          if (F.isFunction(u.onSelect) && !1 === u.onSelect.call(b, l, s))
           return (
            f.debug("Custom onSelect callback cancelled default select action"),
            void (y = !0)
           );
          f.hideResults(),
           r && f.get.value() === c && f.set.value(r),
           o &&
            (e.preventDefault(),
            f.verbose("Opening search link found in result", i),
            "_blank" == a || e.ctrlKey ? P.open(o) : (P.location.href = o));
         },
        },
       },
       ensureVisible: function (e) {
        ...
        0 !== e.length &&
         ...
         (i = r.scrollTop()),
         (o = r.height()),
         t < 0 ? r.scrollTop(i + t) : o < n && r.scrollTop(i + (n - o)));
       },
       ...
       can: {
        ...
        transition: function () {
         return (
          u.transition && F.fn.transition !== R && h.transition("is supported")
         );
        },
       },
       is: {
        ...
        inMessage: function (e) {
         if (e.target) {
          var t = F(e.target);
          return (
           F.contains(O.documentElement, e.target) &&
       ...
       get: {
        settings: function () {
         F.isPlainObject(c) &&
          c.searchFullText &&
          ((u.fullTextSearch = c.searchFullText),
          f.error(u.error.oldSearchSyntax, b)),
          u.ignoreDiacritics &&
           !String.prototype.normalize &&
           ((u.ignoreDiacritics = !1), f.error(p.noNormalize, b));
        },
        inputEvent: function () {
         var e = v[0];
         return e !== R && e.oninput !== R
          ? "input"
          : e !== R && e.onpropertychange !== R
          ? "propertychange"
          : "keyup";
        },
        value: function () {
         ...
         f.has.minimumCharacters()
          ? (n
             ...
             : (f.debug("Querying for", t),
               F.isPlainObject(u.source) || Array.isArray(u.source)
                ? (f.search.local(t), e())
                : f.can.useAPI()
                ? f.search.remote(t, e)
                : (f.error(p.source), e())),
       ...
       search: {
        local: function (e) {
         ...
         f.set.loading(),
          ...
          "category" == u.type && (n = f.create.categoryResults(n)),
           ...
           : (F.each(e, function (e, i) {
              F.each(t, function (e, t) {
               ...
               ("string" != typeof t[i] && "number" != typeof t[i]) ||
                ...
                (n =
                 "string" == typeof t[i]
                  ? f.remove.diacritics(t[i])
                  : t[i].toString()).search(c)
                 ? a(r, t)
                 : "exact" === u.fullTextSearch && f.exactSearch(o, n)
                 ? a(s, t)
                 : 1 == u.fullTextSearch && f.fuzzySearch(o, n) && a(l, t));
              });
             }),
             F.merge(s, l),
             F.merge(r, s),
        ...
        response: function (e, t) {
         ...
         f.verbose("Parsing server response", e),
          e !== R &&
           ...
           f.write.cache(t, { html: i, results: e[a.results] }),
        ...
        cache: function (e) {
         ...
         e
          ? e &&
            ...
            delete t[e],
            h.data(d.cache, t))
          : (f.debug("Clearing cache", e), h.removeData(d.cache));
        },
       },
       read: {
        cache: function (e) {
         ...
         return (
          "category" === u.type
           ? F.each(e, function (e, t) {
              0 < t.results.length &&
               ((i = 0),
               F.each(t.results, function (e, t) {
                t.id === R && (t.id = f.create.id(i, n)),
                 f.inject.result(t, i, n),
                 i++;
               }),
               n++);
             })
       ...
       addResults: function (e) {
        if (F.isFunction(u.onResultsAdd) && !1 === u.onResultsAdd.call(r, e))
         return f.debug("onResultsAdd callback cancelled default action"), !1;
        e
         ? (r.html(e),
           f.refreshResults(),
           u.selectFirstResult && f.select.firstResult(),
           f.showResults())
       ...
       generateResults: function (e) {
        ...
        return (
         n || i
          ? (0 < u.maxResults &&
             (n
              ? "standard" == u.type && f.error(p.maxResults)
              : (e[a.results] = e[a.results].slice(0, u.maxResults))),
            F.isFunction(t)
             ? (o = t(e, a, u.preserveHTML))
             : f.error(p.noTemplate, !1))
          : u.showNoResults &&
            (o = f.displayMessage(p.noResults, "empty", p.noResultsHeader)),
       ...
       displayMessage: function (e, t, n) {
        return (
         (t = t || "standard"),
         f.debug("Displaying message", e, t, n),
         f.addResults(u.templates.message(e, t, n)),
          ...
          F.each(i, function (e, t) {
           ...
           if (F.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (!F.isPlainObject(r[t]) || e == o)
             return r[t] !== R && (a = r[t]), !1;
            r = r[t];
           }
          })),
         F.isFunction(a) ? (n = a.apply(t, e)) : a !== R && (n = a),
         Array.isArray(C)
          ? C.push(n)
          : C !== R
          ? (C = [C, n])
       ...
       A
        ? (l === R && f.initialize(), f.invoke(D))
        : (l !== R && l.invoke("destroy"), f.initialize());
     }),
     C !== R ? C : this
    );
   }),
   (F.fn.search.settings = {
    ...
    templates: {
     ...
     category: function (e, n, i) {
      ...
      return (
       e[n.categoryResults] !== R &&
       (F.each(e[n.categoryResults], function (e, t) {
        t[n.results] !== R &&
         0 < t.results.length &&
         ((o += '<div class="category">'),
         t[n.categoryName] !== R &&
          (o += '<div class="name">' + a(t[n.categoryName], i) + "</div>"),
         (o += '<div class="results">'),
         F.each(t.results, function (e, t) {
          t[n.url]
           ? (o +=
              '<a class="result" href="' + t[n.url].replace(/"/g, "") + '">')
           : (o += '<a class="result">'),
           t[n.image] !== R &&
            (o +=
           ...
           (o += '<div class="content">'),
           t[n.price] !== R &&
            (o += '<div class="price">' + a(t[n.price], i) + "</div>"),
           t[n.title] !== R &&
            (o += '<div class="title">' + a(t[n.title], i) + "</div>"),
           t[n.description] !== R &&
            (o +=
             '<div class="description">' + a(t[n.description], i) + "</div>"),
           (o += "</div>"),
           (o += "</a>");
         }),
         (o += "</div>"),
       ...
       e[n.action] &&
        (!1 === n.actionURL
         ? (o +=
            '<div class="action">' + a(e[n.action][n.actionText], i) + "</div>")
         : (o +=
            '<a href="' +
            e[n.action][n.actionURL].replace(/"/g, "") +
            '" class="action">' +
     ...
     standard: function (e, n, i) {
      ...
      return (
       e[n.results] !== R &&
       (F.each(e[n.results], function (e, t) {
        t[n.url]
         ? (o += '<a class="result" href="' + t[n.url].replace(/"/g, "") + '">')
         : (o += '<a class="result">'),
         t[n.image] !== R &&
          (o +=
           '<div class="image"> <img src="' +
    ...
    return (
     x.each(function () {
      var i,
       ...
       t = x.selector || "",
       s = A.isPlainObject(b)
        ? A.extend(!0, {}, A.fn.shape.settings, b)
      ...
      if (
       ((r = {
        initialize: function () {
         r.verbose("Initializing module for", p),
          r.set.defaultSide(),
          r.instantiate();
        },
        instantiate: function () {
        ...
        refresh: function () {
         r.verbose("Refreshing selector cache for", p),
          (d = A(p)),
          (f = A(this).find(l.sides)),
          (m = A(this).find(l.side));
        },
        repaint: function () {
        ...
        animate: function (e, t) {
         r.verbose("Animating box with properties", e),
          (t =
           t ||
           function (e) {
            r.verbose("Executing animation callback"),
             e !== F && e.stopPropagation(),
             r.reset(),
             r.set.active();
           }),
          s.beforeChange.call(o[0]),
          r.get.transitionEvent()
           ? (r.verbose("Starting CSS animation"),
             d.addClass(c.animating),
             f.css(e).one(r.get.transitionEvent(), t),
             r.set.duration(s.duration),
             D(function () {
        ...
        queue: function (e) {
         r.debug("Queueing animation of", e),
          f.one(r.get.transitionEvent(), function () {
           r.debug("Executing queued animation"),
            setTimeout(function () {
             d.shape(e);
            }, 0);
          });
        ...
        reset: function () {
         r.verbose("Animating states reset"),
          d.removeClass(c.animating).attr("style", "").removeAttr("style"),
          f.attr("style", "").removeAttr("style"),
          m.attr("style", "").removeAttr("style").removeClass(c.hidden),
          o.removeClass(c.animating).attr("style", "").removeAttr("style");
        },
        is: {
         complete: function () {
        ...
        set: {
         defaultSide: function () {
          (i = m.filter("." + s.className.active)),
           (o = 0 < i.next(l.side).length ? i.next(l.side) : m.first()),
           (g = !1),
           r.verbose("Active side set to", i),
           r.verbose("Next side set to", o);
         },
         duration: function (e) {
          (e = "number" == typeof (e = e || s.duration) ? e + "ms" : e),
           r.verbose("Setting animation duration", e),
          ...
          var e = d.clone().addClass(c.loading),
           ...
           a =
            "next" === s.height
             ...
             ? d.height()
             : s.height;
          n.removeClass(c.active),
           i.addClass(c.active),
           e.insertAfter(d),
           e.remove(),
           "auto" !== s.width &&
            (d.css("width", o + s.jitter),
            r.verbose("Specifying width during animation", o)),
           "auto" !== s.height &&
            (d.css("height", a + s.jitter),
            r.verbose("Specifying height during animation", a));
         },
         nextSide: function (e) {
          (g = e),
           (o = m.filter(e)),
           (g = m.index(o)),
           0 === o.length && (r.set.defaultSide(), r.error(n.side)),
           r.verbose("Next side manually set to", o);
         },
         active: function () {
          r.verbose("Setting new side to active", o),
           m.removeClass(c.active),
           o.addClass(c.active),
           s.onChange.call(o[0]),
           r.set.defaultSide();
         },
        ...
        get: {
         transform: {
          ...
          down: function () {
           ...
           return {
            transform:
             "translateY(-" + e + "px) translateZ(-" + e + "px) rotateX(90deg)",
           };
          },
          left: function () {
         ...
         transitionEvent: function () {
          ...
          for (e in n) if (t.style[e] !== F) return n[e];
         },
         nextSide: function () {
        ...
        stage: {
         above: function () {
          ...
          r.verbose("Setting the initial animation position as above", o, e),
           i.css({ transform: "rotateX(0deg)" }),
         ...
         below: function () {
          ...
          r.verbose("Setting the initial animation position as below", o, e),
           i.css({ transform: "rotateX(0deg)" }),
           o.addClass(c.animating).css({
            top: e.origin + "px",
            transform:
         ...
         left: function () {
          ...
          r.verbose("Setting the initial animation position as left", o, n),
         ...
         right: function () {
          var e = i.outerWidth(!0),
           t = o.outerWidth(!0),
           n = { origin: (e - t) / 2, depth: { active: t / 2, next: e / 2 } };
          r.verbose("Setting the initial animation position as right", o, n),
           i.css({ transform: "rotateY(0deg)" }),
           o.addClass(c.animating).css({
            left: n.origin + "px",
            transform:
         ...
         behind: function () {
          var e = i.outerWidth(!0),
           t = o.outerWidth(!0),
           n = { origin: (e - t) / 2, depth: { active: t / 2, next: e / 2 } };
          r.verbose("Setting the initial animation position as behind", o, n),
           i.css({ transform: "rotateY(0deg)" }),
           o
        ...
        setting: function (e, t) {
         if ((r.debug("Changing setting", e, t), A.isPlainObject(e)))
          A.extend(!0, s, e);
         else {
          if (t === F) return s[e];
           ...
           A.each(i, function (e, t) {
            ...
            if (A.isPlainObject(r[n]) && e != o) r = r[n];
             ...
             if (!A.isPlainObject(r[t]) || e == o)
              return r[t] !== F && (a = r[t]), !1;
             r = r[t];
            }
           })),
          A.isFunction(a) ? (n = a.apply(t, e)) : a !== F && (n = a),
          Array.isArray(y)
           ? y.push(n)
           : y !== F
           ? (y = [y, n])
    ...
    return (
     e.each(function () {
      var r,
       ...
       c,
       u = M.isPlainObject(x)
        ? M.extend(!0, {}, M.fn.sidebar.settings, x)
      ...
      (c = {
       initialize: function () {
        c.debug("Initializing sidebar", x),
         ...
         u.delaySetup ? R(c.setup.layout) : c.setup.layout(),
         R(function () {
          c.setup.cache();
         }),
         c.instantiate();
           ...
           ("left" === o || "right" === o
            ...
            : ("top" !== o && "bottom" != o) ||
              (e +=
               ...
               "px, 0); }"),
           (e +=
            " body.pushable > .ui.visible.left.sidebar ~ .ui.visible.right.sidebar ~ .pusher:after, body.pushable > .ui.visible.right.sidebar ~ .ui.visible.left.sidebar ~ .pusher:after {   -webkit-transform: translate3d(0, 0, 0);           transform: translate3d(0, 0, 0); }")),
          (r = M((e += "</style>")).appendTo(S)),
       ...
       attachEvents: function (e, t) {
        var n = M(e);
        (t = M.isFunction(c[t]) ? c[t] : c.toggle),
         0 < n.length
       ...
       is: {
        ie: function () {
         return (
          (!I.ActiveXObject && "ActiveXObject" in I) || "ActiveXObject" in I
         );
        },
        ios: function () {
        ...
        rtl: function () {
         return (
          c.cache.rtl === L &&
           (c.cache.rtl =
            "rtl" === g.attr("dir") || "rtl" === g.css("direction")),
          c.cache.rtl
         );
        },
       },
       setting: function (e, t) {
        if ((c.debug("Changing setting", e, t), M.isPlainObject(e)))
         M.extend(!0, u, e);
        else {
         if (t === L) return u[e];
         ...
         "string" == typeof i &&
          ...
          M.each(i, function (e, t) {
           ...
           if (M.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (r[n] !== L) return (a = r[n]), !1;
            if (!M.isPlainObject(r[t]) || e == o)
             return r[t] !== L ? (a = r[t]) : c.error(d.method, i), !1;
            r = r[t];
           }
          })),
         M.isFunction(a) ? (n = a.apply(t, e)) : a !== L && (n = a),
       ...
       P
        ? (y === L && c.initialize(), c.invoke(F))
        : (y !== L && c.invoke("destroy"), c.initialize());
     }),
     C !== L ? C : this
    );
   }),
    ...
    return (
     e.each(function () {
      var t,
       ...
       d,
       f = S.isPlainObject(v)
        ? S.extend(!0, {}, S.fn.sticky.settings, v)
        : S.extend({}, S.fn.sticky.settings),
       o = f.className,
       a = f.namespace,
       r = f.error,
       s = "." + a,
      ...
      (d = {
       initialize: function () {
        d.determineContainer(),
         d.determineContext(),
         d.verbose("Initializing sticky", f, t),
         d.save.positions(),
         d.checkErrors(),
         d.bind.events(),
       ...
       observeChanges: function () {
        "MutationObserver" in D &&
         ...
         (n = new MutationObserver(d.event.changed)),
       ...
       determineContext: function () {
        0 !== (i = f.context ? S(f.context) : t).length ||
       ...
       set: {
        ...
        containerSize: function () {
         ...
         "HTML" === e || "body" == e
          ? d.determineContainer()
          : Math.abs(t.outerHeight() - d.cache.context.height) > f.jitter &&
            (d.debug(
             "Context has padding, specifying exact height for container",
             d.cache.context.height
            ),
            t.css({ height: d.cache.context.height }));
        },
        minimumSize: function () {
       ...
       resetCSS: function () {
        c.css({ width: "", height: "" }), t.css({ height: "" });
       },
       setting: function (e, t) {
       ...
       k
        ? (g === E && d.initialize(), d.invoke(w))
        : (g !== E && g.invoke("destroy"), d.initialize());
     }),
     b !== E ? b : this
    );
   }),
    ...
    return (
     d.each(function () {
      var p,
       ...
       y,
       x = P.isPlainObject(c)
        ? P.extend(!0, {}, P.fn.tab.settings, c)
        : P.extend({}, P.fn.tab.settings),
       C = x.className,
       w = x.metadata,
       t = x.selector,
       k = x.error,
      ...
      (b = {
       initialize: function () {
        b.debug("Initializing tab menu item", T),
         ...
         x.auto && b.set.auto(),
         b.bind.events(),
         x.history && !F && (b.initializeHistory(), (F = !0)),
         x.autoTabActivation &&
          l === M &&
          null == b.determine.activeTab() &&
          (b.debug(
           "No active tab detected, setting first tab active",
           b.get.initialPath()
          ),
          b.changeTab(
           !0 === x.autoTabActivation
            ? b.get.initialPath()
            : x.autoTabActivation
          )),
         b.instantiate();
       ...
       bind: {
        events: function () {
         P.isWindow(s) ||
          ...
          T.on("click" + e, b.event.click));
        },
       },
       determineTabs: function () {
        var e;
        "parent" === x.context
         ? (0 < T.closest(t.ui).length
            ? ((e = T.closest(t.ui)),
       ...
       fix: {
        callbacks: function () {
         P.isPlainObject(c) &&
          (c.onTabLoad || c.onTabInit) &&
          (c.onTabLoad &&
           ((c.onLoad = c.onTabLoad),
           delete c.onTabLoad,
           b.error(k.legacyLoad, c.onLoad)),
          c.onTabInit &&
           ((c.onFirstLoad = c.onTabInit),
           delete c.onTabInit,
           b.error(k.legacyInit, c.onFirstLoad)),
          (x = P.extend(!0, {}, P.fn.tab.settings, c)));
        },
       },
       initializeHistory: function () {
        if ((b.debug("Initializing page state"), P.address === M))
       ...
       event: {
        click: function (e) {
         ...
         t !== M
          ? (x.history
             ? (b.verbose("Updating page state", e), P.address.value(t))
        ...
        (d = b.utilities.arrayToPath(g)),
         P.each(g, function (e, t) {
          ...
          if ((b.verbose("Looking for tab", t), l)) {
           ...
           if (-1 != d.search("/") || "" === d)
            return b.error(k.missingTab, T, p, s), !1;
           if (
            ((d = b.escape.string(d)),
            (s = (n = P("#" + d + ', a[name="' + d + '"]'))
             .closest("[data-tab]")
       ...
       update: {
        content: function (e, t, n) {
         var i = b.get.tabElement(e),
          o = i[0];
         (n = n !== M ? n : x.evaluateScripts),
          "string" == typeof x.cacheType &&
          "dom" == x.cacheType.toLowerCase() &&
          "string" != typeof t
           ? i.empty().append(P(t).clone(!0))
           : n
           ? (b.debug("Updating HTML and evaluating inline scripts", e, t),
             i.html(t))
       ...
       activate: {
        ...
        navigation: function (e) {
         ...
         b.verbose("Activating tab navigation for", t, e),
          i ||
           (t.addClass(C.active), n.removeClass(C.active + " " + C.loading));
        },
       },
       deactivate: {
        all: function () {
       ...
       get: {
        ...
        defaultPath: function (e) {
         var t =
          d
           .filter("[data-" + w.tab + '^="' + b.escape.string(e) + '/"]')
           .eq(0)
           .data(w.tab) || !1;
         if (t) {
          if ((b.debug("Found default tab", t), r < x.maxDepth))
           return r++, b.get.defaultPath(t);
          b.error(k.recursion);
        ...
        navElement: function (e) {
         return (
          (e = e || h),
          d.filter("[data-" + w.tab + '="' + b.escape.string(e) + '"]')
         );
        },
        tabElement: function (e) {
         ...
         return (
          ...
          (t = a.filter("[data-" + w.tab + '="' + b.escape.string(e) + '"]')),
          (n = a.filter("[data-" + w.tab + '="' + b.escape.string(o) + '"]')),
          0 < t.length ? t : n
         );
        },
        tab: function () {
         ...
         return (
          a.each(function (e, t) {
           if (P(t).hasClass(C.active)) {
            ...
            d
             .filter("[data-" + w.tab + '="' + b.escape.string(n) + '"]')
             .hasClass(C.active) && (i = n);
           }
          }),
          i
         );
       ...
       setting: function (e, t) {
        if ((b.debug("Changing setting", e, t), P.isPlainObject(e)))
         P.extend(!0, x, e);
        else {
         if (t === M) return x[e];
         ...
         "string" == typeof i &&
          ...
          P.each(i, function (e, t) {
           ...
           if (P.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (!P.isPlainObject(r[t]) || e == o)
             return r[t] !== M ? (a = r[t]) : b.error(k.method, i), !1;
            r = r[t];
           }
          })),
         P.isFunction(a) ? (n = a.apply(t, e)) : a !== M && (n = a),
         Array.isArray(u)
          ? u.push(n)
          : u !== M
          ? (u = [u, n])
       ...
       A
        ? (l === M && b.initialize(), b.invoke(D))
        : (l !== M && l.invoke("destroy"), b.initialize());
     }),
     u !== M ? u : this
    );
   }),
    ...
    return (
     e.each(function () {
      var i,
       ...
       u,
       d = F.isPlainObject(C)
        ? F.extend(!0, {}, F.fn.toast.settings, C)
        : F.extend({}, F.fn.toast.settings),
       f = d.className,
       m = d.selector,
       g = d.error,
       e = d.namespace,
      ...
      (u = {
       initialize: function () {
        u.verbose("Initializing element"),
         u.has.container() || u.create.container(),
         (b ||
          "" !== d.message ||
          "" !== d.title ||
          "" !== u.get.iconClass() ||
          d.showImage ||
          u.has.configActions()) &&
          (("string" == typeof d.showProgress &&
           -1 !== [f.top, f.bottom].indexOf(d.showProgress)) ||
           (d.showProgress = !1),
          u.create.toast(),
          d.closeOnClick &&
           (d.closeIcon ||
            0 < F(o).find(m.input).length ||
            u.has.configActions()) &&
           (d.closeOnClick = !1),
          d.closeOnClick || i.addClass(f.unclickable),
          u.bind.events()),
         u.instantiate(),
         i && u.show();
       },
       ...
       create: {
        ...
        toast: function () {
         ...
         if (b)
          (o = d.cloneModule ? h.clone().removeAttr("id") : h),
           (c = o.find("> i" + u.helpers.toClass(f.close))),
           (d.closeIcon = 0 < c.length),
           "" !== e && o.find(m.icon).attr("class", e + " " + f.icon),
           d.showImage && o.find(m.image).attr("src", d.showImage),
           "" !== d.title &&
            o.find(m.title).html(u.helpers.escape(d.title, d.preserveHTML)),
           "" !== d.message &&
            o.find(m.message).html(u.helpers.escape(d.message, d.preserveHTML));
         else {
          u.verbose("Creating toast"), (o = F("<div/>"));
          var t = F("<div/>", { class: f.content });
          "" !== e && o.append(F("<i/>", { class: e + " " + f.icon })),
           d.showImage &&
            o.append(
             F("<img>", {
           ...
           "" !== d.title &&
            t.append(F("<div/>", { class: f.title, text: d.title })),
           t.append(
            F("<div/>", {
             class: f.message,
           ...
           o.addClass(d.class + " " + f.toast).append(t),
           o.css("opacity", d.opacity),
           d.closeIcon &&
            ((c = F("<i/>", {
             class:
              f.close +
              " " +
              ("string" == typeof d.closeIcon ? d.closeIcon : ""),
            })).hasClass(f.left)
             ? o.prepend(c)
             : o.append(c));
         }
         if (
          (o.hasClass(f.compact) && (d.compact = !0),
          o.hasClass("card") && (d.compact = !1),
          (a = o.find(".actions")),
          u.has.configActions() &&
           (0 === a.length &&
            (a = F("<div/>", {
           ...
           o.hasClass("card") &&
            !a.hasClass(f.attached) &&
            (a.addClass(f.extraContent),
            a.hasClass(f.vertical) &&
             (a.removeClass(f.vertical), u.error(g.verticalCard))),
           d.actions.forEach(function (e) {
            var t = e[p.icon]
              ? '<i class="' + u.helpers.deQuote(e[p.icon]) + ' icon"></i>'
              : "",
             ...
             i = u.helpers.deQuote(e[p.class] || ""),
             o =
              e[p.click] && F.isFunction(e[p.click])
               ? e[p.click]
               : function () {};
            a.append(
             F("<button/>", {
          ...
          a && a.hasClass(f.vertical) && o.addClass(f.vertical),
          0 < a.length &&
           !a.hasClass(f.attached) &&
           (!a ||
            (a.hasClass(f.basic) && !a.hasClass(f.left)) ||
            o.addClass(f.actions)),
          "auto" === d.displayTime &&
           (d.displayTime = Math.max(
            d.minDisplayTime,
            (o.text().split(" ").length / d.wordsPerMinute) * 6e4
           )),
          i.append(o),
          0 < a.length &&
           a.hasClass(f.attached) &&
           (a.addClass(f.buttons),
           a.detach(),
           o.addClass(f.attached),
           a.hasClass(f.vertical)
            ? (o.wrap(
               F("<div/>", {
                class:
              ...
              a.hasClass(f.left)
               ? o.addClass(f.left).parent().addClass(f.left).prepend(a)
               : o.parent().append(a))
            : a.hasClass(f.top)
            ? (i.prepend(a), o.addClass(f.bottom))
            : (i.append(a), o.addClass(f.top))),
          h !== o && (y = (h = o)[0]),
          0 < d.displayTime)
         ) {
          ...
          d.showProgress &&
           ...
           d.classProgress ||
            (o.hasClass("toast") && !o.hasClass(f.inverted)
             ? r.addClass(f.inverted)
             : r.removeClass(f.inverted)),
           (s = F("<div/>", {
            class: "bar " + (d.progressUp ? "up " : "down ") + n,
           })),
           r.addClass(d.showProgress).append(s),
           r.hasClass(f.top) ? i.prepend(r) : i.append(r),
           s.css("animation-duration", d.displayTime / 1e3 + "s")),
           (l = F("<span/>", { class: "wait " + n })).css(
            "animation-duration",
            d.displayTime / 1e3 + "s"
           ),
           l.appendTo(o);
         ...
         d.compact &&
          (i.addClass(f.compact),
          o.addClass(f.compact),
          r && r.addClass(f.compact)),
          d.newestOnTop
           ? i.prependTo(u.get.container())
           : i.appendTo(u.get.container());
        },
       },
       bind: {
        events: function () {
         u.debug("Binding events to toast"),
          (d.closeOnClick || d.closeIcon) &&
           (d.closeIcon ? c : o).on("click" + t, u.event.click),
          l && l.on("animationend" + t, u.close),
          i
           .on("click" + t, m.approve, u.event.approve)
           .on("click" + t, m.deny, u.event.deny);
        },
       },
       unbind: {
        events: function () {
         u.debug("Unbinding events to toast"),
          (d.closeOnClick || d.closeIcon) &&
           (d.closeIcon ? c : o).off("click" + t),
          l && l.off("animationend" + t),
          i.off("click" + t);
        },
       },
       animate: {
         ...
         (e = F.isFunction(e) ? e : function () {}),
          ...
          !1 !== d.onHide.call(i, y)
           ? d.transition &&
             ...
             : u.error(g.noTransition)
           : u.debug(
              "onHide callback returned false, cancelling toast animation"
             );
        },
        pause: function () {
         l.css("animationPlayState", "paused"),
          s && s.css("animationPlayState", "paused");
        },
        continue: function () {
         l.css("animationPlayState", "running"),
          s && s.css("animationPlayState", "running");
        },
       },
       has: {
        container: function () {
         return (
          u.verbose("Determining if there is already a container"),
          0 <
           v.find(
            u.helpers.toClass(d.position) +
             m.container +
             (d.horizontal ? u.helpers.toClass(f.horizontal) : "")
           ).length
         );
        },
        toast: function () {
       ...
       get: {
        ...
        iconClass: function () {
         return "string" == typeof d.showIcon
          ? d.showIcon
          : d.showIcon && d.icons[d.class]
          ? d.icons[d.class]
          : "";
        },
       ...
       event: {
        click: function (e) {
         0 === F(e.target).closest("a").length &&
          (d.onClick.call(i, y), u.close());
        },
        approve: function () {
         !1 !== d.onApprove.call(y, h)
          ? u.close()
          : u.verbose("Approve callback returned false cancelling close");
        },
        deny: function () {
         !1 !== d.onDeny.call(y, h)
          ? u.close()
          : u.verbose("Deny callback returned false cancelling close");
        },
       },
       helpers: {
        toClass: function (e) {
       ...
       can: {
        useElement: function (e) {
         return (
          F.fn[e] !== P || (u.error(g.noElement.replace("{element}", e)), !1)
         );
        },
       },
       setting: function (e, t) {
        if ((u.debug("Changing setting", e, t), F.isPlainObject(e)))
         F.extend(!0, d, e);
        else {
         if (t === P) return d[e];
         ...
         "string" == typeof i &&
          ...
          F.each(i, function (e, t) {
           ...
           if (F.isPlainObject(r[n]) && e != o) r = r[n];
            ...
            if (!F.isPlainObject(r[t]) || e == o)
             return r[t] !== P ? (a = r[t]) : u.error(g.method, i), !1;
            r = r[t];
           }
          })),
         F.isFunction(a) ? (n = a.apply(t, e)) : a !== P && (n = a),
         Array.isArray(w)
          ? w.push(n)
          : w !== P
          ? (w = [w, n])
       ...
       A
        ? (x === P && u.initialize(), u.invoke(D))
        : (x !== P && x.invoke("destroy"), u.initialize(), (w = h));
     }),
     w !== P ? w : this
    );
   }),
    ...
    return (
     r.each(function (i) {
      ...
      (f = {
       ...
       complete: function (e) {
        e && e.target === l && e.stopPropagation(),
       ...
       force: {
        visible: function () {
         var e = m.attr("style"),
          ...
          o = m[0].style.display;
         return !n ||
          ("none" === o && u.skipInlineHidden) ||
          m[0].tagName.match(/(script|link|style)/i)
          ? (f.remove.transition(), !1)
       ...
       set: {
        animating: function (e) {
         ...
         f.save.animation(t),
          f.force.visible() &&
           (f.remove.hidden(), f.remove.direction(), f.start.animation(t));
        },
       ...
       restore: {
        conditions: function () {
         ...
         e &&
          (m.removeClass(e), f.verbose("Removing animation class", f.cache)),
          f.remove.duration();
        },
       },
       add: {
       ...
       hide: function () {
        f.verbose("Hiding element"),
         ...
         f.remove.display(),
         f.remove.visible(),
         C.isFunction(u.onBeforeHide)
          ? u.onBeforeHide.call(l, function () {
             f.hideNow();
            })
          : f.hideNow();
       },
     ...
     return (
      e.each(function () {
       var a,
        ...
        l,
        c = E.isPlainObject(x)
         ? E.extend(!0, {}, E.fn.api.settings, x)
       ...
       (l = {
        ...
        write: {
         cachedResponse: function (e, t) {
          t && "" === t
           ...
           : F.Storage !== P
           ? (E.isPlainObject(t) && (t = JSON.stringify(t)),
        ...
        query: function () {
         if (l.is.disabled())
          ...
          if (
           (c.defaultData && E.extend(!0, c.urlData, l.get.defaultData()),
           c.serializeForm && (c.data = l.add.formData(c.data)),
           !1 === (r = l.get.settings()))
          )
           return (l.cancelled = !0), void l.error(u.beforeSend);
          if (
           ((l.cancelled = !1), (n = l.get.templatedURL()) || l.is.mocked())
          ) {
         ...
         xhr: {
          always: function () {},
           ...
           var i = this,
            ...
            r =
             !!E.isFunction(c.onResponse) &&
             (l.is.expectingJSON() && !c.rawResponse
              ? c.onResponse.call(i, E.extend(!0, {}, e))
        ...
        get: {
         ...
         errorFromRequest: function (e, t, n) {
          return E.isPlainObject(e) && e.error !== P
           ? e.error
           : c.error[t] !== P
           ? c.error[t]
           : n;
         ...
         settings: function () {
          ...
          return (
           ...
           e === P && l.error(u.noReturnedValue),
           !1 === e ? e : e !== P ? E.extend(!0, {}, e) : E.extend(!0, {}, c)
          );
         },
        ...
        setting: function (e, t) {
         if ((l.debug("Changing setting", e, t), E.isPlainObject(e)))
          E.extend(!0, c, e);
         else {
          if (t === P) return c[e];
           ...
           E.each(i, function (e, t) {
            ...
            if (E.isPlainObject(r[n]) && e != o) r = r[n];
             ...
             if (!E.isPlainObject(r[t]) || e == o)
              return r[t] !== P ? (a = r[t]) : l.error(u.method, i), !1;
             r = r[t];
            }
           })),
          E.isFunction(a) ? (n = a.apply(t, e)) : a !== P && (n = a),
          Array.isArray(C)
           ? C.push(n)
           : C !== P
           ? (C = [C, n])
        ...
        D
         ? (y === P && l.initialize(), l.invoke(S))
         : (y !== P && y.invoke("destroy"), l.initialize());
      }),
      C !== P ? C : this
     );
    }),
   ...
   (w.fn.state = function (m) {
    ...
    return (
     p.each(function () {
      var s,
       o = w.isPlainObject(m)
        ? w.extend(!0, {}, w.fn.state.settings, m)
        : w.extend({}, w.fn.state.settings),
       l = o.error,
       n = o.metadata,
       t = o.className,
       e = o.namespace,
      ...
      (s = {
       initialize: function () {
        s.verbose("Initializing module"),
         o.automatic && s.add.defaults(),
         o.context && "" !== h
          ? w(o.context)
             .on(h, "mouseenter" + r, s.change.text)
             .on(h, "mouseleave" + r, s.reset.text)
             .on(h, "click" + r, s.toggle.state)
          : u
             .on("mouseenter" + r, s.change.text)
             .on("mouseleave" + r, s.reset.text)
             .on("click" + r, s.toggle.state),
         s.instantiate();
       },
       instantiate: function () {
       ...
       add: {
        defaults: function () {
         ...
         w.each(o.defaults, function (e, t) {
          s.is[e] !== k &&
           s.is[e]() &&
           (s.verbose("Adding default states", e, d), w.extend(o.states, t, n));
         });
        },
       },
       is: {
        ...
        state: function () {
         ...
         if (s.allows("active") && s.is.enabled()) {
          if ((s.refresh(), w.fn.api !== k))
           if (((e = u.api("get request")), u.api("was cancelled")))
            s.debug("API Request cancelled by beforesend"),
       ...
       listenTo: function (e) {
        s.debug("API request detected, waiting for state signal", e),
         e &&
          (a.loading && s.update.text(a.loading),
          w.when(e).then(function () {
           "resolved" == e.state()
            ? (s.debug("API request succeeded"),
              (o.activateTest = function () {
               return !0;
              }),
              (o.deactivateTest = function () {
       ...
       change: {
        state: function () {
         s.debug("Determining state change direction"),
          s.is.inactive() ? s.activate() : s.deactivate(),
          o.sync && s.sync(),
          o.onChange.call(d);
        },
        text: function () {
         s.is.textEnabled() &&
          (s.is.disabled()
           ? (s.verbose("Changing text to disabled text", a.hover),
             s.update.text(a.disabled))
           : s.is.active()
           ? a.hover
             ? (s.verbose("Changing text to hover text", a.hover),
               s.update.text(a.hover))
             : a.deactivate &&
               (s.verbose("Changing text to deactivating text", a.deactivate),
               s.update.text(a.deactivate))
           : a.hover
           ? (s.verbose("Changing text to hover text", a.hover),
             s.update.text(a.hover))
           : a.activate &&
             (s.verbose("Changing text to activating text", a.activate),
             s.update.text(a.activate)));
        },
       },
       activate: function () {
        o.activateTest.call(d) &&
         (s.debug("Setting state to active"),
         u.addClass(t.active),
         s.update.text(a.active),
         o.onActivate.call(d));
       },
       deactivate: function () {
        o.deactivateTest.call(d) &&
         (s.debug("Setting state to inactive"),
         u.removeClass(t.active),
         s.update.text(a.inactive),
         o.onDeactivate.call(d));
       },
       sync: function () {
        s.verbose("Syncing other buttons to current state"),
         s.is.active()
          ? p.not(u).state("activate")
          : p.not(u).state("deactivate");
       },
       get: {
        text: function () {
       ...
       flash: {
        text: function (e, t, n) {
         var i = s.get.text();
         s.debug("Flashing text message", e, t),
          (e = e || o.text.flash),
          (t = t || o.flashDuration),
          (n = n || function () {}),
          s.update.text(e),
       ...
       reset: {
        text: function () {
         ...
         s.is.textEnabled() &&
          (s.is.active() && e
           ? (s.verbose("Resetting active text", e), s.update.text(e))
           : t && (s.verbose("Resetting inactive text", e), s.update.text(t)));
        },
       },
       update: {
        text: function (e) {
         var t = s.get.text();
         e && e !== t
          ? (s.debug("Updating text", e),
            o.selector.text
             ? u.data(n.storedText, e).find(o.selector.text).text(e)
             : u.data(n.storedText, e).html(e))
          : s.debug("Text is already set, ignoring update", e);
        },
       },
       setting: function (e, t) {
        if ((s.debug("Changing setting", e, t), w.isPlainObject(e)))
         w.extend(!0, o, e);
        else {
         if (t === k) return o[e];
       ...
       invoke: function (i, e, t) {
        ...
        return (
         ...
         w.isFunction(a) ? (n = a.apply(t, e)) : a !== k && (n = a),
         Array.isArray(g)
          ? g.push(n)
          : g !== k
          ? (g = [g, n])
       ...
       x
        ? (f === k && s.initialize(), s.invoke(y))
        : (f !== k && f.invoke("destroy"), s.initialize());
     }),
     g !== k ? g : this
    );
   }),
    ...
    return (
     e.each(function () {
      var e,
       ...
       s,
       o = E.isPlainObject(b)
        ? E.extend(!0, {}, E.fn.visibility.settings, b)
      ...
      (s = {
          ...
          e.removedNodes &&
           [].forEach.call(e.removedNodes, function (e) {
            (e == h || 0 < E(e).find(h).length) &&
             (s.debug("Element removed from DOM, tearing down events"),
             s.destroy());
           });
         });
        },
       ...
       precache: function (e, t) {
        ...
        for (
         ...
         ((a = P.createElement("img")).onload = r),
          (a.onerror = r),
          (a.src = e[n]),
          o.push(a);
       },
       ...
       passed: function (e, t) {
        ...
        if (e && t) o.onPassed[e] = t;
         ...
         n.passing &&
          E.each(o.onPassed, function (e, t) {
       ...
       offScreen: function (e) {
        ...
        if (
         (e &&
          (s.debug("Adding callback for offScreen", e), (o.onOffScreen = e)),
         t.offScreen
       ...
       topVisible: function (e) {
        ...
        if (
         (e &&
          (s.debug("Adding callback for top visible", e), (o.onTopVisible = e)),
       ...
       topPassed: function (e) {
        ...
        if (
         (e &&
          (s.debug("Adding callback for top passed", e), (o.onTopPassed = e)),
         t.topPassed
       ...
       get: {
        ...
        direction: function () {
         return (
          s.cache.direction === O && s.save.direction(), s.cache.direction
         );
        },
        elementPosition: function () {
         return (
          s.cache.element === O && s.save.elementPosition(), s.cache.element
         );
        },
        elementCalculations: function () {
         return (
          s.cache.element === O && s.save.elementCalculations(), s.cache.element
         );
        },
        screenCalculations: function () {
         return (
          s.cache.screen === O && s.save.screenCalculations(), s.cache.screen
         );
        },
        screenSize: function () {
       ...
       invoke: function (i, e, t) {
        ...
        return (
         ...
         E.isFunction(a) ? (n = a.apply(t, e)) : a !== O && (n = a),
         Array.isArray(y)
          ? y.push(n)
          : y !== O
          ? (y = [y, n])
